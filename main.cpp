...
PHPCPP_EXPORT void *get_module() {
  ...
  gdkfullscreenmode.constant("ON_CURRENT_MONITOR",
  ...
  gdkmodifierintent.constant("PRIMARY_ACCELERATOR",
                             GDK_MODIFIER_INTENT_PRIMARY_ACCELERATOR);
  gdkmodifierintent.constant("CONTEXT_MENU", GDK_MODIFIER_INTENT_CONTEXT_MENU);
  gdkmodifierintent.constant("EXTEND_SELECTION",
                             GDK_MODIFIER_INTENT_EXTEND_SELECTION);
  gdkmodifierintent.constant("MODIFY_SELECTION",
                             GDK_MODIFIER_INTENT_MODIFY_SELECTION);
  gdkmodifierintent.constant("NO_TEXT_INPUT",
                             GDK_MODIFIER_INTENT_NO_TEXT_INPUT);
  gdkmodifierintent.constant("SHIFT_GROUP", GDK_MODIFIER_INTENT_SHIFT_GROUP);
  gdkmodifierintent.constant("DEFAULT_MOD_MASK",
  ...
  gdkwindowtypehint.constant("DROPDOWN_MENU",
  ...
  gdkwindow.method<&GdkWindow_::get_default_root_window>(
  ...
  gtkapplication.method<&GtkApplication_::get_active_window>(
      "get_active_window");
  ...
  gtkapplication.method<&GtkApplication_::remove_accelerator>(
      "remove_accelerator");
  gtkapplication.method<&GtkApplication_::list_action_descriptions>(
      "list_action_descriptions");
  gtkapplication.method<&GtkApplication_::get_accels_for_action>(
      "get_accels_for_action");
  gtkapplication.method<&GtkApplication_::set_accels_for_action>(
      "set_accels_for_action");
  gtkapplication.method<&GtkApplication_::get_actions_for_accel>(
  ...
  gtkicontheme.method<&GtkIconTheme_::prepend_search_path>(
      "prepend_search_path");
  ...
  gapplication.method<&GApplication_::get_inactivity_timeout>(
      "get_inactivity_timeout");
  gapplication.method<&GApplication_::set_inactivity_timeout>(
      "set_inactivity_timeout");
  gapplication.method<&GApplication_::get_flags>("get_flags");
  gapplication.method<&GApplication_::set_flags>("set_flags");
  gapplication.method<&GApplication_::get_resource_base_path>(
      "get_resource_base_path");
  gapplication.method<&GApplication_::set_resource_base_path>(
      "set_resource_base_path");
  gapplication.method<&GApplication_::get_dbus_connection>(
      "get_dbus_connection");
  gapplication.method<&GApplication_::get_dbus_object_path>(
  ...
  gapplication.method<&GApplication_::withdraw_notification>(
      "withdraw_notification");
  gapplication.method<&GApplication_::run>("run");
  gapplication.method<&GApplication_::add_main_option_entries>(
  ...
  gapplication.method<&GApplication_::set_option_context_parameter_string>(
      "set_option_context_parameter_string");
  gapplication.method<&GApplication_::set_option_context_summary>(
      "set_option_context_summary");
  gapplication.method<&GApplication_::set_option_context_description>(
  ...
  gapplication.method<&GApplication_::unbind_busy_property>(
  ...
  gapplication.constant("HANDLES_COMMAND_LINE",
  ...
  gapplication.constant("CAN_OVERRIDE_APP_ID",
                        G_APPLICATION_CAN_OVERRIDE_APP_ID);
  // gapplication.constant("ALLOW_REPLACEMENT",
  // G_APPLICATION_ALLOW_REPLACEMENT); gapplication.constant("REPLACE",
  ...
  gtkapplicationinhibitflag.constant("SUSPEND",
  ...
  gtksizerequestmode.constant("HEIGHT_FOR_WIDTH",
                              GTK_SIZE_REQUEST_HEIGHT_FOR_WIDTH);
  gtksizerequestmode.constant("WIDTH_FOR_HEIGHT",
  ...
  gtkjunctionsides.constant("CORNER_BOTTOMLEFT",
                            GTK_JUNCTION_CORNER_BOTTOMLEFT);
  gtkjunctionsides.constant("CORNER_BOTTOMRIGHT",
  ...
  gtkstylecontextprintflags.constant("RECURSE",
                                     GTK_STYLE_CONTEXT_PRINT_RECURSE);
  gtkstylecontextprintflags.constant("SHOW_STYLE",
                                     GTK_STYLE_CONTEXT_PRINT_SHOW_STYLE);

  // GtkStyleProvider
  Php::Class<Php::Base> gtkstyleprovider("GtkStyleProvider");
  gtkstyleprovider.constant("PRIORITY_APPLICATION",
                            GTK_STYLE_PROVIDER_PRIORITY_APPLICATION);
  gtkstyleprovider.constant("PRIORITY_FALLBACK",
                            GTK_STYLE_PROVIDER_PRIORITY_FALLBACK);
  gtkstyleprovider.constant("PRIORITY_SETTINGS",
                            GTK_STYLE_PROVIDER_PRIORITY_SETTINGS);
  gtkstyleprovider.constant("PRIORITY_THEME",
  ...
  gdk.constant("WINDOW_TYPE_HINT_SPLASHSCREEN",
  ...
  gdk.constant("WINDOW_TYPE_HINT_DROPDOWN_MENU",
               GDK_WINDOW_TYPE_HINT_DROPDOWN_MENU);
  ...
  gdk.constant("WINDOW_TYPE_HINT_NOTIFICATION",
  ...
  gdkvisual.method<&GdkVisual_::get_blue_pixel_details>(
      "get_blue_pixel_details");
  gdkvisual.method<&GdkVisual_::get_green_pixel_details>(
  ...
  gdkeventmask.constant("POINTER_MOTION_HINT_MASK",
  ...
  gdkeventmask.constant("VISIBILITY_NOTIFY_MASK",
  ...
  gdkeventmask.constant("TOUCHPAD_GESTURE_MASK",
                        (int)GDK_TOUCHPAD_GESTURE_MASK);
  ...
  gdkpixbuf.method<&GdkPixbuf_::new_from_file_at_scale>(
  ...
  // Special value (-1): Used to indicate the default sort column in
  // GtkTreeSortable.
  gtk.constant("TREE_SORTABLE_DEFAULT_SORT_COLUMN_ID",
               GTK_TREE_SORTABLE_DEFAULT_SORT_COLUMN_ID);
  // Special value (-2): Used to indicate that the model is not sorted in
  // GtkTreeSortable.
  gtk.constant("TREE_SORTABLE_UNSORTED_SORT_COLUMN_ID",
  ...
  gtkwidget.method<&GtkWidget_::queue_resize_no_redraw>(
  ...
  gtkwidget.method<&GtkWidget_::size_allocate_with_baseline>(
  ...
  gtkwidget.method<&GtkWidget_::input_shape_combine_region>(
  ...
  gtkwidget.method<&GtkWidget_::set_redraw_on_allocate>(
  ...
  gtkwidget.method<&GtkWidget_::class_install_style_property>(
      "class_install_style_property");
  gtkwidget.method<&GtkWidget_::class_install_style_property_parser>(
      "class_install_style_property_parser");
  gtkwidget.method<&GtkWidget_::class_find_style_property>(
      "class_find_style_property");
  gtkwidget.method<&GtkWidget_::class_list_style_properties>(
  ...
  gtkwidget.method<&GtkWidget_::class_set_accessible_type>(
      "class_set_accessible_type");
  gtkwidget.method<&GtkWidget_::class_set_accessible_role>(
  ...
  gtkwidget.method<&GtkWidget_::gtk_cairo_should_draw_window>(
      "gtk_cairo_should_draw_window");
  gtkwidget.method<&GtkWidget_::gtk_cairo_transform_to_window>(
  ...
  gtkwidget.method<&GtkWidget_::get_allocated_baseline>(
  ...
  gtkwidget.method<&GtkWidget_::set_support_multidevice>(
      "set_support_multidevice");
  gtkwidget.method<&GtkWidget_::get_support_multidevice>(
  ...
  gtkwidget.method<&GtkWidget_::get_preferred_height_for_width>(
      "get_preferred_height_for_width");
  gtkwidget.method<&GtkWidget_::get_preferred_width_for_height>(
      "get_preferred_width_for_height");
  gtkwidget.method<&GtkWidget_::get_preferred_height_and_baseline_for_width>(
  ...
  gtkwidget.method<&GtkWidget_::gtk_distribute_natural_allocation>(
  ...
  gtkwidget.method<&GtkWidget_::get_valign_with_baseline>(
  ...
  gtkwidget.method<&GtkWidget_::class_set_template_from_resource>(
      "class_set_template_from_resource");
  gtkwidget.method<&GtkWidget_::get_template_child>("get_template_child");
  gtkwidget.method<&GtkWidget_::class_bind_template_child_full>(
      "class_bind_template_child_full");
  gtkwidget.method<&GtkWidget_::class_bind_template_callback_full>(
      "class_bind_template_callback_full");
  gtkwidget.method<&GtkWidget_::class_set_connect_func>(
  ...
  gtkcontainer.method<&GtkContainer_::add_with_properties>(
      "add_with_properties");
  ...
  gtkcontainer.method<&GtkContainer_::set_reallocate_redraws>(
  ...
  gtkcontainer.method<&GtkContainer_::get_focus_vadjustment>(
      "get_focus_vadjustment");
  gtkcontainer.method<&GtkContainer_::set_focus_vadjustment>(
      "set_focus_vadjustment");
  gtkcontainer.method<&GtkContainer_::get_focus_hadjustment>(
      "get_focus_hadjustment");
  gtkcontainer.method<&GtkContainer_::set_focus_hadjustment>(
  ...
  gtkcontainer.method<&GtkContainer_::child_notify_by_pspec>(
  ...
  gtkcontainer.method<&GtkContainer_::class_find_child_property>(
      "class_find_child_property");
  gtkcontainer.method<&GtkContainer_::class_install_child_property>(
      "class_install_child_property");
  gtkcontainer.method<&GtkContainer_::class_install_child_properties>(
      "class_install_child_properties");
  gtkcontainer.method<&GtkContainer_::class_list_child_properties>(
      "class_list_child_properties");
  gtkcontainer.method<&GtkContainer_::class_handle_border_width>(
  ...
  gtktable.method<&GtkTable_::get_default_row_spacing>(
      "get_default_row_spacing");
  gtktable.method<&GtkTable_::set_col_spacings>("set_col_spacings");
  gtktable.method<&GtkTable_::get_default_col_spacing>(
  ...
  gtkgrid.method<&GtkGrid_::set_row_baseline_position>(
      "set_row_baseline_position");
  gtkgrid.method<&GtkGrid_::get_row_baseline_position>(
  ...
  gtkwindow.method<&GtkWindow_::set_destroy_with_parent>(
      "set_destroy_with_parent");
  gtkwindow.method<&GtkWindow_::get_destroy_with_parent>(
      "get_destroy_with_parent");
  gtkwindow.method<&GtkWindow_::set_hide_titlebar_when_maximized>(
      "set_hide_titlebar_when_maximized");
  gtkwindow.method<&GtkWindow_::get_hide_titlebar_when_maximized>(
  ...
  gtkwindow.method<&GtkWindow_::set_default_icon_from_file>(
      "set_default_icon_from_file");
  gtkwindow.method<&GtkWindow_::set_default_icon_name>("set_default_icon_name");
  gtkwindow.method<&GtkWindow_::set_auto_startup_notification>(
  ...
  gtkwindow.method<&GtkWindow_::set_interactive_debugging>(
  ...
  Php::Class<GtkApplicationWindow_> gtkapplicationwindow(
      "GtkApplicationWindow");
  gtkapplicationwindow.extends(gtkwindow);
  gtkapplicationwindow.method<&GtkApplicationWindow_::set_show_menubar>(
      "set_show_menubar");
  gtkapplicationwindow.method<&GtkApplicationWindow_::get_show_menubar>(
      "get_show_menubar");
  ...
  gtkdialog.method<&GtkDialog_::set_response_sensitive>(
      "set_response_sensitive");
  gtkdialog.method<&GtkDialog_::get_response_for_widget>(
      "get_response_for_widget");
  gtkdialog.method<&GtkDialog_::get_widget_for_response>(
  ...
  gtkappchooserdialog.method<&GtkAppChooserDialog_::new_for_content_type>(
  ...
  gtkappchooserdialog.method<&GtkAppChooserDialog_::get_app_info>(
      "get_app_info");
  ...
  Php::Class<GtkColorChooserDialog_> gtkcolorchooserdialog(
      "GtkColorChooserDialog");
  gtkcolorchooserdialog.extends(gtkdialog);
  gtkcolorchooserdialog.method<&GtkColorChooserDialog_::__construct>(
      "__construct");
  ...
  gtkcolorchooserdialog.method<&GtkColorChooserDialog_::get_use_alpha>(
      "get_use_alpha");
  gtkcolorchooserdialog.method<&GtkColorChooserDialog_::set_use_alpha>(
      "set_use_alpha");
  gtkcolorchooserdialog.method<&GtkColorChooserDialog_::add_palette>(
      "add_palette");
  ...
  gtkprintsettings.method<&GtkPrintSettings_::get_double_with_default>(
  ...
  gtkprintsettings.method<&GtkPrintSettings_::get_int_with_default>(
  ...
  gtkprintsettings.method<&GtkPrintSettings_::get_orientation>(
      "get_orientation");
  gtkprintsettings.method<&GtkPrintSettings_::set_orientation>(
      "set_orientation");
  ...
  gtkprintsettings.method<&GtkPrintSettings_::get_paper_width>(
      "get_paper_width");
  gtkprintsettings.method<&GtkPrintSettings_::set_paper_width>(
      "set_paper_width");
  gtkprintsettings.method<&GtkPrintSettings_::get_paper_height>(
      "get_paper_height");
  gtkprintsettings.method<&GtkPrintSettings_::set_paper_height>(
      "set_paper_height");
  ...
  gtkprintsettings.method<&GtkPrintSettings_::get_number_up_layout>(
      "get_number_up_layout");
  gtkprintsettings.method<&GtkPrintSettings_::set_number_up_layout>(
  ...
  gtkprintsettings.method<&GtkPrintSettings_::set_resolution_xy>(
      "set_resolution_xy");
  gtkprintsettings.method<&GtkPrintSettings_::get_resolution_x>(
      "get_resolution_x");
  gtkprintsettings.method<&GtkPrintSettings_::get_resolution_y>(
      "get_resolution_y");
  gtkprintsettings.method<&GtkPrintSettings_::get_printer_lpi>(
      "get_printer_lpi");
  gtkprintsettings.method<&GtkPrintSettings_::set_printer_lpi>(
      "set_printer_lpi");
  ...
  gtkprintsettings.method<&GtkPrintSettings_::get_print_pages>(
      "get_print_pages");
  gtkprintsettings.method<&GtkPrintSettings_::set_print_pages>(
      "set_print_pages");
  gtkprintsettings.method<&GtkPrintSettings_::get_page_ranges>(
      "get_page_ranges");
  gtkprintsettings.method<&GtkPrintSettings_::set_page_ranges>(
      "set_page_ranges");
  ...
  gtkprintsettings.method<&GtkPrintSettings_::get_default_source>(
      "get_default_source");
  gtkprintsettings.method<&GtkPrintSettings_::set_default_source>(
      "set_default_source");
  ...
  gtkprintsettings.method<&GtkPrintSettings_::new_from_key_file>(
      "new_from_key_file");
  ...
  // Php::Class<GtkPageSetupUnixDialog_>
  ...
  gtkpagesetup.method<&GtkPageSetup_::set_paper_size_and_default_margins>(
  ...
  gtkpapersize.method<&GtkPaperSize_::get_default_top_margin>(
      "get_default_top_margin");
  gtkpapersize.method<&GtkPaperSize_::get_default_bottom_margin>(
      "get_default_bottom_margin");
  gtkpapersize.method<&GtkPaperSize_::get_default_left_margin>(
      "get_default_left_margin");
  gtkpapersize.method<&GtkPaperSize_::get_default_right_margin>(
  ...
  gtktogglebutton.method<&GtkToggleButton_::new_with_mnemonic>(
      "new_with_mnemonic");
  ...
  gtktogglebutton.method<&GtkToggleButton_::get_inconsistent>(
      "get_inconsistent");
  gtktogglebutton.method<&GtkToggleButton_::set_inconsistent>(
      "set_inconsistent");
  ...
  gtkcheckbutton.method<&GtkCheckButton_::new_with_mnemonic>(
      "new_with_mnemonic");
  ...
  gtkradiobutton.method<&GtkRadioButton_::new_with_label_from_widget>(
      "new_with_label_from_widget");
  gtkradiobutton.method<&GtkRadioButton_::new_with_mnemonic>(
      "new_with_mnemonic");
  gtkradiobutton.method<&GtkRadioButton_::new_with_mnemonic_from_widget>(
  ...
  gtkscrolledwindow.method<&GtkScrolledWindow_::set_policy>(
      "set_overlay_scrolling");
  gtkscrolledwindow.method<&GtkScrolledWindow_::set_policy>("set_policy");
  gtkscrolledwindow.method<&GtkScrolledWindow_::set_shadow_type>(
      "set_shadow_type");
  gtkscrolledwindow.method<&GtkScrolledWindow_::set_propagate_natural_height>(
      "set_propagate_natural_height");
  gtkscrolledwindow.method<&GtkScrolledWindow_::set_propagate_natural_width>(
      "set_propagate_natural_width");
  gtkscrolledwindow.method<&GtkScrolledWindow_::set_max_content_height>(
      "set_max_content_height");
  gtkscrolledwindow.method<&GtkScrolledWindow_::set_min_content_height>(
      "set_min_content_height");
  gtkscrolledwindow.method<&GtkScrolledWindow_::set_max_content_width>(
      "set_max_content_width");
  gtkscrolledwindow.method<&GtkScrolledWindow_::set_min_content_width>(
      "set_min_content_width");
  gtkscrolledwindow.method<&GtkScrolledWindow_::get_hadjustment>(
      "get_hadjustment");
  gtkscrolledwindow.method<&GtkScrolledWindow_::get_vadjustment>(
      "get_vadjustment");
  ...
  gtkentrycompletion.method<&GtkEntryCompletion_::new_with_area>(
      "new_with_area");
  ...
  gtkentrycompletion.method<&GtkEntryCompletion_::set_match_func>(
      "set_match_func");
  gtkentrycompletion.method<&GtkEntryCompletion_::set_minimum_key_length>(
      "set_minimum_key_length");
  gtkentrycompletion.method<&GtkEntryCompletion_::get_minimum_key_length>(
      "get_minimum_key_length");
  gtkentrycompletion.method<&GtkEntryCompletion_::compute_prefix>(
      "compute_prefix");
  gtkentrycompletion.method<&GtkEntryCompletion_::complete>("complete");
  gtkentrycompletion.method<&GtkEntryCompletion_::get_completion_prefix>(
      "get_completion_prefix");
  gtkentrycompletion.method<&GtkEntryCompletion_::insert_prefix>(
      "insert_prefix");
  gtkentrycompletion.method<&GtkEntryCompletion_::insert_action_text>(
      "insert_action_text");
  gtkentrycompletion.method<&GtkEntryCompletion_::insert_action_markup>(
      "insert_action_markup");
  gtkentrycompletion.method<&GtkEntryCompletion_::delete_action>(
      "delete_action");
  gtkentrycompletion.method<&GtkEntryCompletion_::set_text_column>(
      "set_text_column");
  gtkentrycompletion.method<&GtkEntryCompletion_::get_text_column>(
      "get_text_column");
  gtkentrycompletion.method<&GtkEntryCompletion_::set_inline_completion>(
      "set_inline_completion");
  gtkentrycompletion.method<&GtkEntryCompletion_::get_inline_completion>(
      "get_inline_completion");
  gtkentrycompletion.method<&GtkEntryCompletion_::set_inline_selection>(
      "set_inline_selection");
  gtkentrycompletion.method<&GtkEntryCompletion_::get_inline_selection>(
      "get_inline_selection");
  gtkentrycompletion.method<&GtkEntryCompletion_::set_popup_completion>(
      "set_popup_completion");
  gtkentrycompletion.method<&GtkEntryCompletion_::get_popup_completion>(
      "get_popup_completion");
  gtkentrycompletion.method<&GtkEntryCompletion_::set_popup_set_width>(
      "set_popup_set_width");
  gtkentrycompletion.method<&GtkEntryCompletion_::get_popup_set_width>(
      "get_popup_set_width");
  gtkentrycompletion.method<&GtkEntryCompletion_::set_popup_single_match>(
      "set_popup_single_match");
  gtkentrycompletion.method<&GtkEntryCompletion_::get_popup_single_match>(
  ...
  gtkentry.method<&GtkEntry_::set_progress_pulse_step>(
      "set_progress_pulse_step");
  gtkentry.method<&GtkEntry_::get_progress_pulse_step>(
  ...
  gtktreeview.method<&GtkTreeView_::set_level_indentation>(
      "set_level_indentation");
  gtktreeview.method<&GtkTreeView_::set_show_expanders>("set_show_expanders");
  gtktreeview.method<&GtkTreeView_::set_enable_tree_lines>(
      "set_enable_tree_lines");
  gtktreeview.method<&GtkTreeView_::get_enable_tree_lines>(
  ...
  gtktreeview.method<&GtkTreeView_::set_fixed_height_mode>(
      "set_fixed_height_mode");
  gtktreeview.method<&GtkTreeView_::get_fixed_height_mode>(
  ...
  gtktreeview.method<&GtkTreeView_::convert_widget_to_bin_window_coords>(
      "convert_widget_to_bin_window_coords");
  gtktreeview.method<&GtkTreeView_::convert_widget_to_tree_coords>(
      "convert_widget_to_tree_coords");
  gtktreeview.method<&GtkTreeView_::convert_tree_to_widget_coords>(
      "convert_tree_to_widget_coords");
  gtktreeview.method<&GtkTreeView_::convert_tree_to_bin_window_coords>(
      "convert_tree_to_bin_window_coords");
  gtktreeview.method<&GtkTreeView_::convert_bin_window_to_widget_coords>(
      "convert_bin_window_to_widget_coords");
  gtktreeview.method<&GtkTreeView_::convert_bin_window_to_tree_coords>(
  ...
  gtktreeviewcolumn.method<&GtkTreeViewColumn_::get_fixed_width>(
      "get_fixed_width");
  gtktreeviewcolumn.method<&GtkTreeViewColumn_::set_fixed_width>(
      "set_fixed_width");
  ...
  gtktreeviewcolumn.method<&GtkTreeViewColumn_::set_reorderable>(
      "set_reorderable");
  gtktreeviewcolumn.method<&GtkTreeViewColumn_::get_reorderable>(
      "get_reorderable");
  ...
  gtktreeviewcolumn.method<&GtkTreeViewColumn_::set_sort_column_id>(
      "set_sort_column_id");
  gtktreeviewcolumn.method<&GtkTreeViewColumn_::get_sort_column_id>(
      "get_sort_column_id");
  gtktreeviewcolumn.method<&GtkTreeViewColumn_::set_sort_indicator>(
      "set_sort_indicator");
  gtktreeviewcolumn.method<&GtkTreeViewColumn_::get_sort_indicator>(
      "get_sort_indicator");
  gtktreeviewcolumn.method<&GtkTreeViewColumn_::set_sort_order>(
      "set_sort_order");
  gtktreeviewcolumn.method<&GtkTreeViewColumn_::get_sort_order>(
      "get_sort_order");
  ...
  gtktreeviewcolumn.method<&GtkTreeViewColumn_::set_cell_data_func>(
      "set_cell_data_func");
  ...
  gtkcellrenderertext.method<&GtkCellRendererText_::set_fixed_height_from_font>(
      "set_fixed_height_from_font");

  // GtkCellRendererCombo
  Php::Class<GtkCellRendererCombo_> gtkcellrenderercombo(
      "GtkCellRendererCombo");
  gtkcellrenderercombo.extends(gtkcellrenderertext);
  gtkcellrenderercombo.method<&GtkCellRendererCombo_::__construct>(
      "__construct");

  // GtkCellRendererToggle
  Php::Class<GtkCellRendererToggle_> gtkcellrenderertoggle(
      "GtkCellRendererToggle");
  gtkcellrenderertoggle.extends(gtkcellrenderer);
  gtkcellrenderertoggle.method<&GtkCellRendererToggle_::__construct>(
      "__construct");
  gtkcellrenderertoggle.method<&GtkCellRendererToggle_::set_activatable>(
      "set_activatable");
  gtkcellrenderertoggle.method<&GtkCellRendererToggle_::get_activatable>(
      "get_activatable");
  ...
  gtkcellrenderertoggle.method<&GtkCellRendererToggle_::set_active>(
      "set_active");
  gtkcellrenderertoggle.method<&GtkCellRendererToggle_::get_active>(
      "get_active");

  // GtkCellRendererPixbuf
  Php::Class<GtkCellRendererPixbuf_> gtkcellrendererpixbuf(
      "GtkCellRendererPixbuf");
  gtkcellrendererpixbuf.extends(gtkcellrenderer);
  gtkcellrendererpixbuf.method<&GtkCellRendererPixbuf_::__construct>(
      "__construct");
  ...
  gtktreemodel.method<&GtkTreeModel_::get_iter_from_string>(
      "get_iter_from_string");

  // GtkTreeModelFlags
  Php::Class<Php::Base> gtktreemodelflags("GtkTreeModelFlags");
  gtktreemodelflags.constant("TREE_MODEL_ITERS_PERSIST",
                             (int)GTK_TREE_MODEL_ITERS_PERSIST);
  gtktreemodelflags.constant("TREE_MODEL_LIST_ONLY",
  ...
  gtklabel.method<&GtkLabel_::set_markup_with_mnemonic>(
  ...
  gtklabel.method<&GtkLabel_::set_track_visited_links>(
      "set_track_visited_links");
  gtklabel.method<&GtkLabel_::get_track_visited_links>(
  ...
  gtkfilechooseraction.constant("SELECT_FOLDER",
                                (int)GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER);
  gtkfilechooseraction.constant("CREATE_FOLDER",
                                (int)GTK_FILE_CHOOSER_ACTION_CREATE_FOLDER);
  ...
  gtktextview.method<&GtkTextView_::scroll_mark_onscreen>(
      "scroll_mark_onscreen");
  gtktextview.method<&GtkTextView_::move_mark_onscreen>("move_mark_onscreen");
  gtktextview.method<&GtkTextView_::place_cursor_onscreen>(
  ...
  gtktextview.method<&GtkTextView_::get_iter_at_location>(
      "get_iter_at_location");
  gtktextview.method<&GtkTextView_::get_iter_at_position>(
      "get_iter_at_position");
  gtktextview.method<&GtkTextView_::buffer_to_window_coords>(
      "buffer_to_window_coords");
  gtktextview.method<&GtkTextView_::window_to_buffer_coords>(
      "window_to_buffer_coords");
  gtktextview.method<&GtkTextView_::get_window>("get_window");
  gtktextview.method<&GtkTextView_::get_window_type>("get_window_type");
  gtktextview.method<&GtkTextView_::set_border_window_size>(
      "set_border_window_size");
  gtktextview.method<&GtkTextView_::get_border_window_size>(
      "get_border_window_size");
  gtktextview.method<&GtkTextView_::forward_display_line>(
      "forward_display_line");
  gtktextview.method<&GtkTextView_::backward_display_line>(
      "backward_display_line");
  gtktextview.method<&GtkTextView_::forward_display_line_end>(
      "forward_display_line_end");
  gtktextview.method<&GtkTextView_::backward_display_line_start>(
  ...
  gtktextview.method<&GtkTextView_::set_pixels_above_lines>(
      "set_pixels_above_lines");
  gtktextview.method<&GtkTextView_::get_pixels_above_lines>(
      "get_pixels_above_lines");
  gtktextview.method<&GtkTextView_::set_pixels_below_lines>(
      "set_pixels_below_lines");
  gtktextview.method<&GtkTextView_::get_pixels_below_lines>(
      "get_pixels_below_lines");
  gtktextview.method<&GtkTextView_::set_pixels_inside_wrap>(
      "set_pixels_inside_wrap");
  gtktextview.method<&GtkTextView_::get_pixels_inside_wrap>(
  ...
  gtktextview.method<&GtkTextView_::im_context_filter_keypress>(
  ...
  gtktextiter.method<&GtkTextIter_::get_visible_line_offset>(
  ...
  gtktextiter.method<&GtkTextIter_::backward_word_starts>(
  ...
  gtktextiter.method<&GtkTextIter_::forward_cursor_position>(
      "forward_cursor_position");
  gtktextiter.method<&GtkTextIter_::backward_cursor_position>(
      "backward_cursor_position");
  gtktextiter.method<&GtkTextIter_::forward_cursor_positions>(
      "forward_cursor_positions");
  gtktextiter.method<&GtkTextIter_::backward_cursor_positions>(
      "backward_cursor_positions");
  gtktextiter.method<&GtkTextIter_::backward_sentence_start>(
      "backward_sentence_start");
  gtktextiter.method<&GtkTextIter_::backward_sentence_starts>(
      "backward_sentence_starts");
  gtktextiter.method<&GtkTextIter_::forward_sentence_end>(
      "forward_sentence_end");
  gtktextiter.method<&GtkTextIter_::forward_sentence_ends>(
      "forward_sentence_ends");
  gtktextiter.method<&GtkTextIter_::forward_visible_word_ends>(
      "forward_visible_word_ends");
  gtktextiter.method<&GtkTextIter_::backward_visible_word_starts>(
      "backward_visible_word_starts");
  gtktextiter.method<&GtkTextIter_::forward_visible_word_end>(
      "forward_visible_word_end");
  gtktextiter.method<&GtkTextIter_::backward_visible_word_start>(
      "backward_visible_word_start");
  gtktextiter.method<&GtkTextIter_::forward_visible_cursor_position>(
      "forward_visible_cursor_position");
  gtktextiter.method<&GtkTextIter_::backward_visible_cursor_position>(
      "backward_visible_cursor_position");
  gtktextiter.method<&GtkTextIter_::forward_visible_cursor_positions>(
      "forward_visible_cursor_positions");
  gtktextiter.method<&GtkTextIter_::backward_visible_cursor_positions>(
      "backward_visible_cursor_positions");
  gtktextiter.method<&GtkTextIter_::forward_visible_line>(
      "forward_visible_line");
  gtktextiter.method<&GtkTextIter_::backward_visible_line>(
      "backward_visible_line");
  gtktextiter.method<&GtkTextIter_::forward_visible_lines>(
      "forward_visible_lines");
  gtktextiter.method<&GtkTextIter_::backward_visible_lines>(
  ...
  gtktextiter.method<&GtkTextIter_::set_visible_line_index>(
      "set_visible_line_index");
  gtktextiter.method<&GtkTextIter_::set_visible_line_offset>(
  ...
  gtktextiter.method<&GtkTextIter_::forward_to_tag_toggle>(
      "forward_to_tag_toggle");
  gtktextiter.method<&GtkTextIter_::backward_to_tag_toggle>(
  ...
  gtktextbuffer.method<&GtkTextBuffer_::delete_mark_by_name>(
      "delete_mark_by_name");
  gtktextbuffer.method<&GtkTextBuffer_::get_mark>("get_mark");
  gtktextbuffer.method<&GtkTextBuffer_::get_insert>("get_insert");
  gtktextbuffer.method<&GtkTextBuffer_::get_selection_bound>(
      "get_selection_bound");
  ...
  gtktextbuffer.method<&GtkTextBuffer_::remove_tag_by_name>(
      "remove_tag_by_name");
  ...
  gtktextbuffer.method<&GtkTextBuffer_::get_iter_at_line_offset>(
      "get_iter_at_line_offset");
  gtktextbuffer.method<&GtkTextBuffer_::get_iter_at_offset>(
      "get_iter_at_offset");
  gtktextbuffer.method<&GtkTextBuffer_::get_iter_at_line>("get_iter_at_line");
  gtktextbuffer.method<&GtkTextBuffer_::get_iter_at_line_index>(
  ...
  gtktextbuffer.method<&GtkTextBuffer_::get_selection_bounds>(
  ...
  gtktextbuffer.method<&GtkTextBuffer_::remove_selection_clipboard>(
      "remove_selection_clipboard");
  gtktextbuffer.method<&GtkTextBuffer_::deserialize>("deserialize");
  gtktextbuffer.method<&GtkTextBuffer_::deserialize_get_can_create_tags>(
      "deserialize_get_can_create_tags");
  gtktextbuffer.method<&GtkTextBuffer_::deserialize_set_can_create_tags>(
      "deserialize_set_can_create_tags");
  gtktextbuffer.method<&GtkTextBuffer_::get_copy_target_list>(
      "get_copy_target_list");
  gtktextbuffer.method<&GtkTextBuffer_::get_deserialize_formats>(
      "get_deserialize_formats");
  gtktextbuffer.method<&GtkTextBuffer_::get_paste_target_list>(
      "get_paste_target_list");
  gtktextbuffer.method<&GtkTextBuffer_::get_serialize_formats>(
      "get_serialize_formats");
  gtktextbuffer.method<&GtkTextBuffer_::register_deserialize_format>(
      "register_deserialize_format");
  gtktextbuffer.method<&GtkTextBuffer_::register_serialize_format>(
      "register_serialize_format");
  gtktextbuffer.method<&GtkTextBuffer_::register_serialize_tagset>(
      "register_serialize_tagset");
  gtktextbuffer.method<&GtkTextBuffer_::serialize>("serialize");
  gtktextbuffer.method<&GtkTextBuffer_::unregister_deserialize_format>(
      "unregister_deserialize_format");
  gtktextbuffer.method<&GtkTextBuffer_::unregister_serialize_format>(
  ...
  gtkinputhints.constant("WORD_COMPLETION",
                         (int)GTK_INPUT_HINT_WORD_COMPLETION);
  gtkinputhints.constant("LOWERCASE", (int)GTK_INPUT_HINT_LOWERCASE);
  gtkinputhints.constant("UPPERCASE_CHARS",
                         (int)GTK_INPUT_HINT_UPPERCASE_CHARS);
  gtkinputhints.constant("UPPERCASE_WORDS",
                         (int)GTK_INPUT_HINT_UPPERCASE_WORDS);
  gtkinputhints.constant("UPPERCASE_SENTENCES",
                         (int)GTK_INPUT_HINT_UPPERCASE_SENTENCES);
  gtkinputhints.constant("INHIBIT_OSK", (int)GTK_INPUT_HINT_INHIBIT_OSK);
  gtkinputhints.constant("VERTICAL_WRITING",
                         (int)GTK_INPUT_HINT_VERTICAL_WRITING);
  ...
  gtkdialogflags.constant("DESTROY_WITH_PARENT",
  ...
  gtkfilefilter.method<&GtkFileFilter_::add_pixbuf_formats>(
      "add_pixbuf_formats");
  ...
  Php::Class<GtkFileChooserDialog_> gtkfilechooserdialog(
      "GtkFileChooserDialog");
  gtkfilechooserdialog.extends(gtkdialog);
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::__construct>(
      "__construct");
  ...
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::set_local_only>(
      "set_local_only");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_local_only>(
      "get_local_only");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::set_select_multiple>(
      "set_select_multiple");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_select_multiple>(
      "get_select_multiple");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::set_show_hidden>(
      "set_show_hidden");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_show_hidden>(
      "get_show_hidden");
  gtkfilechooserdialog
      .method<&GtkFileChooserDialog_::set_do_overwrite_confirmation>(
          "set_do_overwrite_confirmation");
  gtkfilechooserdialog
      .method<&GtkFileChooserDialog_::get_do_overwrite_confirmation>(
          "get_do_overwrite_confirmation");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::set_create_folders>(
      "set_create_folders");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_create_folders>(
      "get_create_folders");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::set_current_name>(
      "set_current_name");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_current_name>(
      "get_current_name");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::set_filename>(
      "set_filename");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_filename>(
      "get_filename");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::select_filename>(
      "select_filename");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::unselect_filename>(
      "unselect_filename");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::select_all>("select_all");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::unselect_all>(
      "unselect_all");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_filenames>(
      "get_filenames");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::set_current_folder>(
      "set_current_folder");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_current_folder>(
      "get_current_folder");
  ...
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::unselect_uri>(
      "unselect_uri");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_uris>("get_uris");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::set_current_folder_uri>(
      "set_current_folder_uri");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::set_preview_widget>(
      "set_preview_widget");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_preview_widget>(
      "get_preview_widget");
  gtkfilechooserdialog
      .method<&GtkFileChooserDialog_::set_preview_widget_active>(
          "set_preview_widget_active");
  gtkfilechooserdialog
      .method<&GtkFileChooserDialog_::get_preview_widget_active>(
          "get_preview_widget_active");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::set_use_preview_label>(
      "set_use_preview_label");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_use_preview_label>(
      "get_use_preview_label");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_preview_uri>(
      "get_preview_uri");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::set_extra_widget>(
      "set_extra_widget");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_extra_widget>(
      "get_extra_widget");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::add_filter>("add_filter");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::remove_filter>(
      "remove_filter");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::list_filters>(
      "list_filters");
  ...
  gtkmessagedialog.method<&GtkMessageDialog_::new_with_markup>(
      "new_with_markup");
  gtkmessagedialog.method<&GtkMessageDialog_::set_markup>("set_markup");
  gtkmessagedialog.method<&GtkMessageDialog_::format_secondary_text>(
      "format_secondary_text");
  gtkmessagedialog.method<&GtkMessageDialog_::format_secondary_markup>(
      "format_secondary_markup");
  gtkmessagedialog.method<&GtkMessageDialog_::get_message_area>(
      "get_message_area");
  ...
  gtkaboutdialog.method<&GtkAboutDialog_::get_website_label>(
      "get_website_label");
  gtkaboutdialog.method<&GtkAboutDialog_::set_website_label>(
      "set_website_label");
  ...
  gtkaboutdialog.method<&GtkAboutDialog_::get_translator_credits>(
      "get_translator_credits");
  gtkaboutdialog.method<&GtkAboutDialog_::set_translator_credits>(
      "set_translator_credits");
  gtkaboutdialog.method<&GtkAboutDialog_::get_logo>("get_logo");
  gtkaboutdialog.method<&GtkAboutDialog_::set_logo>("set_logo");
  gtkaboutdialog.method<&GtkAboutDialog_::get_logo_icon_name>(
      "get_logo_icon_name");
  gtkaboutdialog.method<&GtkAboutDialog_::set_logo_icon_name>(
      "set_logo_icon_name");
  gtkaboutdialog.method<&GtkAboutDialog_::add_credit_section>(
      "add_credit_section");
  gtkaboutdialog.method<&GtkAboutDialog_::gtk_show_about_dialog>(
  ...
  gtkpageorientation.constant("REVERSE_PORTRAIT",
                              (int)GTK_PAGE_ORIENTATION_REVERSE_PORTRAIT);
  gtkpageorientation.constant("REVERSE_LANDSCAPE",
                              (int)GTK_PAGE_ORIENTATION_REVERSE_LANDSCAPE);
  ...
  gtknumberuplayout.constant(
      "LEFT_TO_RIGHT_TOP_TO_BOTTOM",
      (int)GTK_NUMBER_UP_LAYOUT_LEFT_TO_RIGHT_TOP_TO_BOTTOM);
  gtknumberuplayout.constant(
      "LEFT_TO_RIGHT_BOTTOM_TO_TOP",
      (int)GTK_NUMBER_UP_LAYOUT_LEFT_TO_RIGHT_BOTTOM_TO_TOP);
  gtknumberuplayout.constant(
      "RIGHT_TO_LEFT_TOP_TO_BOTTOM",
      (int)GTK_NUMBER_UP_LAYOUT_RIGHT_TO_LEFT_TOP_TO_BOTTOM);
  gtknumberuplayout.constant(
      "RIGHT_TO_LEFT_BOTTOM_TO_TOP",
      (int)GTK_NUMBER_UP_LAYOUT_RIGHT_TO_LEFT_BOTTOM_TO_TOP);
  gtknumberuplayout.constant(
      "TOP_TO_BOTTOM_LEFT_TO_RIGHT",
      (int)GTK_NUMBER_UP_LAYOUT_TOP_TO_BOTTOM_LEFT_TO_RIGHT);
  gtknumberuplayout.constant(
      "TOP_TO_BOTTOM_RIGHT_TO_LEFT",
      (int)GTK_NUMBER_UP_LAYOUT_TOP_TO_BOTTOM_RIGHT_TO_LEFT);
  gtknumberuplayout.constant(
      "BOTTOM_TO_TOP_LEFT_TO_RIGHT",
      (int)GTK_NUMBER_UP_LAYOUT_BOTTOM_TO_TOP_LEFT_TO_RIGHT);
  gtknumberuplayout.constant(
      "BOTTOM_TO_TOP_RIGHT_TO_LEFT",
      (int)GTK_NUMBER_UP_LAYOUT_BOTTOM_TO_TOP_RIGHT_TO_LEFT);
  ...
  Php::Class<GtkFontChooserDialog_> gtkfontchooserdialog(
      "GtkFontChooserDialog");
  gtkfontchooserdialog.extends(gtkdialog);
  gtkfontchooserdialog.method<&GtkFontChooserDialog_::__construct>(
      "__construct");
  gtkfontchooserdialog.method<&GtkFontChooserDialog_::get_font_size>(
      "get_font_size");
  gtkfontchooserdialog.method<&GtkFontChooserDialog_::get_font>("get_font");
  gtkfontchooserdialog.method<&GtkFontChooserDialog_::get_preview_text>(
      "get_preview_text");
  gtkfontchooserdialog.method<&GtkFontChooserDialog_::set_preview_text>(
      "set_preview_text");
  gtkfontchooserdialog.method<&GtkFontChooserDialog_::get_show_preview_entry>(
      "get_show_preview_entry");
  gtkfontchooserdialog.method<&GtkFontChooserDialog_::set_show_preview_entry>(
  ...
  gtktoolitem.method<&GtkToolItem_::set_visible_horizontal>(
      "set_visible_horizontal");
  gtktoolitem.method<&GtkToolItem_::get_visible_horizontal>(
      "get_visible_horizontal");
  gtktoolitem.method<&GtkToolItem_::set_visible_vertical>(
      "set_visible_vertical");
  gtktoolitem.method<&GtkToolItem_::get_visible_vertical>(
  ...
  gtktoolitem.method<&GtkToolItem_::get_text_orientation>(
      "get_text_orientation");
  gtktoolitem.method<&GtkToolItem_::retrieve_proxy_menu_item>(
  ...
  gtktoolitem.method<&GtkToolItem_::toolbar_reconfigured>(
      "toolbar_reconfigured");
  gtktoolitem.method<&GtkToolItem_::get_text_size_group>("get_text_size_group");

  // GtkSeparatorToolItem
  Php::Class<GtkSeparatorToolItem_> gtkseparatortoolitem(
      "GtkSeparatorToolItem");
  gtkseparatortoolitem.extends(gtktoolitem);
  gtkseparatortoolitem.method<&GtkSeparatorToolItem_::__construct>(
      "__construct");
  ...
  gtktoolbar.method<&GtkToolbar_::set_drop_highlight_item>(
  ...
  gtkstatusicon.method<&GtkStatusIcon_::set_from_icon_name>(
      "set_from_icon_name");
  ...
  gtkstatusicon.method<&GtkStatusIcon_::set_tooltip_markup>(
      "set_tooltip_markup");
  ...
  gtkstatusicon.method<&GtkStatusIcon_::get_tooltip_markup>(
      "get_tooltip_markup");
  ...
  gtkstatusicon.method<&GtkStatusIcon_::new_from_icon_name>(
      "new_from_icon_name");
  ...
  gtkclipboard.method<&GtkClipboard_::wait_is_text_available>(
      "wait_is_text_available");
  gtkclipboard.method<&GtkClipboard_::wait_is_image_available>(
      "wait_is_image_available");
  gtkclipboard.method<&GtkClipboard_::wait_is_uris_available>(
      "wait_is_uris_available");
  gtkclipboard.method<&GtkClipboard_::wait_is_target_available>(
  ...
  gtkliststore.method<&GtkListStore_::insert_with_valuesv>(
      "insert_with_valuesv");
  ...
  gtkliststore.method<&GtkListStore_::get_sort_column_id>("get_sort_column_id");
  ...
  gtktreeselection.method<&GtkTreeSelection_::set_select_function>(
      "set_select_function");
  gtktreeselection.method<&GtkTreeSelection_::get_select_function>(
      "get_select_function");
  ...
  gtktreeselection.method<&GtkTreeSelection_::selected_foreach>(
      "selected_foreach");
  gtktreeselection.method<&GtkTreeSelection_::get_selected_rows>(
      "get_selected_rows");
  gtktreeselection.method<&GtkTreeSelection_::count_selected_rows>(
      "count_selected_rows");
  ...
  gtktreeselection.method<&GtkTreeSelection_::path_is_selected>(
      "path_is_selected");
  ...
  gtktreeselection.method<&GtkTreeSelection_::iter_is_selected>(
      "iter_is_selected");
  ...
  gtktreesortable.method<&GtkTreeSortable_::sort_column_changed>(
      "sort_column_changed");
  gtktreesortable.method<&GtkTreeSortable_::get_sort_column_id>(
      "get_sort_column_id");
  gtktreesortable.method<&GtkTreeSortable_::set_sort_column_id>(
      "set_sort_column_id");
  gtktreesortable.method<&GtkTreeSortable_::has_default_sort_func>(
  ...
  gtkmenubar.method<&GtkMenuBar_::set_child_pack_direction>(
  ...
  gtkmenuitem.method<&GtkMenuItem_::get_reserve_indicator>(
      "get_reserve_indicator");
  gtkmenuitem.method<&GtkMenuItem_::set_reserve_indicator>(
      "set_reserve_indicator");
  gtkmenuitem.method<&GtkMenuItem_::set_right_justified>("set_right_justified");

  // GtkSeparatorMenuItem
  Php::Class<GtkSeparatorMenuItem_> gtkseparatormenuitem(
      "GtkSeparatorMenuItem");
  gtkseparatormenuitem.extends(gtkmenuitem);
  gtkseparatormenuitem.method<&GtkSeparatorMenuItem_::__construct>(
      "__construct");
  ...
  gtkcheckmenuitem.method<&GtkCheckMenuItem_::new_with_mnemonic>(
      "new_with_mnemonic");
  ...
  gtkcheckmenuitem.method<&GtkCheckMenuItem_::get_inconsistent>(
      "get_inconsistent");
  gtkcheckmenuitem.method<&GtkCheckMenuItem_::set_inconsistent>(
      "set_inconsistent");
  gtkcheckmenuitem.method<&GtkCheckMenuItem_::get_draw_as_radio>(
      "get_draw_as_radio");
  gtkcheckmenuitem.method<&GtkCheckMenuItem_::set_draw_as_radio>(
      "set_draw_as_radio");
  ...
  gtklistbox.method<&GtkListBox_::set_activate_on_single_click>(
      "set_activate_on_single_click");
  gtklistbox.method<&GtkListBox_::get_activate_on_single_click>(
  ...
  gtkcombobox.method<&GtkComboBox_::new_with_model_and_entry>(
      "new_with_model_and_entry");
  gtkcombobox.method<&GtkComboBox_::new_with_area>("new_with_area");
  gtkcombobox.method<&GtkComboBox_::new_with_area_and_entry>(
  ...
  gtkcombobox.method<&GtkComboBox_::get_column_span_column>(
      "get_column_span_column");
  gtkcombobox.method<&GtkComboBox_::set_column_span_column>(
  ...
  gtkcombobox.method<&GtkComboBox_::get_popup_accessible>(
      "get_popup_accessible");
  gtkcombobox.method<&GtkComboBox_::get_row_separator_func>(
      "get_row_separator_func");
  gtkcombobox.method<&GtkComboBox_::set_row_separator_func>(
      "set_row_separator_func");
  gtkcombobox.method<&GtkComboBox_::set_button_sensitivity>(
      "set_button_sensitivity");
  gtkcombobox.method<&GtkComboBox_::get_button_sensitivity>(
      "get_button_sensitivity");
  gtkcombobox.method<&GtkComboBox_::get_has_entry>("get_has_entry");
  gtkcombobox.method<&GtkComboBox_::get_entry_text_column>(
      "get_entry_text_column");
  gtkcombobox.method<&GtkComboBox_::set_entry_text_column>(
      "set_entry_text_column");
  gtkcombobox.method<&GtkComboBox_::get_popup_fixed_width>(
      "get_popup_fixed_width");
  gtkcombobox.method<&GtkComboBox_::set_popup_fixed_width>(
  ...
  gtkappchooserbutton.method<&GtkAppChooserButton_::append_custom_item>(
      "append_custom_item");
  gtkappchooserbutton.method<&GtkAppChooserButton_::append_separator>(
      "append_separator");
  gtkappchooserbutton.method<&GtkAppChooserButton_::set_active_custom_item>(
      "set_active_custom_item");
  gtkappchooserbutton.method<&GtkAppChooserButton_::get_show_default_item>(
      "get_show_default_item");
  gtkappchooserbutton.method<&GtkAppChooserButton_::set_show_default_item>(
      "set_show_default_item");
  gtkappchooserbutton.method<&GtkAppChooserButton_::get_show_dialog_item>(
      "get_show_dialog_item");
  gtkappchooserbutton.method<&GtkAppChooserButton_::set_show_dialog_item>(
  ...
  gtkappchooserbutton.method<&GtkAppChooserButton_::get_app_info>(
      "get_app_info");
  ...
  gtkbuilder.method<&GtkBuilder_::lookup_callback_symbol>(
  ...
  gtkbuilder.method<&GtkBuilder_::add_objects_from_file>(
      "add_objects_from_file");
  gtkbuilder.method<&GtkBuilder_::add_objects_from_string>(
      "add_objects_from_string");
  gtkbuilder.method<&GtkBuilder_::add_objects_from_resource>(
  ...
  gtkbuilder.method<&GtkBuilder_::set_translation_domain>(
      "set_translation_domain");
  gtkbuilder.method<&GtkBuilder_::get_translation_domain>(
  ...
  gtkbuilder.method<&GtkBuilder_::value_from_string_type>(
  ...
  gtkdeletetype.constant("DISPLAY_LINE_ENDS",
                         (int)GTK_DELETE_DISPLAY_LINE_ENDS);
  ...
  gtkmovementstep.constant("LOGICAL_POSITIONS",
                           (int)GTK_MOVEMENT_LOGICAL_POSITIONS);
  gtkmovementstep.constant("VISUAL_POSITIONS",
                           (int)GTK_MOVEMENT_VISUAL_POSITIONS);
  ...
  gtkmovementstep.constant("DISPLAY_LINE_ENDS",
                           (int)GTK_MOVEMENT_DISPLAY_LINE_ENDS);
  ...
  gtkmovementstep.constant("HORIZONTAL_PAGES",
                           (int)GTK_MOVEMENT_HORIZONTAL_PAGES);
  ...
  gtkrevealertransitiontype.constant("NONE",
                                     (int)GTK_REVEALER_TRANSITION_TYPE_NONE);
  gtkrevealertransitiontype.constant(
      "CROSSFADE", (int)GTK_REVEALER_TRANSITION_TYPE_CROSSFADE);
  gtkrevealertransitiontype.constant(
      "RIGHT", (int)GTK_REVEALER_TRANSITION_TYPE_SLIDE_RIGHT);
  gtkrevealertransitiontype.constant(
      "LEFT", (int)GTK_REVEALER_TRANSITION_TYPE_SLIDE_LEFT);
  gtkrevealertransitiontype.constant(
      "UP", (int)GTK_REVEALER_TRANSITION_TYPE_SLIDE_UP);
  gtkrevealertransitiontype.constant(
      "DOWN", (int)GTK_REVEALER_TRANSITION_TYPE_SLIDE_DOWN);
  ...
  gtkrevealer.method<&GtkRevealer_::get_transition_duration>(
      "get_transition_duration");
  gtkrevealer.method<&GtkRevealer_::set_transition_duration>(
  ...
  gladedesignview.method<&GladeDesignView_::get_from_project>(
      "get_from_project");
  ...
  gladepalette.method<&GladePalette_::get_item_appearance>(
      "get_item_appearance");
  gladepalette.method<&GladePalette_::set_item_appearance>(
      "set_item_appearance");
  gladepalette.method<&GladePalette_::get_use_small_item_icons>(
      "get_use_small_item_icons");
  gladepalette.method<&GladePalette_::set_use_small_item_icons>(
      "set_use_small_item_icons");
  gladepalette.method<&GladePalette_::get_show_selector_button>(
      "get_show_selector_button");
  gladepalette.method<&GladePalette_::set_show_selector_button>(
  ...
  gtkflowbox.method<&GtkFlowBox_::set_min_children_per_line>(
      "set_min_children_per_line");
  gtkflowbox.method<&GtkFlowBox_::get_min_children_per_line>(
      "get_min_children_per_line");
  gtkflowbox.method<&GtkFlowBox_::set_max_children_per_line>(
      "set_max_children_per_line");
  gtkflowbox.method<&GtkFlowBox_::get_max_children_per_line>(
      "get_max_children_per_line");
  gtkflowbox.method<&GtkFlowBox_::set_activate_on_single_click>(
      "set_activate_on_single_click");
  gtkflowbox.method<&GtkFlowBox_::get_activate_on_single_click>(
      "get_activate_on_single_click");
  gtkflowbox.method<&GtkFlowBox_::selected_foreach>("selected_foreach");
  gtkflowbox.method<&GtkFlowBox_::get_selected_children>(
  ...
  gtkstacktransitiontype.constant("CROSSFADE",
                                  (int)GTK_STACK_TRANSITION_TYPE_CROSSFADE);
  gtkstacktransitiontype.constant("SLIDE_RIGHT",
                                  (int)GTK_STACK_TRANSITION_TYPE_SLIDE_RIGHT);
  gtkstacktransitiontype.constant("SLIDE_LEFT",
                                  (int)GTK_STACK_TRANSITION_TYPE_SLIDE_LEFT);
  gtkstacktransitiontype.constant("SLIDE_UP",
                                  (int)GTK_STACK_TRANSITION_TYPE_SLIDE_UP);
  gtkstacktransitiontype.constant("SLIDE_DOWN",
                                  (int)GTK_STACK_TRANSITION_TYPE_SLIDE_DOWN);
  gtkstacktransitiontype.constant(
      "SLIDE_LEFT_RIGHT", (int)GTK_STACK_TRANSITION_TYPE_SLIDE_LEFT_RIGHT);
  gtkstacktransitiontype.constant("SLIDE_UP_DOWN",
                                  (int)GTK_STACK_TRANSITION_TYPE_SLIDE_UP_DOWN);
  gtkstacktransitiontype.constant("OVER_UP",
                                  (int)GTK_STACK_TRANSITION_TYPE_OVER_UP);
  gtkstacktransitiontype.constant("OVER_DOWN",
                                  (int)GTK_STACK_TRANSITION_TYPE_OVER_DOWN);
  gtkstacktransitiontype.constant("OVER_LEFT",
                                  (int)GTK_STACK_TRANSITION_TYPE_OVER_LEFT);
  gtkstacktransitiontype.constant("OVER_RIGHT",
                                  (int)GTK_STACK_TRANSITION_TYPE_OVER_RIGHT);
  gtkstacktransitiontype.constant("UNDER_UP",
                                  (int)GTK_STACK_TRANSITION_TYPE_UNDER_UP);
  gtkstacktransitiontype.constant("UNDER_DOWN",
                                  (int)GTK_STACK_TRANSITION_TYPE_UNDER_DOWN);
  gtkstacktransitiontype.constant("UNDER_LEF",
                                  (int)GTK_STACK_TRANSITION_TYPE_UNDER_LEFT);
  gtkstacktransitiontype.constant("UNDER_RIGHT",
                                  (int)GTK_STACK_TRANSITION_TYPE_UNDER_RIGHT);
  gtkstacktransitiontype.constant("OVER_UP_DOWN",
                                  (int)GTK_STACK_TRANSITION_TYPE_OVER_UP_DOWN);
  gtkstacktransitiontype.constant("OVER_DOWN_UP",
                                  (int)GTK_STACK_TRANSITION_TYPE_OVER_DOWN_UP);
  gtkstacktransitiontype.constant(
      "OVER_LEFT_RIGHT", (int)GTK_STACK_TRANSITION_TYPE_OVER_LEFT_RIGHT);
  gtkstacktransitiontype.constant(
      "OVER_RIGHT_LEFT", (int)GTK_STACK_TRANSITION_TYPE_OVER_RIGHT_LEFT);
  ...
  gtkstack.method<&GtkStack_::set_transition_duration>(
      "set_transition_duration");
  gtkstack.method<&GtkStack_::get_transition_duration>(
      "get_transition_duration");
  ...
  gtkstackswitcher.method<&GtkStackSwitcher_::get_orientation>(
      "get_orientation");
  gtkstackswitcher.method<&GtkStackSwitcher_::set_orientation>(
      "set_orientation");
  ...
  gtkheaderbar.method<&GtkHeaderBar_::set_show_close_button>(
      "set_show_close_button");
  gtkheaderbar.method<&GtkHeaderBar_::get_show_close_button>(
      "get_show_close_button");
  gtkheaderbar.method<&GtkHeaderBar_::set_decoration_layout>(
      "set_decoration_layout");
  gtkheaderbar.method<&GtkHeaderBar_::get_decoration_layout>(
  ...
  gtkoverlay.method<&GtkOverlay_::get_overlay_pass_through>(
      "get_overlay_pass_through");
  gtkoverlay.method<&GtkOverlay_::set_overlay_pass_through>(
  ...
  gtkbuttonbox.method<&GtkButtonBox_::get_child_secondary>(
      "get_child_secondary");
  gtkbuttonbox.method<&GtkButtonBox_::get_child_non_homogeneous>(
      "get_child_non_homogeneous");
  gtkbuttonbox.method<&GtkButtonBox_::set_layout>("set_layout");
  gtkbuttonbox.method<&GtkButtonBox_::set_child_secondary>(
      "set_child_secondary");
  gtkbuttonbox.method<&GtkButtonBox_::set_child_non_homogeneous>(
  ...
  gtkwidgetpath.method<&GtkWidgetPath_::append_with_siblings>(
  ...
  gtkwidgetpath.method<&GtkWidgetPath_::iter_clear_classes>(
      "iter_clear_classes");
  gtkwidgetpath.method<&GtkWidgetPath_::iter_clear_regions>(
      "iter_clear_regions");
  gtkwidgetpath.method<&GtkWidgetPath_::iter_get_name>("iter_get_name");
  gtkwidgetpath.method<&GtkWidgetPath_::iter_get_object_name>(
      "iter_get_object_name");
  gtkwidgetpath.method<&GtkWidgetPath_::iter_get_object_type>(
      "iter_get_object_type");
  gtkwidgetpath.method<&GtkWidgetPath_::iter_get_siblings>("iter_get_siblings");
  gtkwidgetpath.method<&GtkWidgetPath_::iter_get_sibling_index>(
  ...
  gtkwidgetpath.method<&GtkWidgetPath_::iter_remove_region>(
      "iter_remove_region");
  gtkwidgetpath.method<&GtkWidgetPath_::iter_set_name>("iter_set_name");
  gtkwidgetpath.method<&GtkWidgetPath_::iter_set_object_name>(
      "iter_set_object_name");
  gtkwidgetpath.method<&GtkWidgetPath_::iter_set_object_type>(
  ...
  gtkcalendardisplayoptions.constant("SHOW_HEADING",
                                     (int)GTK_CALENDAR_SHOW_HEADING);
  gtkcalendardisplayoptions.constant("SHOW_DAY_NAMES",
                                     (int)GTK_CALENDAR_SHOW_DAY_NAMES);
  gtkcalendardisplayoptions.constant("NO_MONTH_CHANGE",
                                     (int)GTK_CALENDAR_NO_MONTH_CHANGE);
  gtkcalendardisplayoptions.constant("SHOW_WEEK_NUMBERS",
                                     (int)GTK_CALENDAR_SHOW_WEEK_NUMBERS);
  gtkcalendardisplayoptions.constant("SHOW_DETAILS",
                                     (int)GTK_CALENDAR_SHOW_DETAILS);
  ...
  gtkcalendar.method<&GtkCalendar_::get_detail_width_chars>(
      "get_detail_width_chars");
  gtkcalendar.method<&GtkCalendar_::set_detail_width_chars>(
      "set_detail_width_chars");
  gtkcalendar.method<&GtkCalendar_::get_detail_height_rows>(
      "get_detail_height_rows");
  gtkcalendar.method<&GtkCalendar_::set_detail_height_rows>(
  ...
  gtkinfobar.method<&GtkInfoBar_::set_response_sensitive>(
      "set_response_sensitive");
  ...
  gtkinfobar.method<&GtkInfoBar_::get_show_close_button>(
      "get_show_close_button");
  gtkinfobar.method<&GtkInfoBar_::set_show_close_button>(
      "set_show_close_button");
  ...
  gtkcssprovidererror.constant("UNKNOWN_VALUE",
                               (int)GTK_CSS_PROVIDER_ERROR_UNKNOWN_VALUE);
  gtkcssprovidererror.constant("DEPRECATED",
                               (int)GTK_CSS_PROVIDER_ERROR_DEPRECATED);
  ...
  gtkcsssectiontype.constant("COLOR_DEFINITION",
                             (int)GTK_CSS_SECTION_COLOR_DEFINITION);
  ...
  gtkcssprovider.method<&GtkCssProvider_::load_from_resource>(
      "load_from_resource");
  gtkcssprovider.method<&GtkCssProvider_::__construct>("__construct");
  gtkcssprovider.method<&GtkCssProvider_::to_string>("to_string");
  gtkcssprovider.method<&GtkCssProvider_::gtk_css_section_get_end_line>(
      "gtk_css_section_get_end_line");
  gtkcssprovider.method<&GtkCssProvider_::gtk_css_section_get_end_position>(
      "gtk_css_section_get_end_position");
  gtkcssprovider.method<&GtkCssProvider_::gtk_css_section_get_file>(
      "gtk_css_section_get_file");
  gtkcssprovider.method<&GtkCssProvider_::gtk_css_section_get_parent>(
      "gtk_css_section_get_parent");
  gtkcssprovider.method<&GtkCssProvider_::gtk_css_section_get_section_type>(
      "gtk_css_section_get_section_type");
  gtkcssprovider.method<&GtkCssProvider_::gtk_css_section_get_start_line>(
      "gtk_css_section_get_start_line");
  gtkcssprovider.method<&GtkCssProvider_::gtk_css_section_get_start_position>(
      "gtk_css_section_get_start_position");
  gtkcssprovider.method<&GtkCssProvider_::gtk_css_section_ref>(
      "gtk_css_section_ref");
  gtkcssprovider.method<&GtkCssProvider_::gtk_css_section_unref>(
  ...
  gtkstylecontext.method<&GtkStyleContext_::add_provider_for_screen>(
      "add_provider_for_screen");
  gtkstylecontext.method<&GtkStyleContext_::get>("get");
  gtkstylecontext.method<&GtkStyleContext_::get_direction>("get_direction");
  gtkstylecontext.method<&GtkStyleContext_::get_junction_sides>(
      "get_junction_sides");
  ...
  gtkstylecontext.method<&GtkStyleContext_::get_style_property>(
      "get_style_property");
  gtkstylecontext.method<&GtkStyleContext_::get_style_valist>(
      "get_style_valist");
  ...
  gtkstylecontext.method<&GtkStyleContext_::get_background_color>(
      "get_background_color");
  gtkstylecontext.method<&GtkStyleContext_::get_border_color>(
      "get_border_color");
  ...
  gtkstylecontext.method<&GtkStyleContext_::state_is_running>(
      "state_is_running");
  ...
  gtkstylecontext.method<&GtkStyleContext_::notify_state_change>(
      "notify_state_change");
  gtkstylecontext.method<&GtkStyleContext_::pop_animatable_region>(
      "pop_animatable_region");
  gtkstylecontext.method<&GtkStyleContext_::push_animatable_region>(
      "push_animatable_region");
  gtkstylecontext.method<&GtkStyleContext_::cancel_animations>(
      "cancel_animations");
  gtkstylecontext.method<&GtkStyleContext_::scroll_animations>(
      "scroll_animations");
  gtkstylecontext.method<&GtkStyleContext_::remove_provider>("remove_provider");
  gtkstylecontext.method<&GtkStyleContext_::remove_provider_for_screen>(
  ...
  gtkstylecontext.method<&GtkStyleContext_::set_junction_sides>(
      "set_junction_sides");
  ...
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_arrow>(
      "gtk_render_arrow");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_background>(
      "gtk_render_background");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_background_get_clip>(
      "gtk_render_background_get_clip");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_check>(
      "gtk_render_check");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_expander>(
      "gtk_render_expander");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_extension>(
      "gtk_render_extension");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_focus>(
      "gtk_render_focus");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_frame>(
      "gtk_render_frame");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_frame_gap>(
      "gtk_render_frame_gap");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_handle>(
      "gtk_render_handle");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_layout>(
      "gtk_render_layout");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_line>("gtk_render_line");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_option>(
      "gtk_render_option");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_slider>(
      "gtk_render_slider");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_activity>(
      "gtk_render_activity");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_icon_pixbuf>(
      "gtk_render_icon_pixbuf");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_icon_surface>(
      "gtk_render_icon_surface");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_icon>("gtk_render_icon");
  gtkstylecontext.method<&GtkStyleContext_::gtk_render_insertion_cursor>(
      "gtk_render_insertion_cursor");

  // GtkRecentChooserError
  Php::Class<Php::Base> gtkrecentchoosererror("GtkRecentChooserError");
  gtkrecentchoosererror.constant("NOT_FOUND",
                                 (int)GTK_RECENT_CHOOSER_ERROR_NOT_FOUND);
  gtkrecentchoosererror.constant("INVALID_URI",
                                 (int)GTK_RECENT_CHOOSER_ERROR_INVALID_URI);
  ...
  Php::Class<GtkRecentChooserDialog_> gtkrecentchooserdialog(
      "GtkRecentChooserDialog");
  gtkrecentchooserdialog.extends(gtkdialog);
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::__construct>(
      "__construct");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::new_for_manager>(
      "new_for_manager");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::set_show_private>(
      "set_show_private");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::get_show_private>(
      "get_show_private");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::set_show_not_found>(
      "set_show_not_found");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::get_show_not_found>(
      "get_show_not_found");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::set_show_icons>(
      "set_show_icons");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::get_show_icons>(
      "get_show_icons");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::set_select_multiple>(
      "set_select_multiple");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::get_select_multiple>(
      "get_select_multiple");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::set_local_only>(
      "set_local_only");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::get_local_only>(
      "get_local_only");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::set_limit>(
      "set_limit");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::get_limit>(
      "get_limit");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::set_show_tips>(
      "set_show_tips");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::get_show_tips>(
      "get_show_tips");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::set_sort_type>(
      "set_sort_type");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::get_sort_type>(
      "get_sort_type");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::set_sort_func>(
      "set_sort_func");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::set_current_uri>(
      "set_current_uri");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::get_current_uri>(
      "get_current_uri");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::get_current_item>(
      "get_current_item");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::select_uri>(
      "select_uri");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::unselect_uri>(
      "unselect_uri");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::select_all>(
      "select_all");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::unselect_all>(
      "unselect_all");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::get_items>(
      "get_items");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::get_uris>("get_uris");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::add_filter>(
      "add_filter");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::remove_filter>(
      "remove_filter");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::list_filters>(
      "list_filters");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::set_filter>(
      "set_filter");
  gtkrecentchooserdialog.method<&GtkRecentChooserDialog_::get_filter>(
      "get_filter");
  ...
  gtksourcesmarthomeendtype.constant("DISABLED",
                                     (int)GTK_SOURCE_SMART_HOME_END_DISABLED);
  gtksourcesmarthomeendtype.constant("BEFORE",
                                     (int)GTK_SOURCE_SMART_HOME_END_BEFORE);
  gtksourcesmarthomeendtype.constant("AFTER",
                                     (int)GTK_SOURCE_SMART_HOME_END_AFTER);
  gtksourcesmarthomeendtype.constant("ALWAYS",
                                     (int)GTK_SOURCE_SMART_HOME_END_ALWAYS);
  ...
  gtksourcedrawspacesflags.constant("NEWLINE",
                                    (int)GTK_SOURCE_DRAW_SPACES_NEWLINE);
  gtksourcedrawspacesflags.constant("NBSP", (int)GTK_SOURCE_DRAW_SPACES_NBSP);
  gtksourcedrawspacesflags.constant("LEADING",
                                    (int)GTK_SOURCE_DRAW_SPACES_LEADING);
  gtksourcedrawspacesflags.constant("TEXT", (int)GTK_SOURCE_DRAW_SPACES_TEXT);
  gtksourcedrawspacesflags.constant("TRAILING",
                                    (int)GTK_SOURCE_DRAW_SPACES_TRAILING);
  gtksourcedrawspacesflags.constant("ALL", (int)GTK_SOURCE_DRAW_SPACES_ALL);

  // GtkSourceBackgroundPatternType
  Php::Class<Php::Base> gtksourcebackgroundpatterntype(
      "GtkSourceBackgroundPatternType");
  gtksourcebackgroundpatterntype.constant(
      "NONE", (int)GTK_SOURCE_BACKGROUND_PATTERN_TYPE_NONE);
  gtksourcebackgroundpatterntype.constant(
      "GRID", (int)GTK_SOURCE_BACKGROUND_PATTERN_TYPE_GRID);
  ...
  gtksourceview.method<&GtkSourceView_::set_show_line_numbers>(
      "set_show_line_numbers");
  gtksourceview.method<&GtkSourceView_::get_show_line_numbers>(
      "get_show_line_numbers");
  gtksourceview.method<&GtkSourceView_::set_show_right_margin>(
      "set_show_right_margin");
  gtksourceview.method<&GtkSourceView_::get_show_right_margin>(
      "get_show_right_margin");
  gtksourceview.method<&GtkSourceView_::set_right_margin_position>(
      "set_right_margin_position");
  gtksourceview.method<&GtkSourceView_::get_right_margin_position>(
      "get_right_margin_position");
  gtksourceview.method<&GtkSourceView_::set_highlight_current_line>(
      "set_highlight_current_line");
  gtksourceview.method<&GtkSourceView_::get_highlight_current_line>(
  ...
  gtksourceview.method<&GtkSourceView_::set_insert_spaces_instead_of_tabs>(
      "set_insert_spaces_instead_of_tabs");
  gtksourceview.method<&GtkSourceView_::get_insert_spaces_instead_of_tabs>(
  ...
  gtksourceview.method<&GtkSourceView_::set_smart_backspace>(
      "set_smart_backspace");
  gtksourceview.method<&GtkSourceView_::get_smart_backspace>(
      "get_smart_backspace");
  gtksourceview.method<&GtkSourceView_::set_smart_home_end>(
      "set_smart_home_end");
  gtksourceview.method<&GtkSourceView_::get_smart_home_end>(
      "get_smart_home_end");
  gtksourceview.method<&GtkSourceView_::set_mark_attributes>(
      "set_mark_attributes");
  gtksourceview.method<&GtkSourceView_::get_mark_attributes>(
      "get_mark_attributes");
  gtksourceview.method<&GtkSourceView_::set_show_line_marks>(
      "set_show_line_marks");
  gtksourceview.method<&GtkSourceView_::get_show_line_marks>(
      "get_show_line_marks");
  ...
  gtksourceview.method<&GtkSourceView_::set_background_pattern>(
      "set_background_pattern");
  gtksourceview.method<&GtkSourceView_::get_background_pattern>(
  ...
  gtksourcebuffer.method<&GtkSourceBuffer_::new_with_language>(
      "new_with_language");
  ...
  gtksourcechangecasetype.constant("TOGGLE",
                                   (int)GTK_SOURCE_CHANGE_CASE_TOGGLE);
  gtksourcechangecasetype.constant("TITLE", (int)GTK_SOURCE_CHANGE_CASE_TITLE);

  // GtkSourceLanguageManager
  Php::Class<GtkSourceLanguageManager_> gtksourcelanguagemanager(
      "GtkSourceLanguageManager");
  gtksourcelanguagemanager.extends(gobject);
  gtksourcelanguagemanager.method<&GtkSourceLanguageManager_::__construct>(
      "__construct");
  gtksourcelanguagemanager.method<&GtkSourceLanguageManager_::get_default>(
      "get_default");
  gtksourcelanguagemanager.method<&GtkSourceLanguageManager_::get_language>(
      "get_language");
  gtksourcelanguagemanager.method<&GtkSourceLanguageManager_::get_language_ids>(
      "get_language_ids");
  gtksourcelanguagemanager.method<&GtkSourceLanguageManager_::set_search_path>(
      "set_search_path");
  gtksourcelanguagemanager.method<&GtkSourceLanguageManager_::get_search_path>(
      "get_search_path");
  gtksourcelanguagemanager.method<&GtkSourceLanguageManager_::guess_language>(
      "guess_language");
  ...
  webkitwebview.method<&WebKitWebView_::register_script_message_handler>(
      "register_script_message_handler");
  webkitwebview.method<&WebKitWebView_::enable_developer_extras>(
      "enable_developer_extras");
  webkitwebview.method<&WebKitWebView_::get_settings>("get_settings");
  webkitwebview.method<&WebKitWebView_::set_user_data_folder>(
  ...
  gtkosxapplication.method<&GtkosxApplication_::set_dock_icon_pixbuf>(
      "set_dock_icon_pixbuf");
  ...
  gtkosxapplication.method<&GtkosxApplication_::set_use_quartz_accelerators>(
      "set_use_quartz_accelerators");
  gtkosxapplication.method<&GtkosxApplication_::use_quartz_accelerators>(
      "use_quartz_accelerators");
  gtkosxapplication.method<&GtkosxApplication_::set_menu_bar>("set_menu_bar");
  gtkosxapplication.method<&GtkosxApplication_::insert_app_menu_item>(
      "insert_app_menu_item");
  gtkosxapplication.method<&GtkosxApplication_::set_window_menu>(
      "set_window_menu");
  ...
  gtkosxapplication.method<&GtkosxApplication_::set_dock_icon_resource>(
      "set_dock_icon_resource");
  gtkosxapplication.method<&GtkosxApplication_::attention_request>(
      "attention_request");
  gtkosxapplication.method<&GtkosxApplication_::cancel_attention_request>(
      "cancel_attention_request");
  gtkosxapplication.method<&GtkosxApplication_::get_bundle_path>(
      "get_bundle_path");
  gtkosxapplication.method<&GtkosxApplication_::get_resource_path>(
      "get_resource_path");
  gtkosxapplication.method<&GtkosxApplication_::get_executable_path>(
      "get_executable_path");
  gtkosxapplication.method<&GtkosxApplication_::get_bundle_id>("get_bundle_id");
  gtkosxapplication.method<&GtkosxApplication_::get_bundle_info>(
      "get_bundle_info");
#endif
...
GValue phpgtk_get_gvalue(const Php::Value &phpgtk_value, GType type_column) {
  ...
  case G_TYPE_BOOLEAN: {
    ...
    g_value_set_boolean(&gtk_value, static_cast<gboolean>(b));
...
void phpgtk_throw_wrong_type(int param, Php::Type type) {
  ...
  // Get len of string
  len = snprintf(nullptr, 0, "expects at least %d parameters, %s given", param,
                 str_type.c_str());
  buffer = (char *)malloc((len + 1) * sizeof(char));

  // Save into buffer
  snprintf(buffer, len + 1, "expects at least %d parameters, %s given", param,
           str_type.c_str());
