...
PHPCPP_EXPORT void *get_module() {
  ...
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::set_do_overwrite_confirmation>(
      "set_do_overwrite_confirmation");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_do_overwrite_confirmation>(
  ...
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::set_preview_widget_active>(
      "set_preview_widget_active");
  gtkfilechooserdialog.method<&GtkFileChooserDialog_::get_preview_widget_active>(
  ...
  gtknumberuplayout.constant("LEFT_TO_RIGHT_TOP_TO_BOTTOM",
                             (int)GTK_NUMBER_UP_LAYOUT_LEFT_TO_RIGHT_TOP_TO_BOTTOM);
  gtknumberuplayout.constant("LEFT_TO_RIGHT_BOTTOM_TO_TOP",
                             (int)GTK_NUMBER_UP_LAYOUT_LEFT_TO_RIGHT_BOTTOM_TO_TOP);
  gtknumberuplayout.constant("RIGHT_TO_LEFT_TOP_TO_BOTTOM",
                             (int)GTK_NUMBER_UP_LAYOUT_RIGHT_TO_LEFT_TOP_TO_BOTTOM);
  gtknumberuplayout.constant("RIGHT_TO_LEFT_BOTTOM_TO_TOP",
                             (int)GTK_NUMBER_UP_LAYOUT_RIGHT_TO_LEFT_BOTTOM_TO_TOP);
  gtknumberuplayout.constant("TOP_TO_BOTTOM_LEFT_TO_RIGHT",
                             (int)GTK_NUMBER_UP_LAYOUT_TOP_TO_BOTTOM_LEFT_TO_RIGHT);
  gtknumberuplayout.constant("TOP_TO_BOTTOM_RIGHT_TO_LEFT",
                             (int)GTK_NUMBER_UP_LAYOUT_TOP_TO_BOTTOM_RIGHT_TO_LEFT);
  gtknumberuplayout.constant("BOTTOM_TO_TOP_LEFT_TO_RIGHT",
                             (int)GTK_NUMBER_UP_LAYOUT_BOTTOM_TO_TOP_LEFT_TO_RIGHT);
  gtknumberuplayout.constant("BOTTOM_TO_TOP_RIGHT_TO_LEFT",
  ...
  gtkstacktransitiontype.constant("SLIDE_LEFT_RIGHT",
                                  (int)GTK_STACK_TRANSITION_TYPE_SLIDE_LEFT_RIGHT);
  ...
  gtkstacktransitiontype.constant("OVER_LEFT_RIGHT",
                                  (int)GTK_STACK_TRANSITION_TYPE_OVER_LEFT_RIGHT);
  gtkstacktransitiontype.constant("OVER_RIGHT_LEFT",
                                  (int)GTK_STACK_TRANSITION_TYPE_OVER_RIGHT_LEFT);
