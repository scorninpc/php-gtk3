srcdir = /home/scorninpc/Desktop/extensions/php-5.5.7/ext/gtk
builddir = /home/scorninpc/Desktop/extensions/php-5.5.7/ext/gtk
top_srcdir = /home/scorninpc/Desktop/extensions/php-5.5.7/ext/gtk
...
./gtk.la: $(shared_objects_gtk) $(GTK_SHARED_DEPENDENCIES)
	$(LIBTOOL) --mode=link $(CC) $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS) $(LDFLAGS) -o $@ -export-dynamic -avoid-version -prefer-pic -module -rpath $(phplibdir) $(EXTRA_LDFLAGS) $(shared_objects_gtk) $(GTK_SHARED_LIBADD)
