...
class Application
{
	...
	public function __construct()
	{
		...
		$tlb_btn1->set_icon_name("gtk-close");
		$tlb->insert($tlb_btn1, -1);
	...
	public function create_new_tab($label)
	{
		...
		$button_close = GtkButton::new_from_icon_name("gtk-close", GtkIconSize::BUTTON);
		...
		$scroll->add($text);
		$scroll->set_policy(GtkPolicyType::AUTOMATIC, GtkPolicyType::AUTOMATIC);
		$this->ntb->insert_page($scroll, $hbox, -1);
