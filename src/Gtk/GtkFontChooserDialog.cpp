...
Php::Value GtkFontChooserDialog_::get_preview_text() {
  std::string ret =
      gtk_font_chooser_get_preview_text(GTK_FONT_CHOOSER(instance));
...
Php::Value GtkFontChooserDialog_::get_show_preview_entry() {
  bool ret =
      gtk_font_chooser_get_show_preview_entry(GTK_FONT_CHOOSER(instance)) != 0;

  return ret;
}

void GtkFontChooserDialog_::set_show_preview_entry(
    Php::Parameters &parameters) {
  gboolean show_preview_entry = (gboolean)parameters[0];

  gtk_font_chooser_set_show_preview_entry(GTK_FONT_CHOOSER(instance),
                                          show_preview_entry);
}
