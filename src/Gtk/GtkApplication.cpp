...
Php::Value GtkApplication_::get_window_by_id(Php::Parameters &parameters) {
  ...
  GtkWindow *ret =
      gtk_application_get_window_by_id(GTK_APPLICATION(instance), id);
...
Php::Value GtkApplication_::inhibit(Php::Parameters &parameters) {
  ...
  int ret =
      gtk_application_inhibit(GTK_APPLICATION(instance), window, flags, reason);
...
Php::Value GtkApplication_::is_inhibited(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_application_is_inhibited(GTK_APPLICATION(instance), flags) != 0;

  return ret;
}

Php::Value GtkApplication_::prefers_app_menu() {
  bool ret = gtk_application_prefers_app_menu(GTK_APPLICATION(instance)) != 0;
...
Php::Value GtkApplication_::get_menubar() {
  // 	GMenuModel ret = gtk_application_get_menubar
  // (GTK_APPLICATION(instance));
...
Php::Value GtkApplication_::get_menu_by_id(Php::Parameters &parameters) {
  ...
  // 	GMenu ret = gtk_application_get_menu_by_id (GTK_APPLICATION(instance),
  // id);
...
void GtkApplication_::add_accelerator(Php::Parameters &parameters) {
  ...
  //
  // 	gtk_application_add_accelerator (GTK_APPLICATION(instance), accelerator,
  // action_name, parameter);

  Php::deprecated
      << "GtkApplication_::add_accelerator  is deprecated on Gtk 3.14";
}
...
void GtkApplication_::remove_accelerator(Php::Parameters &parameters) {
  ...
  //
  // 	gtk_application_remove_accelerator (GTK_APPLICATION(instance),
  // action_name, parameter);

  Php::deprecated
      << "GtkApplication_::remove_accelerator  is deprecated on Gtk 3.14";
}

Php::Value GtkApplication_::list_action_descriptions() {
  std::string ret =
      *gtk_application_list_action_descriptions(GTK_APPLICATION(instance));
...
Php::Value GtkApplication_::get_accels_for_action(Php::Parameters &parameters) {
  ...
  std::string ret = *gtk_application_get_accels_for_action(
      GTK_APPLICATION(instance), detailed_action_name);
...
void GtkApplication_::set_accels_for_action(Php::Parameters &parameters) {
  ...
  // gtk_application_set_accels_for_action (GTK_APPLICATION(instance),
  // detailed_action_name, accels);
...
Php::Value GtkApplication_::get_actions_for_accel(Php::Parameters &parameters) {
  ...
  // std::string ret = *gtk_application_get_actions_for_accel
  // (GTK_APPLICATION(instance), b);
