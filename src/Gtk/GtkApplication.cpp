...
void GtkApplication_::add_accelerator(Php::Parameters &parameters) {
  ...
  //
  // 	gtk_application_add_accelerator (GTK_APPLICATION(instance), accelerator, action_name,
  // parameter);
...
Php::Value GtkApplication_::get_accels_for_action(Php::Parameters &parameters) {
  ...
  std::string ret =
      *gtk_application_get_accels_for_action(GTK_APPLICATION(instance), detailed_action_name);
...
void GtkApplication_::set_accels_for_action(Php::Parameters &parameters) {
  ...
  // gtk_application_set_accels_for_action (GTK_APPLICATION(instance), detailed_action_name,
  // accels);
