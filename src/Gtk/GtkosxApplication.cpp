...
void GtkosxApplication_::set_dock_icon_pixbuf(Php::Parameters &parameters) {
  ...
  gtkosx_application_set_dock_icon_pixbuf(GTKOSX_APPLICATION(instance),
                                          passedPixbuf->get_instance());
}

void GtkosxApplication_::set_use_quartz_accelerators(
    Php::Parameters &parameters) {
  gboolean use_quartz_accelerators = parameters[0];

  gtkosx_application_set_use_quartz_accelerators(GTKOSX_APPLICATION(instance),
...
Php::Value GtkosxApplication_::use_quartz_accelerators() {
  bool ret =
      gtkosx_application_use_quartz_accelerators(GTKOSX_APPLICATION(instance));
...
void GtkosxApplication_::set_menu_bar(Php::Parameters &parameters) {
  ...
  gtkosx_application_set_menu_bar(
      GTKOSX_APPLICATION(instance),
      GTK_MENU_SHELL(passedMenuShell->get_instance()));
}
...
void GtkosxApplication_::insert_app_menu_item(Php::Parameters &parameters) {
  ...
  gtkosx_application_insert_app_menu_item(
      GTKOSX_APPLICATION(instance), GTK_WIDGET(passedWidget->get_instance()),
      index);
}
...
void GtkosxApplication_::set_window_menu(Php::Parameters &parameters) {
  ...
  gtkosx_application_set_window_menu(
      GTKOSX_APPLICATION(instance),
      GTK_MENU_ITEM(passedMenuItem->get_instance()));
}
...
void GtkosxApplication_::cancel_attention_request(Php::Parameters &parameters) {
  ...
  gtkosx_application_cancel_attention_request(GTKOSX_APPLICATION(instance),
                                              index);
}
