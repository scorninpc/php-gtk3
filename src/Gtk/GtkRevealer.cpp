...
void GtkRevealer_::__construct() { instance = (gpointer *)gtk_revealer_new(); }

Php::Value GtkRevealer_::get_reveal_child() {
  bool ret = gtk_revealer_get_reveal_child(GTK_REVEALER(instance)) != 0;
...
Php::Value GtkRevealer_::get_child_revealed() {
  bool ret = gtk_revealer_get_child_revealed(GTK_REVEALER(instance)) != 0;
...
Php::Value GtkRevealer_::get_transition_type() {
  GtkRevealerTransitionType ret =
      gtk_revealer_get_transition_type(GTK_REVEALER(instance));
...
void GtkRevealer_::set_transition_type(Php::Parameters &parameters) {
  ...
  GtkRevealerTransitionType transition =
      (GtkRevealerTransitionType)int_transition;
