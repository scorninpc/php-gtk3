...
Php::Value GtkRecentChooserDialog_::new_for_manager(Php::Parameters &parameters) {
  ...
  // GtkWidget *ret = gtk_recent_chooser_dialog_new_for_manager (GTK_RECENT_CHOOSER(instance),
  // parent, manager, first_button_text, );
...
void GtkRecentChooserDialog_::set_sort_func(Php::Parameters &parameters) {
  ...
  // gtk_recent_chooser_set_sort_func (GTK_RECENT_CHOOSER(instance), sort_func, sort_data,
  // data_destroy);
