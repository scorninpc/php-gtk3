...
void GtkRecentChooserDialog_::__construct(Php::Parameters &parameters) {
  ...
  instance = (gpointer *)gtk_recent_chooser_dialog_new(title, parent, arr[0],
                                                       (int)arr[1], NULL);
...
Php::Value
GtkRecentChooserDialog_::new_for_manager(Php::Parameters &parameters) {
  // GtkWindow *parent;
  // if(parameters.size() > 0) {
  // 	Php::Value object_parent = parameters[0];
  // 	GtkWindow_ *phpgtk_parent = (GtkWindow_
  // *)object_parent.implementation(); 	parent =
  // GTK_WIDGET(phpgtk_parent->get_instance());
  // }

  // GtkRecentManager *manager;
  // if(parameters.size() > 1) {
  // 	Php::Value object_manager = parameters[1];
  // 	GtkRecentManager_ *phpgtk_manager = (GtkRecentManager_
  // *)object_manager.implementation(); 	manager =
  // GTK_WIDGET(phpgtk_manager->get_instance());
  // }

  // std::string s_first_button_text = parameters[2];
  // gchar *first_button_text = (gchar *)s_first_button_text.c_str();

  // GtkWidget *ret = gtk_recent_chooser_dialog_new_for_manager
  // (GTK_RECENT_CHOOSER(instance), parent, manager, first_button_text, );
  ...
  throw Php::Exception(
      "GtkRecentChooserDialog_::new_for_manager not implemented");
}

void GtkRecentChooserDialog_::set_show_private(Php::Parameters &parameters) {
  gboolean show_private = (gboolean)parameters[0];

  gtk_recent_chooser_set_show_private(GTK_RECENT_CHOOSER(instance),
                                      show_private);
}

Php::Value GtkRecentChooserDialog_::get_show_private() {
  bool ret =
      gtk_recent_chooser_get_show_private(GTK_RECENT_CHOOSER(instance)) != 0;
...
void GtkRecentChooserDialog_::set_show_not_found(Php::Parameters &parameters) {
  ...
  gtk_recent_chooser_set_show_not_found(GTK_RECENT_CHOOSER(instance),
                                        show_not_found);
}

Php::Value GtkRecentChooserDialog_::get_show_not_found() {
  bool ret =
      gtk_recent_chooser_get_show_not_found(GTK_RECENT_CHOOSER(instance)) != 0;
...
Php::Value GtkRecentChooserDialog_::get_show_icons() {
  bool ret =
      gtk_recent_chooser_get_show_icons(GTK_RECENT_CHOOSER(instance)) != 0;
...
void GtkRecentChooserDialog_::set_select_multiple(Php::Parameters &parameters) {
  ...
  gtk_recent_chooser_set_select_multiple(GTK_RECENT_CHOOSER(instance),
                                         select_multiple);
}

Php::Value GtkRecentChooserDialog_::get_select_multiple() {
  bool ret =
      gtk_recent_chooser_get_select_multiple(GTK_RECENT_CHOOSER(instance)) != 0;
...
Php::Value GtkRecentChooserDialog_::get_local_only() {
  bool ret =
      gtk_recent_chooser_get_local_only(GTK_RECENT_CHOOSER(instance)) != 0;
...
Php::Value GtkRecentChooserDialog_::get_show_tips() {
  bool ret =
      gtk_recent_chooser_get_show_tips(GTK_RECENT_CHOOSER(instance)) != 0;
...
Php::Value GtkRecentChooserDialog_::get_sort_type() {
  GtkRecentSortType ret =
      gtk_recent_chooser_get_sort_type(GTK_RECENT_CHOOSER(instance));
...
void GtkRecentChooserDialog_::set_sort_func(Php::Parameters &parameters) {
  ...
  // gtk_recent_chooser_set_sort_func (GTK_RECENT_CHOOSER(instance), sort_func,
  // sort_data, data_destroy);

  throw Php::Exception(
      "GtkRecentChooserDialog_::set_sort_func not implemented");
}

Php::Value
GtkRecentChooserDialog_::set_current_uri(Php::Parameters &parameters) {
  std::string s_uri = parameters[0];
  gchar *uri = (gchar *)s_uri.c_str();

  GError *error = nullptr;

  bool ret = gtk_recent_chooser_set_current_uri(GTK_RECENT_CHOOSER(instance),
                                                uri, &error) != 0;
...
Php::Value GtkRecentChooserDialog_::get_current_item() {
  // GtkRecentInfo *ret = gtk_recent_chooser_get_current_item
  // (GTK_RECENT_CHOOSER(instance));
  ...
  throw Php::Exception(
      "GtkRecentChooserDialog_::get_current_item not implemented");
  return 1;
}
...
Php::Value GtkRecentChooserDialog_::select_uri(Php::Parameters &parameters) {
  ...
  bool ret = gtk_recent_chooser_select_uri(GTK_RECENT_CHOOSER(instance), uri,
                                           &error) != 0;
...
Php::Value GtkRecentChooserDialog_::get_uris(Php::Parameters &parameters) {
  ...
  gchar **ret =
      gtk_recent_chooser_get_uris(GTK_RECENT_CHOOSER(instance), &length);
...
void GtkRecentChooserDialog_::add_filter(Php::Parameters &parameters) {
  ...
  // 	GtkRecentFilter_ *phpgtk_filter = (GtkRecentFilter_
  // *)object_filter.implementation(); 	filter =
  // GTK_WIDGET(phpgtk_filter->get_instance());
  // }
...
void GtkRecentChooserDialog_::remove_filter(Php::Parameters &parameters) {
  ...
  throw Php::Exception(
      "GtkRecentChooserDialog_::remove_filter not implemented");
}
...
Php::Value GtkRecentChooserDialog_::get_filter() {
  // GtkRecentFilter *ret = gtk_recent_chooser_get_filter
  // (GTK_RECENT_CHOOSER(instance));
