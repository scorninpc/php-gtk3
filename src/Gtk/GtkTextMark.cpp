...
Php::Value GtkTextMark_::set_buffer() {
  bool ret = gtk_text_mark_get_visible(GTK_TEXT_MARK(instance)) != 0;

  return ret;
}

Php::Value GtkTextMark_::get_deleted() {
  bool ret = gtk_text_mark_get_deleted(GTK_TEXT_MARK(instance)) != 0;
...
Php::Value GtkTextMark_::get_left_gravity() {
  bool ret = gtk_text_mark_get_left_gravity(GTK_TEXT_MARK(instance)) != 0;
