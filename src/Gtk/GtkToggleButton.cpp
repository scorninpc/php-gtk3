...
Php::Value GtkToggleButton_::get_mode() {
  bool ret = gtk_toggle_button_get_mode(GTK_TOGGLE_BUTTON(instance)) != 0;
...
Php::Value GtkToggleButton_::get_active() {
  bool ret = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(instance)) != 0;
...
Php::Value GtkToggleButton_::get_inconsistent() {
  bool ret =
      gtk_toggle_button_get_inconsistent(GTK_TOGGLE_BUTTON(instance)) != 0;
