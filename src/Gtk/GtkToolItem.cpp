...
void GtkToolItem_::__construct() { instance = (gpointer *)gtk_tool_item_new(); }
...
Php::Value GtkToolItem_::get_homogeneous() {
  bool ret = gtk_tool_item_get_homogeneous(GTK_TOOL_ITEM(instance)) != 0;
...
Php::Value GtkToolItem_::get_expand() {
  bool ret = gtk_tool_item_get_expand(GTK_TOOL_ITEM(instance)) != 0;
...
Php::Value GtkToolItem_::get_use_drag_window() {
  bool ret = gtk_tool_item_get_use_drag_window(GTK_TOOL_ITEM(instance)) != 0;
...
void GtkToolItem_::set_visible_horizontal(Php::Parameters &parameters) {
  ...
  gtk_tool_item_set_visible_horizontal(GTK_TOOL_ITEM(instance),
                                       visible_horizontal);
}

Php::Value GtkToolItem_::get_visible_horizontal() {
  bool ret = gtk_tool_item_get_visible_horizontal(GTK_TOOL_ITEM(instance)) != 0;
...
Php::Value GtkToolItem_::get_visible_vertical() {
  bool ret = gtk_tool_item_get_visible_vertical(GTK_TOOL_ITEM(instance)) != 0;
...
Php::Value GtkToolItem_::get_is_important() {
  bool ret = gtk_tool_item_get_is_important(GTK_TOOL_ITEM(instance)) != 0;
...
Php::Value GtkToolItem_::get_toolbar_style() {
  GtkToolbarStyle ret =
      gtk_tool_item_get_toolbar_style(GTK_TOOL_ITEM(instance));
...
Php::Value GtkToolItem_::get_text_orientation() {
  GtkOrientation ret =
      gtk_tool_item_get_text_orientation(GTK_TOOL_ITEM(instance));

  return ret;
}

Php::Value GtkToolItem_::retrieve_proxy_menu_item() {
  gpointer *ret = (gpointer *)gtk_tool_item_retrieve_proxy_menu_item(
      GTK_TOOL_ITEM(instance));
...
void GtkToolItem_::set_proxy_menu_item(Php::Parameters &parameters) {
  ...
  if (parameters.size() > 1) {
    ...
    GtkWidget_ *phpgtk_menu_item =
        (GtkWidget_ *)object_menu_item.implementation();
    menu_item = GTK_WIDGET(phpgtk_menu_item->get_instance());
  }

  gtk_tool_item_set_proxy_menu_item(GTK_TOOL_ITEM(instance), menu_item_id,
                                    menu_item);
}
...
Php::Value GtkToolItem_::get_proxy_menu_item(Php::Parameters &parameters) {
  ...
  gpointer *ret = (gpointer *)gtk_tool_item_get_proxy_menu_item(
      GTK_TOOL_ITEM(instance), menu_item_id);
