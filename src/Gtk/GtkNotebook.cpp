...
void GtkNotebook_::__construct() { instance = (gpointer *)gtk_notebook_new(); }
...
Php::Value GtkNotebook_::append_page(Php::Parameters &parameters) {
  ...
  if (parameters.size() > 1) {
    ...
    GtkWidget_ *phpgtk_tab_label =
        (GtkWidget_ *)object_tab_label.implementation();
...
Php::Value GtkNotebook_::prepend_page(Php::Parameters &parameters) {
  ...
  gint ret =
      gtk_notebook_prepend_page(GTK_NOTEBOOK(instance), child, tab_label);
...
Php::Value GtkNotebook_::insert_page(Php::Parameters &parameters) {
  ...
  gint ret = gtk_notebook_insert_page(GTK_NOTEBOOK(instance), child, tab_label,
                                      position);
...
Php::Value GtkNotebook_::get_menu_label(Php::Parameters &parameters) {
  ...
  gpointer *ret =
      (gpointer *)gtk_notebook_get_menu_label(GTK_NOTEBOOK(instance), child);
...
Php::Value GtkNotebook_::get_nth_page(Php::Parameters &parameters) {
  ...
  gpointer *ret =
      (gpointer *)gtk_notebook_get_nth_page(GTK_NOTEBOOK(instance), page_num);
...
Php::Value GtkNotebook_::get_tab_label(Php::Parameters &parameters) {
  ...
  gpointer *ret =
      (gpointer *)gtk_notebook_get_tab_label(GTK_NOTEBOOK(instance), child);
...
void GtkNotebook_::set_menu_label(Php::Parameters &parameters) {
  ...
  GtkWidget *menu_label = nullptr;
  if (parameters.size() > 1) {
    Php::Value object_menu_label = parameters[1];
    GtkWidget_ *phpgtk_menu_label =
        (GtkWidget_ *)object_menu_label.implementation();
...
Php::Value GtkNotebook_::get_menu_label_text(Php::Parameters &parameters) {
  ...
  std::string ret =
      gtk_notebook_get_menu_label_text(GTK_NOTEBOOK(instance), child);

  return ret;
}

Php::Value GtkNotebook_::get_scrollable() {
  bool ret = gtk_notebook_get_scrollable(GTK_NOTEBOOK(instance)) != 0;

  return ret;
}

Php::Value GtkNotebook_::get_show_border() {
  bool ret = gtk_notebook_get_show_border(GTK_NOTEBOOK(instance)) != 0;

  return ret;
}

Php::Value GtkNotebook_::get_show_tabs() {
  bool ret = gtk_notebook_get_show_tabs(GTK_NOTEBOOK(instance)) != 0;
...
Php::Value GtkNotebook_::get_tab_label_text(Php::Parameters &parameters) {
  ...
  std::string ret =
      gtk_notebook_get_tab_label_text(GTK_NOTEBOOK(instance), child);
...
Php::Value GtkNotebook_::get_tab_reorderable(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_notebook_get_tab_reorderable(GTK_NOTEBOOK(instance), child) != 0;
...
Php::Value GtkNotebook_::get_tab_detachable(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_notebook_get_tab_detachable(GTK_NOTEBOOK(instance), child) != 0;
...
Php::Value GtkNotebook_::get_action_widget(Php::Parameters &parameters) {
  ...
  gpointer *ret = (gpointer *)gtk_notebook_get_action_widget(
      GTK_NOTEBOOK(instance), pack_type);
