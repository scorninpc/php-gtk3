...
void GtkStack_::__construct() { instance = (gpointer *)gtk_stack_new(); }
...
Php::Value GtkStack_::get_child_by_name(Php::Parameters &parameters) {
  ...
  gpointer *ret =
      (gpointer *)gtk_stack_get_child_by_name(GTK_STACK(instance), name);
...
Php::Value GtkStack_::get_homogeneous() {
  bool ret = gtk_stack_get_homogeneous(GTK_STACK(instance)) != 0;
...
Php::Value GtkStack_::get_hhomogeneous() {
  bool ret = gtk_stack_get_hhomogeneous(GTK_STACK(instance)) != 0;
...
Php::Value GtkStack_::get_vhomogeneous() {
  bool ret = gtk_stack_get_vhomogeneous(GTK_STACK(instance)) != 0;
...
Php::Value GtkStack_::get_transition_type() {
  GtkStackTransitionType ret =
      gtk_stack_get_transition_type(GTK_STACK(instance));

  return ret;
}

Php::Value GtkStack_::get_transition_running() {
  bool ret = gtk_stack_get_transition_running(GTK_STACK(instance)) != 0;

  return ret;
}

Php::Value GtkStack_::get_interpolate_size() {
  bool ret = gtk_stack_get_interpolate_size(GTK_STACK(instance)) != 0;
