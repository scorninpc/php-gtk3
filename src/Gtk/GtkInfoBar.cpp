...
void GtkInfoBar_::__construct() { instance = (gpointer *)gtk_info_bar_new(); }
...
Php::Value GtkInfoBar_::new_with_buttons(Php::Parameters &parameters) {
  ...
  gpointer *ret =
      (gpointer *)gtk_info_bar_new_with_buttons(arr[0], (int)arr[1], NULL);
...
Php::Value GtkInfoBar_::add_button(Php::Parameters &parameters) {
  ...
  gpointer *ret = (gpointer *)gtk_info_bar_add_button(GTK_INFO_BAR(instance),
...
void GtkInfoBar_::add_buttons(Php::Parameters &parameters) {
  ...
  for (int index = 0; index < (int)arr.size(); index += 2) {
    gtk_info_bar_add_buttons(GTK_INFO_BAR(instance), arr[index],
                             (int)arr[index + 1]);
  }
}
...
void GtkInfoBar_::set_response_sensitive(Php::Parameters &parameters) {
  ...
  gtk_info_bar_set_response_sensitive(GTK_INFO_BAR(instance), response_id,
                                      setting);
}
...
Php::Value GtkInfoBar_::get_action_area() {
  gpointer *ret =
      (gpointer *)gtk_info_bar_get_action_area(GTK_INFO_BAR(instance));
...
Php::Value GtkInfoBar_::get_content_area() {
  gpointer *ret =
      (gpointer *)gtk_info_bar_get_content_area(GTK_INFO_BAR(instance));
...
Php::Value GtkInfoBar_::get_show_close_button() {
  bool ret = gtk_info_bar_get_show_close_button(GTK_INFO_BAR(instance)) != 0;
