...
Php::Value GtkContainer_::class_find_child_property(Php::Parameters &parameters) {
  ...
  // GParamSpec ret = gtk_container_class_find_child_property (GTK_CONTAINER(instance),
  // property_name);
...
Php::Value GtkContainer_::class_list_child_properties(Php::Parameters &parameters) {
  ...
  // GParamSpec ret = *gtk_container_class_list_child_properties (GTK_CONTAINER(instance),
  // n_properties);
