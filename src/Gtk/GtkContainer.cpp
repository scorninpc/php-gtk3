...
void GtkContainer_::add_with_properties(Php::Parameters &parameters) {
  ...
  // gtk_container_add_with_properties (GTK_CONTAINER(instance), widget,
  // first_prop_name, );
...
Php::Value GtkContainer_::get_resize_mode() {
  // GtkResizeMode ret = gtk_container_get_resize_mode
...
void GtkContainer_::foreach (Php::Parameters &parameters) {
  ...
  // 	GtkCallback_ *phpgtk_callback = (GtkCallback_
...
Php::Value GtkContainer_::get_children() {
  ...
  if (ret == nullptr) {
    return Php::Array(); // ← immediately return empty array
  }

  Php::Array ret_arr;
  for (int i = 0; GList *item != nullptr = g_list_nth(ret, i); ++i) {
    ret_arr[i] = cobject_to_phpobject((gpointer *)item->data);
  }
  g_list_free(ret);
  return ret_arr;
}
...
Php::Value GtkContainer_::get_path_for_child(Php::Parameters &parameters) {
  ...
  GtkWidgetPath *ret =
      gtk_container_get_path_for_child(GTK_CONTAINER(instance), child);
...
void GtkContainer_::set_reallocate_redraws(Php::Parameters &parameters) {
  ...
  // gtk_container_set_reallocate_redraws (GTK_CONTAINER(instance),
  // needs_redraws);
...
Php::Value GtkContainer_::get_focus_child() {
  gpointer *ret =
      (gpointer *)gtk_container_get_focus_child(GTK_CONTAINER(instance));
...
Php::Value GtkContainer_::get_focus_vadjustment() {
  GtkAdjustment *ret =
      gtk_container_get_focus_vadjustment(GTK_CONTAINER(instance));
...
void GtkContainer_::set_focus_vadjustment(Php::Parameters &parameters) {
  ...
  if (!parameters.empty()) {
    ...
    GtkAdjustment_ *phpgtk_adjustment =
        (GtkAdjustment_ *)object_adjustment.implementation();
...
Php::Value GtkContainer_::get_focus_hadjustment() {
  GtkAdjustment *ret =
      gtk_container_get_focus_hadjustment(GTK_CONTAINER(instance));
...
void GtkContainer_::child_get_property(Php::Parameters &parameters) {
  ...
  // gtk_container_child_get_property (GTK_CONTAINER(instance), child,
  // property_name, value);
...
void GtkContainer_::child_set_property(Php::Parameters &parameters) {
  ...
  // gtk_container_child_set_property (GTK_CONTAINER(instance), child,
  // property_name, value);
...
void GtkContainer_::child_get_valist(Php::Parameters &parameters) {
  ...
  // gtk_container_child_get_valist (GTK_CONTAINER(instance), child,
...
void GtkContainer_::child_set_valist(Php::Parameters &parameters) {
  ...
  // gtk_container_child_set_valist (GTK_CONTAINER(instance), child,
  // first_property_name, var_args);
...
void GtkContainer_::child_notify_by_pspec(Php::Parameters &parameters) {
  ...
  // gtk_container_child_notify_by_pspec (GTK_CONTAINER(instance), child,
  // pspec);
...
Php::Value
GtkContainer_::class_find_child_property(Php::Parameters &parameters) {
  // std::string s_property_name = parameters[0];
  // gchar *property_name = (gchar *)s_property_name.c_str();

  // GParamSpec ret = gtk_container_class_find_child_property
  // (GTK_CONTAINER(instance), property_name);

  // return ret;

  throw Php::Exception(
      "GtkContainer_::class_find_child_property not implemented");
  return 0;
}
...
void GtkContainer_::class_install_child_property(Php::Parameters &parameters) {
  ...
  // gtk_container_class_install_child_property (GTK_CONTAINER(instance),
  // property_id, pspec);

  throw Php::Exception(
      "GtkContainer_::class_install_child_property not implemented");
}

void GtkContainer_::class_install_child_properties(
    Php::Parameters &parameters) {
  // guint n_pspecs = (int)parameters[0];

  // gtk_container_class_install_child_properties (GTK_CONTAINER(instance),
  // n_pspecs, pspecs);

  throw Php::Exception(
      "GtkContainer_::class_install_child_properties not implemented");
}

Php::Value
GtkContainer_::class_list_child_properties(Php::Parameters &parameters) {
  // guint n_properties = (int)parameters[0];

  // GParamSpec ret = *gtk_container_class_list_child_properties
  // (GTK_CONTAINER(instance), n_properties);

  // return ret;

  throw Php::Exception(
      "GtkContainer_::class_list_child_properties not implemented");
  return 0;
}
...
void GtkContainer_::class_handle_border_width() {
  ...
  throw Php::Exception(
      "GtkContainer_::class_handle_border_width not implemented");
}
