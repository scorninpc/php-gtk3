...
Php::Value GtkButtonBox_::get_child_secondary(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_button_box_get_child_secondary(GTK_BUTTON_BOX(instance), child) != 0;

  return ret;
}

Php::Value
GtkButtonBox_::get_child_non_homogeneous(Php::Parameters &parameters) {
  GtkWidget *child = nullptr;
  if (!parameters.empty()) {
    Php::Value object_child = parameters[0];
    GtkWidget_ *phpgtk_child = (GtkWidget_ *)object_child.implementation();
  ...
  bool ret = gtk_button_box_get_child_non_homogeneous(GTK_BUTTON_BOX(instance),
                                                      child) != 0;
...
void GtkButtonBox_::set_child_secondary(Php::Parameters &parameters) {
  ...
  gtk_button_box_set_child_secondary(GTK_BUTTON_BOX(instance), child,
                                     is_secondary);
}
...
void GtkButtonBox_::set_child_non_homogeneous(Php::Parameters &parameters) {
  ...
  gtk_button_box_set_child_non_homogeneous(GTK_BUTTON_BOX(instance), child,
                                           non_homogeneous);
}
