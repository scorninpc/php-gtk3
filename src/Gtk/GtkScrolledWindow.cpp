...
void GtkScrolledWindow_::set_overlay_scrolling(Php::Parameters &parameters) {
  ...
  gtk_scrolled_window_set_overlay_scrolling(GTK_SCROLLED_WINDOW(instance),
                                            overlay_scrolling);
}
...
void GtkScrolledWindow_::set_propagate_natural_height(
    Php::Parameters &parameters) {
  gboolean natural_height = (gboolean)parameters[0];

  gtk_scrolled_window_set_propagate_natural_height(
      GTK_SCROLLED_WINDOW(instance), natural_height);
}

void GtkScrolledWindow_::set_propagate_natural_width(
    Php::Parameters &parameters) {
  gboolean natural_height = (gboolean)parameters[0];

  gtk_scrolled_window_set_propagate_natural_width(GTK_SCROLLED_WINDOW(instance),
                                                  natural_height);
}
...
void GtkScrolledWindow_::set_max_content_height(Php::Parameters &parameters) {
  ...
  gtk_scrolled_window_set_max_content_height(GTK_SCROLLED_WINDOW(instance),
                                             height);
}
...
void GtkScrolledWindow_::set_min_content_height(Php::Parameters &parameters) {
  ...
  gtk_scrolled_window_set_min_content_height(GTK_SCROLLED_WINDOW(instance),
                                             height);
}

Php::Value GtkScrolledWindow_::get_vadjustment() {
  gpointer *ret = (gpointer *)gtk_scrolled_window_get_vadjustment(
...
Php::Value GtkScrolledWindow_::get_hadjustment() {
  gpointer *ret = (gpointer *)gtk_scrolled_window_get_hadjustment(
      GTK_SCROLLED_WINDOW(instance));
...
void GtkScrolledWindow_::set_max_content_width(Php::Parameters &parameters) {
  ...
  gtk_scrolled_window_set_max_content_width(GTK_SCROLLED_WINDOW(instance),
                                            width);
}
...
void GtkScrolledWindow_::set_min_content_width(Php::Parameters &parameters) {
  ...
  gtk_scrolled_window_set_min_content_width(GTK_SCROLLED_WINDOW(instance),
                                            width);
}