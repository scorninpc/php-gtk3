...
#define _PHPGTK_GTKMENU_H_
    ...
    class GtkMenu_ : public GtkMenuShell_
    {
        ...
        public:
            ...
            static void set_screen(Php::Parameters &parameters);

            void reorder_child(Php::Parameters &parameters);

            void attach(Php::Parameters &parameters);

            static void popup_at_rect(Php::Parameters &parameters);

            static void popup_at_widget(Php::Parameters &parameters);

            void popup_at_pointer (Php::Parameters &parameters);

            void popup(Php::Parameters &parameters);

            static void set_accel_group(Php::Parameters &parameters);

            static Php::Value get_accel_group();
            ...
            static void place_on_monitor(Php::Parameters &parameters);
            ...
            static void attach_to_widget(Php::Parameters &parameters);

            void detach();

            Php::Value get_attach_widget();

            static Php::Value get_for_attach_widget();
    };
