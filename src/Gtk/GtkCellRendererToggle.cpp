...
void GtkCellRendererToggle_::set_activatable(Php::Parameters &parameters) {
  gtk_cell_renderer_toggle_set_activatable(GTK_CELL_RENDERER_TOGGLE(instance),
                                           parameters[0]);
}
...
Php::Value GtkCellRendererToggle_::get_activatable() {
  ...
  return gtk_cell_renderer_toggle_get_activatable(
      GTK_CELL_RENDERER_TOGGLE(instance));
}
...
void GtkCellRendererToggle_::set_radio(Php::Parameters &parameters) {
  gtk_cell_renderer_toggle_set_radio(GTK_CELL_RENDERER_TOGGLE(instance),
                                     parameters[0]);
}
...
void GtkCellRendererToggle_::set_active(Php::Parameters &parameters) {
  gtk_cell_renderer_toggle_set_active(GTK_CELL_RENDERER_TOGGLE(instance),
                                      parameters[0]);
}
