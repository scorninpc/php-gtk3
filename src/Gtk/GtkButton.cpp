...
void GtkButton_::__construct() { instance = (gpointer *)gtk_button_new(); }
...
void GtkButton_::clicked() { gtk_button_clicked(GTK_BUTTON(instance)); }
...
Php::Value GtkButton_::get_use_underline() {
  bool ret = gtk_button_get_use_underline(GTK_BUTTON(instance)) != 0;
...
void GtkButton_::set_focus_on_click(Php::Parameters &parameters) {
  ...
  // Php::deprecated << "set_focus_on_click is deprecated on Gtk 3.20" <<
  // std::endl;
}
...
Php::Value GtkButton_::get_always_show_image() {
  bool ret = gtk_button_get_always_show_image(GTK_BUTTON(instance)) != 0;
