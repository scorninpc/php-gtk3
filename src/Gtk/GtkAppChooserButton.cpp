...
void GtkAppChooserButton_::append_custom_item(Php::Parameters &parameters) {
  ...
  // (GTK_APP_CHOOSER_BUTTON(instance), name, label, icon);

  throw Php::Exception(
      "GtkAppChooserButton_::append_custom_item not implemented");
}
...
void GtkAppChooserButton_::set_active_custom_item(Php::Parameters &parameters) {
  ...
  gtk_app_chooser_button_set_active_custom_item(
      GTK_APP_CHOOSER_BUTTON(instance), name);
}

Php::Value GtkAppChooserButton_::get_show_default_item() {
  bool ret = gtk_app_chooser_button_get_show_default_item(
                 GTK_APP_CHOOSER_BUTTON(instance)) != 0;
...
void GtkAppChooserButton_::set_show_default_item(Php::Parameters &parameters) {
  ...
  gtk_app_chooser_button_set_show_default_item(GTK_APP_CHOOSER_BUTTON(instance),
                                               setting);
}

Php::Value GtkAppChooserButton_::get_show_dialog_item() {
  bool ret = gtk_app_chooser_button_get_show_dialog_item(
                 GTK_APP_CHOOSER_BUTTON(instance)) != 0;
...
void GtkAppChooserButton_::set_show_dialog_item(Php::Parameters &parameters) {
  ...
  gtk_app_chooser_button_set_show_dialog_item(GTK_APP_CHOOSER_BUTTON(instance),
                                              setting);
}

Php::Value GtkAppChooserButton_::get_heading() {
  std::string ret =
      gtk_app_chooser_button_get_heading(GTK_APP_CHOOSER_BUTTON(instance));
...
Php::Value GtkAppChooserButton_::get_app_info() {
  ...
  arr[11] = arr["can_remove_supports_type"] =
