...
Php::Value GtkWidget_::__construct(Php::Parameters &parameters) {
  ...
  // 	GtkWidget *ret = instance = (gpointer *)gtk_widget_new
  // (first_property_name);
...
void GtkWidget_::destroy() { gtk_widget_destroy(GTK_WIDGET(instance)); }

Php::Value GtkWidget_::in_destruction() {
  bool ret = gtk_widget_in_destruction(GTK_WIDGET(instance)) != 0;
...
void GtkWidget_::destroyed(Php::Parameters &parameters) {
  ...
  // 		GtkWidget_ *phpgtk_widget_pointer = (GtkWidget_
  // *)object_widget_pointer.implementation(); 		widget_pointer =
  // GTK_WIDGET(phpgtk_widget_pointer->get_instance());
  // 	}
...
void GtkWidget_::unparent() { gtk_widget_unparent(GTK_WIDGET(instance)); }

void GtkWidget_::show() { gtk_widget_show(GTK_WIDGET(instance)); }

void GtkWidget_::show_now() { gtk_widget_show_now(GTK_WIDGET(instance)); }

void GtkWidget_::hide() { gtk_widget_hide(GTK_WIDGET(instance)); }

void GtkWidget_::show_all() { gtk_widget_show_all(GTK_WIDGET(instance)); }

void GtkWidget_::map() { gtk_widget_map(GTK_WIDGET(instance)); }

void GtkWidget_::unmap() { gtk_widget_unmap(GTK_WIDGET(instance)); }

void GtkWidget_::realize() { gtk_widget_realize(GTK_WIDGET(instance)); }

void GtkWidget_::unrealize() { gtk_widget_unrealize(GTK_WIDGET(instance)); }
...
void GtkWidget_::queue_draw() { gtk_widget_queue_draw(GTK_WIDGET(instance)); }
...
Php::Value GtkWidget_::add_tick_callback(Php::Parameters &parameters) {
  ...
  //
  // 	int ret = gtk_widget_add_tick_callback (GTK_WIDGET(instance), callback,
  // user_data, notify);
...
void GtkWidget_::size_request(Php::Parameters &parameters) {
  ...
  // 		GtkRequisition_ *phpgtk_requisition = (GtkRequisition_
  // *)object_requisition.implementation(); 		requisition =
  // GTK_WIDGET(phpgtk_requisition->get_instance());
  // 	}
...
void GtkWidget_::get_child_requisition(Php::Parameters &parameters) {
  ...
  Php::deprecated
      << "GtkWidget_::get_child_requisition  is deprecated on Gtk 3.0";
}
...
void GtkWidget_::size_allocate(Php::Parameters &parameters) {
  ...
  // 		GtkAllocation_ *phpgtk_allocation = (GtkAllocation_
  // *)object_allocation.implementation(); 		allocation =
  // GTK_WIDGET(phpgtk_allocation->get_instance());
  // 	}
...
void GtkWidget_::size_allocate_with_baseline(Php::Parameters &parameters) {
  ...
  // 	gtk_widget_size_allocate_with_baseline (GTK_WIDGET(instance),
  // allocation, baseline);

  throw Php::Exception(
      "GtkWidget_::size_allocate_with_baseline not implemented");
}

void GtkWidget_::add_accelerator(Php::Parameters &parameters) {
  if (parameters.size() < 5) {
    throw Php::Exception("Expected 5 parameters: accel_signal, accel_group, "
  ...
  GtkAccelGroup_ *phpgtk_accel_group =
      (GtkAccelGroup_ *)object_accel_group.implementation();
  GtkAccelGroup *accel_group =
      (GtkAccelGroup *)phpgtk_accel_group->get_instance();
  ...
  gtk_widget_add_accelerator(GTK_WIDGET(instance), accel_signal, accel_group,
                             accel_key, accel_mods, accel_flags);
}
...
Php::Value GtkWidget_::remove_accelerator(Php::Parameters &parameters) {
  ...
  // 		GtkAccelGroup_ *phpgtk_accel_group = (GtkAccelGroup_
  // *)object_accel_group.implementation(); 		accel_group =
  // GTK_WIDGET(phpgtk_accel_group->get_instance());
  // 	}
  ...
  // 		GdkModifierType_ *phpgtk_accel_mods = (GdkModifierType_
  // *)object_accel_mods.implementation(); 		accel_mods =
  // GTK_WIDGET(phpgtk_accel_mods->get_instance());
  // 	}

  // 	bool ret = gtk_widget_remove_accelerator (GTK_WIDGET(instance),
...
void GtkWidget_::set_accel_path(Php::Parameters &parameters) {
  ...
  // 	gtk_widget_set_accel_path (GTK_WIDGET(instance), accel_path,
  // accel_group);
...
Php::Value GtkWidget_::can_activate_accel(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_widget_can_activate_accel(GTK_WIDGET(instance), signal_id) != 0;
...
Php::Value GtkWidget_::event(Php::Parameters &parameters) {
  ...
  // 		GdkEvent_ *phpgtk_event = (GdkEvent_
  // *)object_event.implementation(); 		event =
  // GDK_EVENT(phpgtk_event->get_instance());
  // 	}
...
Php::Value GtkWidget_::activate() {
  bool ret = gtk_widget_activate(GTK_WIDGET(instance)) != 0;
...
void GtkWidget_::reparent(Php::Parameters &parameters) {
  ...
  // 		GtkWidget_ *phpgtk_new_parent = (GtkWidget_
  // *)object_new_parent.implementation(); 		new_parent =
  // GTK_WIDGET(phpgtk_new_parent->get_instance());
  // 	}
...
Php::Value GtkWidget_::intersect(Php::Parameters &parameters) {
  ...
  // 		GdkRectangle_ *phpgtk_area = (GdkRectangle_
  // *)object_area.implementation(); 		area =
  // GTK_WIDGET(phpgtk_area->get_instance());
  // 	}

  // // 	GdkRectangle *intersection;
  // 	if(parameters.size() > 1) {
  // 		Php::Value object_intersection = parameters[1];
  // 		GdkRectangle_ *phpgtk_intersection = (GdkRectangle_
  // *)object_intersection.implementation(); 		intersection =
  // GTK_WIDGET(phpgtk_intersection->get_instance());
  // 	}

  // 	bool ret = gtk_widget_intersect (GTK_WIDGET(instance), area,
  // intersection);
...
Php::Value GtkWidget_::is_focus() {
  bool ret = gtk_widget_is_focus(GTK_WIDGET(instance)) != 0;

  return ret;
}

void GtkWidget_::grab_focus() { gtk_widget_grab_focus(GTK_WIDGET(instance)); }
...
void GtkWidget_::set_state(Php::Parameters &parameters) {
  ...
  // 		GtkStateType_ *phpgtk_state = (GtkStateType_
  // *)object_state.implementation(); 		state =
  // GTK_WIDGET(phpgtk_state->get_instance());
  // 	}
...
void GtkWidget_::set_parent_window(Php::Parameters &parameters) {
  GdkWindow *parent_window = nullptr;
  if (!parameters.empty()) {
    Php::Value object_parent_window = parameters[0];
    GdkWindow_ *phpgtk_parent_window =
        (GdkWindow_ *)object_parent_window.implementation();
...
void GtkWidget_::set_device_events(Php::Parameters &parameters) {
  ...
  // 		GdkDevice_ *phpgtk_device = (GdkDevice_
  // *)object_device.implementation(); 		device =
  // GTK_WIDGET(phpgtk_device->get_instance());
  // 	}
...
Php::Value GtkWidget_::get_device_events(Php::Parameters &parameters) {
  ...
  // 	GdkEventMask ret = gtk_widget_get_device_events (GTK_WIDGET(instance),
  // device);
...
Php::Value GtkWidget_::get_ancestor(Php::Parameters &parameters) {
  // GtkWidget *ret = gtk_widget_get_ancestor (GTK_WIDGET(instance),
  // widget_type);
...
Php::Value GtkWidget_::is_ancestor(Php::Parameters &parameters) {
  GtkWidget *ancestor = nullptr;
  if (!parameters.empty()) {
    Php::Value object_ancestor = parameters[0];
    GtkWidget_ *phpgtk_ancestor =
        (GtkWidget_ *)object_ancestor.implementation();
    ancestor = GTK_WIDGET(phpgtk_ancestor->get_instance());
  }

  bool ret = gtk_widget_is_ancestor(GTK_WIDGET(instance), ancestor) != 0;

  return ret;
}

Php::Value GtkWidget_::translate_coordinates(Php::Parameters &parameters) {
  GtkWidget *dest_widget = nullptr;
  if (!parameters.empty()) {
    Php::Value object_dest_widget = parameters[0];
    GtkWidget_ *phpgtk_dest_widget =
        (GtkWidget_ *)object_dest_widget.implementation();
  ...
  bool ret =
      gtk_widget_translate_coordinates(GTK_WIDGET(instance), dest_widget, src_x,
                                       src_y, &dest_x, &dest_y) != 0;
  if (!ret) {
    return ret;
  }
...
Php::Value GtkWidget_::hide_on_delete() {
  bool ret = gtk_widget_hide_on_delete(GTK_WIDGET(instance)) != 0;
...
void GtkWidget_::set_style(Php::Parameters &parameters) {
  ...
  // 		GtkStyle_ *phpgtk_style = (GtkStyle_
  // *)object_style.implementation(); 		style =
  // GTK_STYLE(phpgtk_style->get_instance());
  // 	}
...
void GtkWidget_::input_shape_combine_region(Php::Parameters &parameters) {
  ...
  throw Php::Exception(
      "GtkWidget_::input_shape_combine_region not implemented");
}
...
void GtkWidget_::path(Php::Parameters &parameters) {
  ...
  // 	gtk_widget_path (GTK_WIDGET(instance), path_length, path,
  // path_reversed);
...
void GtkWidget_::class_path(Php::Parameters &parameters) {
  ...
  // 	gtk_widget_class_path (GTK_WIDGET(instance), path_length, path,
  // path_reversed);
...
Php::Value GtkWidget_::get_composite_name() {
  ...
  // 	return ret;
  Php::deprecated
      << "GtkWidget_::get_composite_name  is deprecated on Gtk 3.10";
  return 1;
}
...
void GtkWidget_::override_background_color(Php::Parameters &parameters) {
  ...
  // Php::deprecated << "GtkWidget_::override_background_color  is deprecated on
  // Gtk 3.16";
}
...
void GtkWidget_::override_symbolic_color(Php::Parameters &parameters) {
  ...
  // 	if(parameters.size() > 1) {
  // 		Php::Value object_color = parameters[1];
  // 		GdkRGBA_ *phpgtk_color = (GdkRGBA_
  // *)object_color.implementation(); 		color =
  // GTK_WIDGET(phpgtk_color->get_instance());
  // 	}

  // 	gtk_widget_override_symbolic_color (GTK_WIDGET(instance), name, color);

  Php::deprecated
      << "GtkWidget_::override_symbolic_color  is deprecated on Gtk 3.16";
}
...
void GtkWidget_::override_cursor(Php::Parameters &parameters) {
  ...
  // 		GdkRGBA_ *phpgtk_cursor = (GdkRGBA_
  // *)object_cursor.implementation(); 		cursor =
  // GTK_WIDGET(phpgtk_cursor->get_instance());
  // 	}

  // // 	GdkRGBA *secondary_cursor;
  // 	if(parameters.size() > 1) {
  // 		Php::Value object_secondary_cursor = parameters[1];
  // 		GdkRGBA_ *phpgtk_secondary_cursor = (GdkRGBA_
  // *)object_secondary_cursor.implementation(); 		secondary_cursor =
  // GTK_WIDGET(phpgtk_secondary_cursor->get_instance());
  // 	}

  // 	gtk_widget_override_cursor (GTK_WIDGET(instance), cursor,
  // secondary_cursor);
...
void GtkWidget_::modify_style(Php::Parameters &parameters) {
  ...
  // 	if(parameters.size() > 0) {
  // 		Php::Value object_style = parameters[0];
  // 		GtkRcStyle_ *phpgtk_style = (GtkRcStyle_
  // *)object_style.implementation(); 		style =
  // GTK_WIDGET(phpgtk_style->get_instance());
  // 	}
...
void GtkWidget_::modify_fg(Php::Parameters &parameters) {
  ...
  // 	if(parameters.size() > 1) {
  // 		Php::Value object_color = parameters[1];
  // 		GdkColor_ *phpgtk_color = (GdkColor_
  // *)object_color.implementation(); 		color =
  // GTK_WIDGET(phpgtk_color->get_instance());
  // 	}
...
void GtkWidget_::modify_font(Php::Parameters &parameters) {
  ...
  PangoFontDescription *font_desc =
      pango_font_description_from_string(s_font_desc.c_str());
...
void GtkWidget_::modify_cursor(Php::Parameters &parameters) {
  ...
  // 		GdkColor_ *phpgtk_primary = (GdkColor_
  // *)object_primary.implementation(); 		primary =
  // GTK_WIDGET(phpgtk_primary->get_instance());
  // 	}

  // // 	GdkColor *secondary;
  // 	if(parameters.size() > 1) {
  // 		Php::Value object_secondary = parameters[1];
  // 		GdkColor_ *phpgtk_secondary = (GdkColor_
  // *)object_secondary.implementation(); 		secondary =
  // GTK_WIDGET(phpgtk_secondary->get_instance());
  // 	}
...
Php::Value GtkWidget_::create_pango_layout(Php::Parameters &parameters) {
  ...
  // 	PangoLayout ret = gtk_widget_create_pango_layout (GTK_WIDGET(instance),
  // text);
...
Php::Value GtkWidget_::render_icon(Php::Parameters &parameters) {
  ...
  // 		GtkIconSize_ *phpgtk_size = (GtkIconSize_
  // *)object_size.implementation(); 		size =
  // GTK_WIDGET(phpgtk_size->get_instance());
  // 	}

  // // 	std::string s_detail = parameters[2];
  // 	gchar *detail = (gchar *)s_detail.c_str();

  // 	GdkPixbuf ret = gtk_widget_render_icon (GTK_WIDGET(instance), stock_id,
  // size, detail);
...
Php::Value GtkWidget_::render_icon_pixbuf(Php::Parameters &parameters) {
  ...
  // 	GdkPixbuf ret = gtk_widget_render_icon_pixbuf (GTK_WIDGET(instance),
  // stock_id, size);

  // 	return ret;
  Php::deprecated
      << "GtkWidget_::render_icon_pixbuf  is deprecated on Gtk 3.10";
  return 1;
}
...
void GtkWidget_::pop_composite_child() {
  ...
  Php::deprecated
      << "GtkWidget_::pop_composite_child  is deprecated on Gtk 3.10";
}
...
void GtkWidget_::push_composite_child() {
  ...
  Php::deprecated
      << "GtkWidget_::push_composite_child  is deprecated on Gtk 3.10";
}
...
void GtkWidget_::set_double_buffered(Php::Parameters &parameters) {
  ...
  Php::deprecated
      << "GtkWidget_::set_double_buffered  is deprecated on Gtk 3.14";
}
...
void GtkWidget_::set_composite_name(Php::Parameters &parameters) {
  ...
  Php::deprecated
      << "GtkWidget_::set_composite_name  is deprecated on Gtk 3.10";
}
...
Php::Value GtkWidget_::mnemonic_activate(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_widget_mnemonic_activate(GTK_WIDGET(instance), group_cycling) != 0;
...
void GtkWidget_::class_install_style_property(Php::Parameters &parameters) {
  ...
  throw Php::Exception(
      "GtkWidget_::class_install_style_property not implemented");
}

void GtkWidget_::class_install_style_property_parser(
    Php::Parameters &parameters) {
  //
  // // 	GtkRcPropertyParser *parser;
  // 	if(parameters.size() > 1) {
  // 		Php::Value object_parser = parameters[1];
  // 		GtkRcPropertyParser_ *phpgtk_parser = (GtkRcPropertyParser_
  // *)object_parser.implementation(); 		parser =
  // GTK_WIDGET(phpgtk_parser->get_instance());
  // 	}

  // 	gtk_widget_class_install_style_property_parser (GTK_WIDGET(instance),
  // pspec, parser);

  throw Php::Exception(
      "GtkWidget_::class_install_style_property_parser not implemented");
}
...
Php::Value GtkWidget_::class_find_style_property(Php::Parameters &parameters) {
  ...
  // 	GParamSpec ret = gtk_widget_class_find_style_property
  // (GTK_WIDGET(instance), property_name);
...
Php::Value
GtkWidget_::class_list_style_properties(Php::Parameters &parameters) {
  // // 	guint n_properties = (int)parameters[0];

  // 	GParamSpec ret = *gtk_widget_class_list_style_properties
  // (GTK_WIDGET(instance), n_properties);

  // 	return ret;
  throw Php::Exception(
      "GtkWidget_::class_list_style_properties not implemented");
}
...
void GtkWidget_::style_get_valist(Php::Parameters &parameters) {
  ...
  //
  // 	gtk_widget_style_get_valist (GTK_WIDGET(instance), first_property_name,
  // var_args);
...
Php::Value GtkWidget_::child_focus(Php::Parameters &parameters) {
  ...
  bool ret = gtk_widget_child_focus(GTK_WIDGET(instance), direction) != 0;
...
Php::Value GtkWidget_::get_child_visible() {
  bool ret = gtk_widget_get_child_visible(GTK_WIDGET(instance)) != 0;

  return ret;
}

Php::Value GtkWidget_::get_parent() {
  if ((instance == nullptr) || !GTK_IS_WIDGET(instance)) {
    return nullptr;
  }
...
Php::Value GtkWidget_::get_clipboard(Php::Parameters &parameters) {
  ...
  // 		GdkAtom_ *phpgtk_selection = (GdkAtom_
  // *)object_selection.implementation(); 		selection =
  // GTK_WIDGET(phpgtk_selection->get_instance());
  // 	}

  // 	GtkClipboard *ret = gtk_widget_get_clipboard (GTK_WIDGET(instance),
  // selection);
...
Php::Value GtkWidget_::has_screen() {
  bool ret = gtk_widget_has_screen(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_no_show_all() {
  bool ret = gtk_widget_get_no_show_all(GTK_WIDGET(instance)) != 0;
...
void GtkWidget_::error_bell() { gtk_widget_error_bell(GTK_WIDGET(instance)); }

Php::Value GtkWidget_::keynav_failed(Php::Parameters &parameters) {
  int int_direction = (int)parameters[0];
  GtkDirectionType direction = (GtkDirectionType)int_direction;

  bool ret = gtk_widget_keynav_failed(GTK_WIDGET(instance), direction) != 0;
...
void GtkWidget_::set_tooltip_window(Php::Parameters &parameters) {
  GtkWindow *custom_window = nullptr;
  if (!parameters.empty()) {
    Php::Value object_custom_window = parameters[0];
    GtkWindow_ *phpgtk_custom_window =
        (GtkWindow_ *)object_custom_window.implementation();
...
Php::Value GtkWidget_::get_has_tooltip() {
  bool ret = gtk_widget_get_has_tooltip(GTK_WIDGET(instance)) != 0;
...
Php::Value
GtkWidget_::gtk_cairo_should_draw_window(Php::Parameters &parameters) {
  // // 	GdkWindow *window;
  // 	if(parameters.size() > 0) {
  // 		Php::Value object_window = parameters[0];
  // 		GdkWindow_ *phpgtk_window = (GdkWindow_
  // *)object_window.implementation(); 		window =
  // GTK_WIDGET(phpgtk_window->get_instance());
  // 	}
  ...
  // 	return ret;
  throw Php::Exception(
      "GtkWidget_::gtk_cairo_should_draw_window not implemented");
}
...
void GtkWidget_::gtk_cairo_transform_to_window(Php::Parameters &parameters) {
  ...
  throw Php::Exception(
      "GtkWidget_::gtk_cairo_transform_to_window not implemented");
}
...
void GtkWidget_::get_allocated_size(Php::Parameters &parameters) {
  ...
  //
  // 	gtk_widget_get_allocated_size (GTK_WIDGET(instance), allocation,
  // baseline);
...
void GtkWidget_::get_clip(Php::Parameters &parameters) {
  ...
  // 		GtkAllocation_ *phpgtk_clip = (GtkAllocation_
  // *)object_clip.implementation(); 		clip =
  // GTK_WIDGET(phpgtk_clip->get_instance());
  // 	}
...
Php::Value GtkWidget_::get_app_paintable() {
  bool ret = gtk_widget_get_app_paintable(GTK_WIDGET(instance)) != 0;

  return ret;
}

Php::Value GtkWidget_::get_can_default() {
  bool ret = gtk_widget_get_can_default(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_can_focus() {
  bool ret = gtk_widget_get_can_focus(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_focus_on_click() {
  bool ret = gtk_widget_get_focus_on_click(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_double_buffered() {
  ...
  // 	return ret;
  Php::deprecated
      << "GtkWidget_::get_double_buffered  is deprecated on Gtk 3.0";
  return 1;
}

Php::Value GtkWidget_::get_has_window() {
  bool ret = gtk_widget_get_has_window(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_sensitive() {
  bool ret = gtk_widget_get_sensitive(GTK_WIDGET(instance)) != 0;

  return ret;
}

Php::Value GtkWidget_::is_sensitive() {
  bool ret = gtk_widget_is_sensitive(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_visible() {
  bool ret = gtk_widget_get_visible(GTK_WIDGET(instance)) != 0;

  return ret;
}

Php::Value GtkWidget_::is_visible() {
  bool ret = gtk_widget_is_visible(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::has_default() {
  bool ret = gtk_widget_has_default(GTK_WIDGET(instance)) != 0;

  return ret;
}

Php::Value GtkWidget_::has_focus() {
  bool ret = gtk_widget_has_focus(GTK_WIDGET(instance)) != 0;

  return ret;
}

Php::Value GtkWidget_::has_visible_focus() {
  bool ret = gtk_widget_has_visible_focus(GTK_WIDGET(instance)) != 0;

  return ret;
}

Php::Value GtkWidget_::has_grab() {
  bool ret = gtk_widget_has_grab(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::is_drawable() {
  bool ret = gtk_widget_is_drawable(GTK_WIDGET(instance)) != 0;

  return ret;
}

Php::Value GtkWidget_::is_toplevel() {
  bool ret = gtk_widget_is_toplevel(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_receives_default() {
  bool ret = gtk_widget_get_receives_default(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_support_multidevice() {
  bool ret = gtk_widget_get_support_multidevice(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_realized() {
  bool ret = gtk_widget_get_realized(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_mapped() {
  bool ret = gtk_widget_get_mapped(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_modifier_mask(Php::Parameters &parameters) {
  ...
  // 		GdkModifierIntent_ *phpgtk_intent = (GdkModifierIntent_
  // *)object_intent.implementation(); 		intent =
  // GTK_WIDGET(phpgtk_intent->get_instance());
  // 	}

  // 	GdkModifierType ret = gtk_widget_get_modifier_mask
  // (GTK_WIDGET(instance), intent);
...
Php::Value GtkWidget_::get_action_group(Php::Parameters &parameters) {
  ...
  // 	GActionGroup ret = gtk_widget_get_action_group (GTK_WIDGET(instance),
  // prefix);
...
void GtkWidget_::reset_style() { gtk_widget_reset_style(GTK_WIDGET(instance)); }
...
Php::Value GtkWidget_::get_preferred_height(Php::Parameters &parameters) {
  ...
  gtk_widget_get_preferred_height(GTK_WIDGET(instance), &minimum_height,
                                  &natural_height);
...
Php::Value GtkWidget_::get_preferred_width(Php::Parameters &parameters) {
  ...
  gtk_widget_get_preferred_width(GTK_WIDGET(instance), &minimum_width,
                                 &natural_width);
...
Php::Value
GtkWidget_::get_preferred_height_for_width(Php::Parameters &parameters) {
  gint width = (gint)parameters[0];

  gint minimum_height = 0;
  gint natural_height = 0;

  gtk_widget_get_preferred_height_for_width(GTK_WIDGET(instance), width,
...
Php::Value
GtkWidget_::get_preferred_width_for_height(Php::Parameters &parameters) {
  gint height = (gint)parameters[0];

  gint minimum_width = 0;
  gint natural_width = 0;

  gtk_widget_get_preferred_width_for_height(GTK_WIDGET(instance), height,
...
Php::Value GtkWidget_::get_preferred_height_and_baseline_for_width(
    Php::Parameters &parameters) {
  gint width = (gint)parameters[0];
  ...
  gtk_widget_get_preferred_height_and_baseline_for_width(
      GTK_WIDGET(instance), width, &minimum_height, &natural_height,
...
Php::Value GtkWidget_::get_preferred_size(Php::Parameters &parameters) {
  ...
  gtk_widget_get_preferred_size(GTK_WIDGET(instance), &minimum_size,
                                &natural_size);
...
Php::Value
GtkWidget_::gtk_distribute_natural_allocation(Php::Parameters &parameters) {
  // guint n_requested_sizes = (int)parameters[0];

  // GtkRequestedSize *sizes;

  // gint ret = gtk_distribute_natural_allocation (GTK_WIDGET(instance),
  // n_requested_sizes, sizes);

  // return ret;

  throw Php::Exception(
      "GtkWidget_::gtk_distribute_natural_allocation not implemented");
  return 1;
}
...
Php::Value GtkWidget_::get_hexpand() {
  bool ret = gtk_widget_get_hexpand(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_hexpand_set() {
  bool ret = gtk_widget_get_hexpand_set(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_vexpand() {
  bool ret = gtk_widget_get_vexpand(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::get_vexpand_set() {
  bool ret = gtk_widget_get_vexpand_set(GTK_WIDGET(instance)) != 0;
...
Php::Value GtkWidget_::compute_expand(Php::Parameters &parameters) {
  ...
  bool ret = gtk_widget_compute_expand(GTK_WIDGET(instance), orientation) != 0;
...
void GtkWidget_::class_set_template_from_resource(Php::Parameters &parameters) {
  ...
  // gtk_widget_class_set_template_from_resource (GTK_WIDGET(instance),
  // resource_name);

  throw Php::Exception(
      "GtkWidget_::class_set_template_from_resource not implemented");
}
...
Php::Value GtkWidget_::get_template_child(Php::Parameters &parameters) {
  ...
  // 	GObject ret = gtk_widget_get_template_child (GTK_WIDGET(instance),
  // widget_type, name);
...
void GtkWidget_::class_bind_template_child_full(Php::Parameters &parameters) {
  ...
  // 	gtk_widget_class_bind_template_child_full (GTK_WIDGET(instance), name,
  // internal_child, struct_offset);

  throw Php::Exception(
      "GtkWidget_::class_bind_template_child_full not implemented");
}

void GtkWidget_::class_bind_template_callback_full(
    Php::Parameters &parameters) {
  // // 	std::string s_callback_name = parameters[0];
  // 	gchar *callback_name = (gchar *)s_callback_name.c_str();

  //
  // 	gtk_widget_class_bind_template_callback_full (GTK_WIDGET(instance),
  // callback_name, callback_symbol);

  throw Php::Exception(
      "GtkWidget_::class_bind_template_callback_full not implemented");
}
...
void GtkWidget_::class_set_connect_func(Php::Parameters &parameters) {
  ...
  // 		GtkBuilderConnectFunc_ *phpgtk_connect_func =
  // (GtkBuilderConnectFunc_ *)object_connect_func.implementation();
  ...
  //
  // 	gtk_widget_class_set_connect_func (GTK_WIDGET(instance), connect_func,
  // connect_data, connect_data_destroy);
