...
void GtkWidget_::add_accelerator(Php::Parameters &parameters) {
  ...
  gtk_widget_add_accelerator(GTK_WIDGET(instance), accel_signal, accel_group, accel_key, accel_mods,
                             accel_flags);
}
...
Php::Value GtkWidget_::remove_accelerator(Php::Parameters &parameters) {
  ...
  // 	bool ret = gtk_widget_remove_accelerator (GTK_WIDGET(instance), accel_group, accel_key,
  // accel_mods);
...
Php::Value GtkWidget_::translate_coordinates(Php::Parameters &parameters) {
  ...
  bool ret = gtk_widget_translate_coordinates(GTK_WIDGET(instance), dest_widget, src_x, src_y,
                                              &dest_x, &dest_y);
  if (!ret) {
    return ret;
  }
...
void GtkWidget_::class_install_style_property_parser(Php::Parameters &parameters) {
  ...
  // *)object_parser.implementation(); 		parser = GTK_WIDGET(phpgtk_parser->get_instance());
  // 	}
...
Php::Value GtkWidget_::class_list_style_properties(Php::Parameters &parameters) {
  ...
  // 	GParamSpec ret = *gtk_widget_class_list_style_properties (GTK_WIDGET(instance),
  // n_properties);
...
Php::Value GtkWidget_::get_modifier_mask(Php::Parameters &parameters) {
  ...
  // *)object_intent.implementation(); 		intent = GTK_WIDGET(phpgtk_intent->get_instance());
  // 	}
...
Php::Value GtkWidget_::get_preferred_height_for_width(Php::Parameters &parameters) {
  ...
  gtk_widget_get_preferred_height_for_width(GTK_WIDGET(instance), width, &minimum_height,
                                            &natural_height);
...
Php::Value GtkWidget_::get_preferred_width_for_height(Php::Parameters &parameters) {
  ...
  gtk_widget_get_preferred_width_for_height(GTK_WIDGET(instance), height, &minimum_width,
                                            &natural_width);
...
Php::Value GtkWidget_::get_preferred_height_and_baseline_for_width(Php::Parameters &parameters) {
  ...
  gtk_widget_get_preferred_height_and_baseline_for_width(GTK_WIDGET(instance), width,
...
void GtkWidget_::class_bind_template_child_full(Php::Parameters &parameters) {
  ...
  // 	gtk_widget_class_bind_template_child_full (GTK_WIDGET(instance), name, internal_child,
  // struct_offset);
...
void GtkWidget_::class_bind_template_callback_full(Php::Parameters &parameters) {
  ...
  //
  // 	gtk_widget_class_bind_template_callback_full (GTK_WIDGET(instance), callback_name,
  // callback_symbol);
...
void GtkWidget_::class_set_connect_func(Php::Parameters &parameters) {
  ...
  // 		GtkBuilderConnectFunc_ *phpgtk_connect_func = (GtkBuilderConnectFunc_
  // *)object_connect_func.implementation(); 		connect_func =
  // GTK_WIDGET(phpgtk_connect_func->get_instance());
  // 	}

  // // 	gpointer connect_data = (gpointer)parameters[1];

  //
  // 	gtk_widget_class_set_connect_func (GTK_WIDGET(instance), connect_func, connect_data,
