...
Php::Value GtkAboutDialog_::get_program_name() {
  std::string ret =
      gtk_about_dialog_get_program_name(GTK_ABOUT_DIALOG(instance));
...
Php::Value GtkAboutDialog_::get_wrap_license() {
  bool ret = gtk_about_dialog_get_wrap_license(GTK_ABOUT_DIALOG(instance)) != 0;
...
Php::Value GtkAboutDialog_::get_license_type() {
  GtkLicense ret =
      gtk_about_dialog_get_license_type(GTK_ABOUT_DIALOG(instance));
...
Php::Value GtkAboutDialog_::get_website_label() {
  std::string ret =
      gtk_about_dialog_get_website_label(GTK_ABOUT_DIALOG(instance));
...
Php::Value GtkAboutDialog_::get_authors() {
  const gchar *const *c_ret =
      gtk_about_dialog_get_authors(GTK_ABOUT_DIALOG(instance));
...
Php::Value GtkAboutDialog_::get_artists() {
  const gchar *const *c_ret =
      gtk_about_dialog_get_artists(GTK_ABOUT_DIALOG(instance));
...
Php::Value GtkAboutDialog_::get_documenters() {
  const gchar *const *c_ret =
      gtk_about_dialog_get_documenters(GTK_ABOUT_DIALOG(instance));
...
Php::Value GtkAboutDialog_::get_translator_credits() {
  std::string ret =
      gtk_about_dialog_get_translator_credits(GTK_ABOUT_DIALOG(instance));
...
void GtkAboutDialog_::set_translator_credits(Php::Parameters &parameters) {
  ...
  gtk_about_dialog_set_translator_credits(GTK_ABOUT_DIALOG(instance),
                                          translator_credits);
}
...
Php::Value GtkAboutDialog_::get_logo_icon_name() {
  std::string ret =
      gtk_about_dialog_get_logo_icon_name(GTK_ABOUT_DIALOG(instance));
...
void GtkAboutDialog_::add_credit_section(Php::Parameters &parameters) {
  ...
  gtk_about_dialog_add_credit_section(GTK_ABOUT_DIALOG(instance), section_name,
                                      people);
}
...
void GtkAboutDialog_::gtk_show_about_dialog(Php::Parameters &parameters) {
  ...
  throw Php::Exception(
      "GtkAboutDialog_::gtk_show_about_dialog not implemented");
}
