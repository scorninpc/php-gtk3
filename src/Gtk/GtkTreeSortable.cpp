...
Php::Value GtkTreeSortable_::get_sort_column_id() {
  ...
  gtk_tree_sortable_get_sort_column_id(GTK_TREE_SORTABLE(instance),
...
void GtkTreeSortable_::set_sort_column_id(Php::Parameters &parameters) {
  ...
  gtk_tree_sortable_set_sort_column_id(GTK_TREE_SORTABLE(instance),
                                       sort_column_id, order);
}

Php::Value GtkTreeSortable_::has_default_sort_func() {
  bool ret =
      gtk_tree_sortable_has_default_sort_func(GTK_TREE_SORTABLE(instance)) != 0;
