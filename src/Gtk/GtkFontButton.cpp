...
Php::Value GtkFontButton_::get_font_name() {
  // std::string ret = gtk_font_button_get_font_name
  // (GTK_FONT_CHOOSER(instance));
...
Php::Value GtkFontButton_::get_show_style() {
  bool ret = gtk_font_button_get_show_style(GTK_FONT_BUTTON(instance)) != 0;
...
Php::Value GtkFontButton_::get_show_size() {
  bool ret = gtk_font_button_get_show_size(GTK_FONT_BUTTON(instance)) != 0;
...
Php::Value GtkFontButton_::get_use_font() {
  bool ret = gtk_font_button_get_use_font(GTK_FONT_BUTTON(instance)) != 0;
...
Php::Value GtkFontButton_::get_use_size() {
  bool ret = gtk_font_button_get_use_size(GTK_FONT_BUTTON(instance)) != 0;
