...
void GtkListBox_::__construct() { instance = (gpointer *)gtk_list_box_new(); }
...
Php::Value GtkListBox_::get_selection_mode() {
  GtkSelectionMode ret =
      gtk_list_box_get_selection_mode(GTK_LIST_BOX(instance));
...
Php::Value GtkListBox_::get_activate_on_single_click() {
  bool ret =
      gtk_list_box_get_activate_on_single_click(GTK_LIST_BOX(instance)) != 0;
...
void GtkListBox_::set_placeholder(Php::Parameters &parameters) {
  ...
  if (!parameters.empty()) {
    ...
    GtkWidget_ *phpgtk_placeholder =
        (GtkWidget_ *)object_placeholder.implementation();
...
Php::Value GtkListBox_::get_row_at_index(Php::Parameters &parameters) {
  ...
  GtkListBoxRow *ret =
      gtk_list_box_get_row_at_index(GTK_LIST_BOX(instance), index_);
...
void GtkListBox_::bind_model(Php::Parameters &parameters) {
  ...
  // gtk_list_box_bind_model (GTK_LIST_BOX(instance), create_widget_func,
