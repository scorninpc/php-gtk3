...
Php::Value GtkProgressBar_::get_inverted() {
  bool ret = gtk_progress_bar_get_inverted(GTK_PROGRESS_BAR(instance)) != 0;
...
Php::Value GtkProgressBar_::get_show_text() {
  bool ret = gtk_progress_bar_get_show_text(GTK_PROGRESS_BAR(instance)) != 0;
...
Php::Value GtkProgressBar_::get_ellipsize() {
  // PangoEllipsizeMode ret = gtk_progress_bar_get_ellipsize
  // (GTK_PROGRESS_BAR(instance));
