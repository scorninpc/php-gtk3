...
/**
 * Retrieves the character displayed in place of the real characters for entries with visibility set
 * to false
 */
 ...
 *
 * Note that the position is in characters, not in bytes. The function updates position to point
