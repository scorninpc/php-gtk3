 ...
 */
GtkTextIter GtkTextIter_::get_instance() const { return instance; }
...
void GtkTextIter_::free() { gtk_text_iter_free(&instance); }
...
Php::Value GtkTextIter_::starts_tag(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_starts_tag(&instance, tag) != 0;
...
Php::Value GtkTextIter_::ends_tag(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_ends_tag(&instance, tag) != 0;
...
Php::Value GtkTextIter_::toggles_tag(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_toggles_tag(&instance, tag) != 0;
...
Php::Value GtkTextIter_::has_tag(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_has_tag(&instance, tag) != 0;
...
Php::Value GtkTextIter_::editable(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_editable(&instance, default_setting) != 0;
...
Php::Value GtkTextIter_::can_insert(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_can_insert(&instance, default_editability) != 0;

  return ret;
}

Php::Value GtkTextIter_::starts_word() {
  bool ret = gtk_text_iter_starts_word(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::ends_word() {
  bool ret = gtk_text_iter_ends_word(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::inside_word() {
  bool ret = gtk_text_iter_inside_word(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::starts_line() {
  bool ret = gtk_text_iter_starts_line(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::ends_line() {
  bool ret = gtk_text_iter_ends_line(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::starts_sentence() {
  bool ret = gtk_text_iter_starts_sentence(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::ends_sentence() {
  bool ret = gtk_text_iter_ends_sentence(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::inside_sentence() {
  bool ret = gtk_text_iter_inside_sentence(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::is_cursor_position() {
  bool ret = gtk_text_iter_is_cursor_position(&instance) != 0;
...
Php::Value GtkTextIter_::is_end() {
  bool ret = gtk_text_iter_is_end(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::is_start() {
  bool ret = gtk_text_iter_is_start(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::forward_char() {
  bool ret = gtk_text_iter_forward_char(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::backward_char() {
  bool ret = gtk_text_iter_backward_char(&instance) != 0;
...
Php::Value GtkTextIter_::forward_chars(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_forward_chars(&instance, count) != 0;
...
Php::Value GtkTextIter_::backward_chars(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_backward_chars(&instance, count) != 0;

  return ret;
}

Php::Value GtkTextIter_::forward_line() {
  bool ret = gtk_text_iter_forward_line(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::backward_line() {
  bool ret = gtk_text_iter_backward_line(&instance) != 0;
...
Php::Value GtkTextIter_::forward_lines(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_forward_lines(&instance, count) != 0;
...
Php::Value GtkTextIter_::backward_lines(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_backward_lines(&instance, count) != 0;
...
Php::Value GtkTextIter_::forward_word_ends(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_forward_word_ends(&instance, count) != 0;
...
Php::Value GtkTextIter_::backward_word_starts(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_backward_word_starts(&instance, count) != 0;

  return ret;
}

Php::Value GtkTextIter_::forward_word_end() {
  bool ret = gtk_text_iter_forward_word_end(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::backward_word_start() {
  bool ret = gtk_text_iter_backward_word_start(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::forward_cursor_position() {
  bool ret = gtk_text_iter_forward_cursor_position(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::backward_cursor_position() {
  bool ret = gtk_text_iter_backward_cursor_position(&instance) != 0;
...
Php::Value GtkTextIter_::forward_cursor_positions(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_forward_cursor_positions(&instance, count) != 0;

  return ret;
}

Php::Value
GtkTextIter_::backward_cursor_positions(Php::Parameters &parameters) {
  gint count = (gint)parameters[0];

  bool ret = gtk_text_iter_backward_cursor_positions(&instance, count) != 0;

  return ret;
}

Php::Value GtkTextIter_::backward_sentence_start() {
  bool ret = gtk_text_iter_backward_sentence_start(&instance) != 0;
...
Php::Value GtkTextIter_::backward_sentence_starts(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_backward_sentence_starts(&instance, count) != 0;

  return ret;
}

Php::Value GtkTextIter_::forward_sentence_end() {
  bool ret = gtk_text_iter_forward_sentence_end(&instance) != 0;
...
Php::Value GtkTextIter_::forward_sentence_ends(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_forward_sentence_ends(&instance, count) != 0;

  return ret;
}

Php::Value
GtkTextIter_::forward_visible_word_ends(Php::Parameters &parameters) {
  gint count = (gint)parameters[0];

  bool ret = gtk_text_iter_forward_visible_word_ends(&instance, count) != 0;

  return ret;
}

Php::Value
GtkTextIter_::backward_visible_word_starts(Php::Parameters &parameters) {
  gint count = (gint)parameters[0];

  bool ret = gtk_text_iter_backward_visible_word_starts(&instance, count) != 0;

  return ret;
}

Php::Value GtkTextIter_::forward_visible_word_end() {
  bool ret = gtk_text_iter_forward_visible_word_end(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::backward_visible_word_start() {
  bool ret = gtk_text_iter_backward_visible_word_start(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::forward_visible_cursor_position() {
  bool ret = gtk_text_iter_forward_visible_cursor_position(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::backward_visible_cursor_position() {
  bool ret = gtk_text_iter_backward_visible_cursor_position(&instance) != 0;

  return ret;
}

Php::Value
GtkTextIter_::forward_visible_cursor_positions(Php::Parameters &parameters) {
  gint count = (gint)parameters[0];

  bool ret =
      gtk_text_iter_forward_visible_cursor_positions(&instance, count) != 0;

  return ret;
}

Php::Value
GtkTextIter_::backward_visible_cursor_positions(Php::Parameters &parameters) {
  gint count = (gint)parameters[0];

  bool ret =
      gtk_text_iter_backward_visible_cursor_positions(&instance, count) != 0;

  return ret;
}

Php::Value GtkTextIter_::forward_visible_line() {
  bool ret = gtk_text_iter_forward_visible_line(&instance) != 0;

  return ret;
}

Php::Value GtkTextIter_::backward_visible_line() {
  bool ret = gtk_text_iter_backward_visible_line(&instance) != 0;
...
Php::Value GtkTextIter_::forward_visible_lines(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_forward_visible_lines(&instance, count) != 0;
...
Php::Value GtkTextIter_::backward_visible_lines(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_backward_visible_lines(&instance, count) != 0;
...
void GtkTextIter_::forward_to_end() { gtk_text_iter_forward_to_end(&instance); }

Php::Value GtkTextIter_::forward_to_line_end() {
  bool ret = gtk_text_iter_forward_to_line_end(&instance) != 0;
...
Php::Value GtkTextIter_::forward_to_tag_toggle(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_forward_to_tag_toggle(&instance, tag) != 0;
...
Php::Value GtkTextIter_::backward_to_tag_toggle(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_backward_to_tag_toggle(&instance, tag) != 0;
...
Php::Value GtkTextIter_::iter_equal(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_equal(&instance, &rhs) != 0;
...
Php::Value GtkTextIter_::iter_compare(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_compare(&instance, &rhs) != 0;
...
Php::Value GtkTextIter_::in_range(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_iter_in_range(&instance, &start, &end) != 0;
