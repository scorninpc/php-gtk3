...
class GtkWindow_ : public GtkBin_ {
 ...
 public:
  ...
  /**
   * Activates the default widget for the window, unless the current focused widget has been
   * configured to receive the default action, in which case the focused widget is activated.
   *
  ...
  /**
   * Requests that the window is closed, similar to what happens when a window manager close button
   * is clicked.
   *
  ...
  /**
   * By setting the type hint for the window, you allow the window manager to decorate and handle
  ...
  /**
   * Windows may set a hint asking the desktop environment not to display the window in the task
   * bar. This function sets this hint.
   *
  ...
  /**
   * Windows may set a hint asking the desktop environment to draw the users attention to the
   * window.
   *
  ...
  /**
   * Windows may set a hint asking the desktop environment not to receive the input focus when the
   * window is mapped.
   *
  ...
  /*
   * Sets the icon for window from file. Does't work in some Window Manager. Use set_default_icon
  ...
  /**
   * Sets an icon to be used as fallback for windows that haven't had gtk_window_set_icon() called
   * on them from a pixbuf.
   */
  ...
  /**
   * Sets an icon to be used as fallback for windows that haven't had
   * gtk_window_set_default_icon_list() called on them from a named themed icon, see
  ...
  /**
   * Tells GTK+ whether to drop its extra reference to the window when gtk_widget_destroy() is
   * called.
   *
  ...
  /**
   * Opens or closes the interactive debugger, which offers access to the widget hierarchy of the
   * application and to useful debugging tools.
   *
  ...
  /**
   * Starts moving a window. This function is used if an application has window move implemented as
   * a pressed-button handler.
   *
  ...
  /**
   * Starts resizing a window. This function is used if an application has window resizing
   * implemented as a pressed-button handler.
   *
