...
void GtkCalendar_::__construct() { instance = (gpointer *)gtk_calendar_new(); }
...
Php::Value GtkCalendar_::get_day_is_marked(Php::Parameters &parameters) {
  ...
  bool ret = gtk_calendar_get_day_is_marked(GTK_CALENDAR(instance), day) != 0;
...
Php::Value GtkCalendar_::get_display_options() {
  GtkCalendarDisplayOptions ret =
      gtk_calendar_get_display_options(GTK_CALENDAR(instance));
...
void GtkCalendar_::set_detail_func(Php::Parameters &parameters) {
  ...
  // 	GtkCalendarDetailFunc_ *phpgtk_func = (GtkCalendarDetailFunc_
