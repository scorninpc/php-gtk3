...
Php::Value GtkCheckMenuItem_::get_active() {
  bool ret = gtk_check_menu_item_get_active(GTK_CHECK_MENU_ITEM(instance)) != 0;
...
Php::Value GtkCheckMenuItem_::get_inconsistent() {
  bool ret =
      gtk_check_menu_item_get_inconsistent(GTK_CHECK_MENU_ITEM(instance)) != 0;
...
Php::Value GtkCheckMenuItem_::get_draw_as_radio() {
  bool ret =
      gtk_check_menu_item_get_draw_as_radio(GTK_CHECK_MENU_ITEM(instance)) != 0;
...
void GtkCheckMenuItem_::set_draw_as_radio(Php::Parameters &parameters) {
  ...
  gtk_check_menu_item_set_draw_as_radio(GTK_CHECK_MENU_ITEM(instance),
                                        draw_as_radio);
}
