...
void GtkTable_::attach(Php::Parameters &parameters) {
  ...
  gtk_table_attach(GTK_TABLE(instance), child, left_attach, right_attach, top_attach, bottom_attach,
...
void GtkTable_::attach_defaults(Php::Parameters &parameters) {
  ...
  gtk_table_attach_defaults(GTK_TABLE(instance), widget, left_attach, right_attach, top_attach,
                            bottom_attach);
}
