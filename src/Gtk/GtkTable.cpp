...
void GtkTable_::attach(Php::Parameters &parameters) {
  ...
  gtk_table_attach(GTK_TABLE(instance), child, left_attach, right_attach,
                   top_attach, bottom_attach, xoptions, yoptions, xpadding,
                   ypadding);
}
...
void GtkTable_::attach_defaults(Php::Parameters &parameters) {
  ...
  gtk_table_attach_defaults(GTK_TABLE(instance), widget, left_attach,
...
Php::Value GtkTable_::get_homogeneous() {
  ...
  bool ret = gtk_table_get_homogeneous(GTK_TABLE(instance)) != 0;
