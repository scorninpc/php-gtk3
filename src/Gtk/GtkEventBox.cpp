...
void GtkEventBox_::__construct() { instance = (gpointer *)gtk_event_box_new(); }

Php::Value GtkEventBox_::get_visible_window() {
  bool ret = gtk_event_box_get_visible_window(GTK_EVENT_BOX(instance)) != 0;
...
Php::Value GtkEventBox_::get_above_child() {
  bool ret = gtk_event_box_get_above_child(GTK_EVENT_BOX(instance)) != 0;
