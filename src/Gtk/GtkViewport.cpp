...
Php::Value GtkViewport_::get_hadjustment() {
  gpointer *ret =
      (gpointer *)gtk_viewport_get_hadjustment(GTK_VIEWPORT(instance));
...
Php::Value GtkViewport_::get_vadjustment() {
  gpointer *ret =
      (gpointer *)gtk_viewport_get_vadjustment(GTK_VIEWPORT(instance));
...
Php::Value GtkViewport_::get_bin_window() {
  gpointer *ret =
      (gpointer *)gtk_viewport_get_bin_window(GTK_VIEWPORT(instance));
...
Php::Value GtkViewport_::get_view_window() {
  gpointer *ret =
      (gpointer *)gtk_viewport_get_view_window(GTK_VIEWPORT(instance));
...
void GtkViewport_::__construct(Php::Parameters &parameters) {
  ...
  // GtkAdjustment_ *phpgtk_hadjustment = (GtkAdjustment_
  // *)object_hadjustment.implementation(); hadjustment =
  // GTK_ADJUSTMENT(phpgtk_hadjustment->get_instance());

  // GtkAdjustment *vadjustment;
  // Php::Value object_vadjustment = parameters[1];
  // GtkAdjustment_ *phpgtk_vadjustment = (GtkAdjustment_
  // *)object_vadjustment.implementation(); vadjustment =
  // GTK_ADJUSTMENT(phpgtk_vadjustment->get_instance());
