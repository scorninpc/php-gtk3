 ...
 */
GtkWidgetPath *GtkWidgetPath_::get_instance() const { return instance; }
...
void GtkWidgetPath_::__construct() { instance = gtk_widget_path_new(); }

Php::Value GtkWidgetPath_::append_type(Php::Parameters &parameters) const {
...
Php::Value
GtkWidgetPath_::append_with_siblings(Php::Parameters &parameters) const {
  GtkWidgetPath *siblings = nullptr;
  if (!parameters.empty()) {
    Php::Value object_siblings = parameters[0];
    GtkWidgetPath_ *phpgtk_siblings =
        (GtkWidgetPath_ *)object_siblings.implementation();
  ...
  gint ret =
      gtk_widget_path_append_with_siblings(instance, siblings, sibling_index);

  return ret;
}

Php::Value
GtkWidgetPath_::append_for_widget(Php::Parameters &parameters) const {
...
Php::Value GtkWidgetPath_::copy() const {
...
Php::Value GtkWidgetPath_::ref() const {
...
void GtkWidgetPath_::unref() const { gtk_widget_path_unref(instance); }

void GtkWidgetPath_::free() const { gtk_widget_path_free(instance); }

Php::Value GtkWidgetPath_::get_object_type() const {
  GType ret = gtk_widget_path_get_object_type(instance);

  return (int)ret;
}

Php::Value GtkWidgetPath_::has_parent(Php::Parameters &parameters) const {
  int int_type = (int)parameters[0];
  GType type = (GType)int_type;

  bool ret = gtk_widget_path_has_parent(instance, type) != 0;

  return ret;
}

Php::Value GtkWidgetPath_::is_type(Php::Parameters &parameters) const {
  int int_type = (int)parameters[0];
  GType type = (GType)int_type;

  bool ret = gtk_widget_path_is_type(instance, type) != 0;

  return ret;
}

void GtkWidgetPath_::iter_add_class(Php::Parameters &parameters) const {
...
void GtkWidgetPath_::iter_clear_classes(Php::Parameters &parameters) const {
  gint pos = (gint)parameters[0];
...
Php::Value GtkWidgetPath_::iter_get_name(Php::Parameters &parameters) const {
  gint pos = (gint)parameters[0];
...
Php::Value
GtkWidgetPath_::iter_get_object_name(Php::Parameters &parameters) const {
  gint pos = (gint)parameters[0];
...
Php::Value
GtkWidgetPath_::iter_get_object_type(Php::Parameters &parameters) const {
  gint pos = (gint)parameters[0];
...
Php::Value
GtkWidgetPath_::iter_get_sibling_index(Php::Parameters &parameters) const {
  gint pos = (gint)parameters[0];
...
Php::Value GtkWidgetPath_::iter_get_state(Php::Parameters &parameters) const {
  gint pos = (gint)parameters[0];
...
Php::Value GtkWidgetPath_::iter_has_class(Php::Parameters &parameters) const {
  gint pos = (gint)parameters[0];

  std::string s_name = parameters[1];
  gchar *name = (gchar *)s_name.c_str();

  bool ret = gtk_widget_path_iter_has_class(instance, pos, name) != 0;

  return ret;
}

Php::Value GtkWidgetPath_::iter_has_name(Php::Parameters &parameters) const {
  gint pos = (gint)parameters[0];

  std::string s_name = parameters[1];
  gchar *name = (gchar *)s_name.c_str();

  bool ret = gtk_widget_path_iter_has_name(instance, pos, name) != 0;
...
void GtkWidgetPath_::iter_remove_class(Php::Parameters &parameters) const {
  gint pos = (gint)parameters[0];
...
void GtkWidgetPath_::iter_set_name(Php::Parameters &parameters) const {
  gint pos = (gint)parameters[0];
...
void GtkWidgetPath_::iter_set_object_name(Php::Parameters &parameters) const {
  gint pos = (gint)parameters[0];
...
void GtkWidgetPath_::iter_set_object_type(Php::Parameters &parameters) const {
  gint pos = (gint)parameters[0];
...
void GtkWidgetPath_::iter_set_state(Php::Parameters &parameters) const {
  gint pos = (gint)parameters[0];
...
Php::Value GtkWidgetPath_::length() const {
  gint ret = gtk_widget_path_length(instance);

  return ret;
}

void GtkWidgetPath_::prepend_type(Php::Parameters &parameters) const {
  int int_type = (int)parameters[0];
  GType type = (GType)int_type;
...
Php::Value GtkWidgetPath_::to_string() const {
