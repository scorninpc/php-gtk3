...
void GtkMessageDialog_::__construct(Php::Parameters &parameters) {
  ...
  instance = (gpointer *)gtk_message_dialog_new(parent, flags, type, buttons,
                                                message_format, s_text.c_str());
}
...
void GtkMessageDialog_::format_secondary_text(Php::Parameters &parameters) {
  ...
  gtk_message_dialog_format_secondary_text(
      GTK_MESSAGE_DIALOG(instance), s_message_format.c_str(), s_text.c_str());
}
...
Php::Value GtkMessageDialog_::get_message_area() {
  gpointer *ret = (gpointer *)gtk_message_dialog_get_message_area(
      GTK_MESSAGE_DIALOG(instance));
