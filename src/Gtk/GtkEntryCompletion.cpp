...
Php::Value GtkEntryCompletion_::get_entry() {
  gpointer *ret = (gpointer *)gtk_entry_completion_get_entry(
      GTK_ENTRY_COMPLETION(instance));
...
void GtkEntryCompletion_::set_model(Php::Parameters &parameters) {
  ...
  if (!object_model.isNull()) {
    GtkTreeModel_ *phpgtk_model =
        (GtkTreeModel_ *)object_model.implementation();
...
Php::Value GtkEntryCompletion_::get_model() {
  GtkTreeModel *ret =
      gtk_entry_completion_get_model(GTK_ENTRY_COMPLETION(instance));
...
void GtkEntryCompletion_::set_match_func(Php::Parameters &parameters) {
  ...
  // 		GtkEntryCompletionMatchFunc_ *phpgtk_func =
  // (GtkEntryCompletionMatchFunc_ *)object_func.implementation(); 		func =
  ...
  //
  // 	gtk_entry_completion_set_match_func (GTK_ENTRY_COMPLETION(instance),
  // func, func_data, func_notify);
...
void GtkEntryCompletion_::set_minimum_key_length(Php::Parameters &parameters) {
  ...
  gtk_entry_completion_set_minimum_key_length(GTK_ENTRY_COMPLETION(instance),
                                              length);
}

Php::Value GtkEntryCompletion_::get_minimum_key_length() {
  gint ret = gtk_entry_completion_get_minimum_key_length(
      GTK_ENTRY_COMPLETION(instance));
...
Php::Value GtkEntryCompletion_::compute_prefix(Php::Parameters &parameters) {
  ...
  std::string ret =
      gtk_entry_completion_compute_prefix(GTK_ENTRY_COMPLETION(instance), key);
...
Php::Value GtkEntryCompletion_::get_completion_prefix() {
  std::string ret = gtk_entry_completion_get_completion_prefix(
      GTK_ENTRY_COMPLETION(instance));
...
void GtkEntryCompletion_::insert_action_text(Php::Parameters &parameters) {
  ...
  gtk_entry_completion_insert_action_text(GTK_ENTRY_COMPLETION(instance),
                                          index_, text);
}
...
void GtkEntryCompletion_::insert_action_markup(Php::Parameters &parameters) {
  ...
  gtk_entry_completion_insert_action_markup(GTK_ENTRY_COMPLETION(instance),
                                            index_, markup);
}
...
Php::Value GtkEntryCompletion_::get_text_column() {
  gint ret =
      gtk_entry_completion_get_text_column(GTK_ENTRY_COMPLETION(instance));
...
void GtkEntryCompletion_::set_inline_completion(Php::Parameters &parameters) {
  ...
  gtk_entry_completion_set_inline_completion(GTK_ENTRY_COMPLETION(instance),
                                             inline_completion);
}

Php::Value GtkEntryCompletion_::get_inline_completion() {
  bool ret = gtk_entry_completion_get_inline_completion(
                 GTK_ENTRY_COMPLETION(instance)) != 0;
...
void GtkEntryCompletion_::set_inline_selection(Php::Parameters &parameters) {
  ...
  gtk_entry_completion_set_inline_selection(GTK_ENTRY_COMPLETION(instance),
                                            inline_selection);
}

Php::Value GtkEntryCompletion_::get_inline_selection() {
  bool ret = gtk_entry_completion_get_inline_selection(
                 GTK_ENTRY_COMPLETION(instance)) != 0;
...
void GtkEntryCompletion_::set_popup_completion(Php::Parameters &parameters) {
  ...
  gtk_entry_completion_set_popup_completion(GTK_ENTRY_COMPLETION(instance),
                                            popup_completion);
}

Php::Value GtkEntryCompletion_::get_popup_completion() {
  bool ret = gtk_entry_completion_get_popup_completion(
                 GTK_ENTRY_COMPLETION(instance)) != 0;
...
void GtkEntryCompletion_::set_popup_set_width(Php::Parameters &parameters) {
  ...
  gtk_entry_completion_set_popup_set_width(GTK_ENTRY_COMPLETION(instance),
                                           popup_set_width);
}

Php::Value GtkEntryCompletion_::get_popup_set_width() {
  bool ret = gtk_entry_completion_get_popup_set_width(
                 GTK_ENTRY_COMPLETION(instance)) != 0;
...
void GtkEntryCompletion_::set_popup_single_match(Php::Parameters &parameters) {
  ...
  gtk_entry_completion_set_popup_single_match(GTK_ENTRY_COMPLETION(instance),
                                              popup_single_match);
}

Php::Value GtkEntryCompletion_::get_popup_single_match() {
  bool ret = gtk_entry_completion_get_popup_single_match(
                 GTK_ENTRY_COMPLETION(instance)) != 0;
