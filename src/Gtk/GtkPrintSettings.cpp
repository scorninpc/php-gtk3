...
Php::Value GtkPrintSettings_::new_from_key_file(Php::Parameters &parameters) {
  ...
  // GError *error;
  // GtkPrintSettings *ret = gtk_print_settings_new_from_key_file (GTK_PRINT_SETTINGS(instance),
  // group_name, &error);
...
Php::Value GtkPrintSettings_::get_page_ranges(Php::Parameters &parameters) {
  ...
  // GtkPageRange *ret = gtk_print_settings_get_page_ranges (GTK_PRINT_SETTINGS(instance),
  // num_ranges);
...
Php::Value GtkPrintSettings_::load_key_file(Php::Parameters &parameters) {
  ...
  // bool ret = gtk_print_settings_load_key_file (GTK_PRINT_SETTINGS(instance), key_file,
  // group_name, &error);
