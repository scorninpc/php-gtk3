...
Php::Value GtkPrintSettings_::new_from_key_file(Php::Parameters &parameters) {
  ...
  // GError *error;
  // GtkPrintSettings *ret = gtk_print_settings_new_from_key_file
  // (GTK_PRINT_SETTINGS(instance), group_name, &error);
...
Php::Value GtkPrintSettings_::has_key(Php::Parameters &parameters) {
  ...
  bool ret = gtk_print_settings_has_key(GTK_PRINT_SETTINGS(instance), key) != 0;
...
void GtkPrintSettings_::foreach (Php::Parameters &parameters) {
  ...
  // 	GtkPrintSettingsFunc_ *phpgtk_func = (GtkPrintSettingsFunc_
  // *)object_func.implementation(); 	func =
  // GTK_WIDGET(phpgtk_func->get_instance());
  // }
...
Php::Value GtkPrintSettings_::get_bool(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_print_settings_get_bool(GTK_PRINT_SETTINGS(instance), key) != 0;
...
Php::Value GtkPrintSettings_::get_double(Php::Parameters &parameters) {
  ...
  gdouble ret =
      gtk_print_settings_get_double(GTK_PRINT_SETTINGS(instance), key);

  return ret;
}

Php::Value
GtkPrintSettings_::get_double_with_default(Php::Parameters &parameters) {
  std::string s_key = parameters[0];
  gchar *key = (gchar *)s_key.c_str();

  gdouble def = (gdouble)parameters[1];

  gdouble ret = gtk_print_settings_get_double_with_default(
      GTK_PRINT_SETTINGS(instance), key, def);
...
Php::Value GtkPrintSettings_::get_length(Php::Parameters &parameters) {
  ...
  gdouble ret =
      gtk_print_settings_get_length(GTK_PRINT_SETTINGS(instance), key, unit);
...
Php::Value
GtkPrintSettings_::get_int_with_default(Php::Parameters &parameters) {
  std::string s_key = parameters[0];
  gchar *key = (gchar *)s_key.c_str();

  gint def = (gint)parameters[1];

  gint ret = gtk_print_settings_get_int_with_default(
      GTK_PRINT_SETTINGS(instance), key, def);
...
Php::Value GtkPrintSettings_::get_printer() {
  std::string ret =
      gtk_print_settings_get_printer(GTK_PRINT_SETTINGS(instance));
...
Php::Value GtkPrintSettings_::get_orientation() {
  GtkPageOrientation ret =
      gtk_print_settings_get_orientation(GTK_PRINT_SETTINGS(instance));
...
Php::Value GtkPrintSettings_::get_paper_size() {
  GtkPaperSize *ret =
      gtk_print_settings_get_paper_size(GTK_PRINT_SETTINGS(instance));
...
void GtkPrintSettings_::set_paper_size(Php::Parameters &parameters) {
  GtkPaperSize *paper_size = nullptr;
  if (!parameters.empty()) {
    Php::Value object_paper_size = parameters[0];
    GtkPaperSize_ *phpgtk_paper_size =
        (GtkPaperSize_ *)object_paper_size.implementation();
...
Php::Value GtkPrintSettings_::get_paper_width(Php::Parameters &parameters) {
  ...
  gdouble ret =
      gtk_print_settings_get_paper_width(GTK_PRINT_SETTINGS(instance), unit);
...
Php::Value GtkPrintSettings_::get_paper_height(Php::Parameters &parameters) {
  ...
  gdouble ret =
      gtk_print_settings_get_paper_height(GTK_PRINT_SETTINGS(instance), unit);
...
void GtkPrintSettings_::set_paper_height(Php::Parameters &parameters) {
  ...
  gtk_print_settings_set_paper_height(GTK_PRINT_SETTINGS(instance), height,
                                      unit);
}

Php::Value GtkPrintSettings_::get_use_color() {
  bool ret =
      gtk_print_settings_get_use_color(GTK_PRINT_SETTINGS(instance)) != 0;
...
Php::Value GtkPrintSettings_::get_collate() {
  bool ret = gtk_print_settings_get_collate(GTK_PRINT_SETTINGS(instance)) != 0;
...
Php::Value GtkPrintSettings_::get_reverse() {
  bool ret = gtk_print_settings_get_reverse(GTK_PRINT_SETTINGS(instance)) != 0;
...
Php::Value GtkPrintSettings_::get_duplex() {
  GtkPrintDuplex ret =
      gtk_print_settings_get_duplex(GTK_PRINT_SETTINGS(instance));
...
Php::Value GtkPrintSettings_::get_quality() {
  GtkPrintQuality ret =
      gtk_print_settings_get_quality(GTK_PRINT_SETTINGS(instance));
...
Php::Value GtkPrintSettings_::get_number_up_layout() {
  GtkNumberUpLayout ret =
      gtk_print_settings_get_number_up_layout(GTK_PRINT_SETTINGS(instance));
...
void GtkPrintSettings_::set_number_up_layout(Php::Parameters &parameters) {
  ...
  gtk_print_settings_set_number_up_layout(GTK_PRINT_SETTINGS(instance),
                                          number_up_layout);
}
...
void GtkPrintSettings_::set_resolution_xy(Php::Parameters &parameters) {
  ...
  gtk_print_settings_set_resolution_xy(GTK_PRINT_SETTINGS(instance),
...
Php::Value GtkPrintSettings_::get_printer_lpi() {
  gdouble ret =
      gtk_print_settings_get_printer_lpi(GTK_PRINT_SETTINGS(instance));
...
Php::Value GtkPrintSettings_::get_print_pages() {
  GtkPrintPages ret =
      gtk_print_settings_get_print_pages(GTK_PRINT_SETTINGS(instance));
...
Php::Value GtkPrintSettings_::get_page_ranges(Php::Parameters &parameters) {
  ...
  // GtkPageRange *ret = gtk_print_settings_get_page_ranges
  // (GTK_PRINT_SETTINGS(instance), num_ranges);
...
void GtkPrintSettings_::set_page_ranges(Php::Parameters &parameters) {
  ...
  // gtk_print_settings_set_page_ranges (GTK_PRINT_SETTINGS(instance),
  // page_ranges, num_ranges);
  throw Php::Exception("GtkPrintSettings_::set_page_ranges not implemented");
}

Php::Value GtkPrintSettings_::get_page_set() {
  GtkPageSet ret =
      gtk_print_settings_get_page_set(GTK_PRINT_SETTINGS(instance));
...
Php::Value GtkPrintSettings_::get_default_source() {
  std::string ret =
      gtk_print_settings_get_default_source(GTK_PRINT_SETTINGS(instance));
...
void GtkPrintSettings_::set_default_source(Php::Parameters &parameters) {
  ...
  gtk_print_settings_set_default_source(GTK_PRINT_SETTINGS(instance),
                                        default_source);
}

Php::Value GtkPrintSettings_::get_media_type() {
  std::string ret =
      gtk_print_settings_get_media_type(GTK_PRINT_SETTINGS(instance));
...
Php::Value GtkPrintSettings_::get_finishings() {
  std::string ret =
      gtk_print_settings_get_finishings(GTK_PRINT_SETTINGS(instance));
...
Php::Value GtkPrintSettings_::get_output_bin() {
  std::string ret =
      gtk_print_settings_get_output_bin(GTK_PRINT_SETTINGS(instance));
...
Php::Value GtkPrintSettings_::load_file(Php::Parameters &parameters) {
  ...
  GError *error = nullptr;
  bool ret = gtk_print_settings_load_file(GTK_PRINT_SETTINGS(instance),
                                          file_name, &error) != 0;
...
Php::Value GtkPrintSettings_::load_key_file(Php::Parameters &parameters) {
  ...
  // bool ret = gtk_print_settings_load_key_file (GTK_PRINT_SETTINGS(instance),
  // key_file, group_name, &error);
...
Php::Value GtkPrintSettings_::to_file(Php::Parameters &parameters) {
  ...
  GError *error = nullptr;
  bool ret = gtk_print_settings_to_file(GTK_PRINT_SETTINGS(instance), file_name,
                                        &error) != 0;
...
void GtkPrintSettings_::to_key_file(Php::Parameters &parameters) {
  ...
  // gtk_print_settings_to_key_file (GTK_PRINT_SETTINGS(instance), key_file,
  // group_name);
