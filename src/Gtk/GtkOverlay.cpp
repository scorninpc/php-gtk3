...
void GtkOverlay_::__construct() { instance = (gpointer *)gtk_overlay_new(); }
...
Php::Value GtkOverlay_::get_overlay_pass_through(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_overlay_get_overlay_pass_through(GTK_OVERLAY(instance), widget) != 0;
...
void GtkOverlay_::set_overlay_pass_through(Php::Parameters &parameters) {
  ...
  gtk_overlay_set_overlay_pass_through(GTK_OVERLAY(instance), widget,
                                       pass_through);
}
