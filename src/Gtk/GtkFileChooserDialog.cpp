...
void GtkFileChooserDialog_::__construct(Php::Parameters &parameters) {
  ...
  instance = (gpointer *)gtk_file_chooser_dialog_new(title, parent, action,
                                                     arr[0], (int)arr[1], NULL);

  // Add buttons
  for (int index = 2; index < (int)arr.size(); index += 2) {
    gtk_dialog_add_button(GTK_DIALOG(instance), arr[index],
                          (int)arr[index + 1]);
  }
}
...
Php::Value GtkFileChooserDialog_::get_action() {
  GtkFileChooserAction ret =
      gtk_file_chooser_get_action(GTK_FILE_CHOOSER(instance));
...
Php::Value GtkFileChooserDialog_::get_local_only() {
  bool ret = gtk_file_chooser_get_local_only(GTK_FILE_CHOOSER(instance)) != 0;
...
void GtkFileChooserDialog_::set_select_multiple(Php::Parameters &parameters) {
  ...
  gtk_file_chooser_set_select_multiple(GTK_FILE_CHOOSER(instance),
                                       select_multiple);
}

Php::Value GtkFileChooserDialog_::get_select_multiple() {
  bool ret =
      gtk_file_chooser_get_select_multiple(GTK_FILE_CHOOSER(instance)) != 0;
...
Php::Value GtkFileChooserDialog_::get_show_hidden() {
  bool ret = gtk_file_chooser_get_show_hidden(GTK_FILE_CHOOSER(instance)) != 0;

  return ret;
}

void GtkFileChooserDialog_::set_do_overwrite_confirmation(
    Php::Parameters &parameters) {
  gboolean select_multiple = (gboolean)parameters[0];

  gtk_file_chooser_set_do_overwrite_confirmation(GTK_FILE_CHOOSER(instance),
                                                 select_multiple);
}

Php::Value GtkFileChooserDialog_::get_do_overwrite_confirmation() {
  bool ret = gtk_file_chooser_get_do_overwrite_confirmation(
                 GTK_FILE_CHOOSER(instance)) != 0;
...
void GtkFileChooserDialog_::set_create_folders(Php::Parameters &parameters) {
  ...
  gtk_file_chooser_set_create_folders(GTK_FILE_CHOOSER(instance),
                                      create_folders);
}

Php::Value GtkFileChooserDialog_::get_create_folders() {
  bool ret =
      gtk_file_chooser_get_create_folders(GTK_FILE_CHOOSER(instance)) != 0;
...
Php::Value GtkFileChooserDialog_::get_current_name() {
  std::string ret =
      gtk_file_chooser_get_current_name(GTK_FILE_CHOOSER(instance));
...
Php::Value GtkFileChooserDialog_::set_filename(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_file_chooser_set_filename(GTK_FILE_CHOOSER(instance), name) != 0;
...
Php::Value GtkFileChooserDialog_::select_filename(Php::Parameters &parameters) {
  ...
  bool ret = gtk_file_chooser_select_filename(GTK_FILE_CHOOSER(instance),
                                              filename) != 0;
...
Php::Value
GtkFileChooserDialog_::set_current_folder(Php::Parameters &parameters) {
  std::string s_filename = parameters[0];
  gchar *filename = (gchar *)s_filename.c_str();

  bool ret = gtk_file_chooser_set_current_folder(GTK_FILE_CHOOSER(instance),
                                                 filename) != 0;
...
Php::Value GtkFileChooserDialog_::get_current_folder() {
  std::string ret =
      gtk_file_chooser_get_current_folder(GTK_FILE_CHOOSER(instance));
...
Php::Value GtkFileChooserDialog_::get_uri() {
  std::string ret =
      gtk_file_chooser_get_preview_filename(GTK_FILE_CHOOSER(instance));
...
Php::Value GtkFileChooserDialog_::set_uri(Php::Parameters &parameters) {
  ...
  bool ret = gtk_file_chooser_set_uri(GTK_FILE_CHOOSER(instance), uri) != 0;
...
Php::Value GtkFileChooserDialog_::select_uri(Php::Parameters &parameters) {
  ...
  bool ret = gtk_file_chooser_select_uri(GTK_FILE_CHOOSER(instance), uri) != 0;
...
Php::Value
GtkFileChooserDialog_::set_current_folder_uri(Php::Parameters &parameters) {
  std::string s_uri = parameters[0];
  gchar *uri = (gchar *)s_uri.c_str();

  bool ret = gtk_file_chooser_set_current_folder_uri(GTK_FILE_CHOOSER(instance),
                                                     uri) != 0;
...
Php::Value GtkFileChooserDialog_::get_current_folder_uri() {
  std::string s_uri =
      gtk_file_chooser_get_current_folder_uri(GTK_FILE_CHOOSER(instance));

  return s_uri.c_str();
}

void GtkFileChooserDialog_::set_preview_widget(Php::Parameters &parameters) {
  GtkWidget *preview_widget = nullptr;
  if (!parameters.empty()) {
    Php::Value object_preview_widget = parameters[0];
    GtkWidget_ *phpgtk_preview_widget =
        (GtkWidget_ *)object_preview_widget.implementation();
    preview_widget = GTK_WIDGET(phpgtk_preview_widget->get_instance());
  }

  gtk_file_chooser_set_preview_widget(GTK_FILE_CHOOSER(instance),
                                      preview_widget);
}

Php::Value GtkFileChooserDialog_::get_preview_widget() {
  gpointer *ret = (gpointer *)gtk_file_chooser_get_preview_widget(
      GTK_FILE_CHOOSER(instance));
...
void GtkFileChooserDialog_::set_preview_widget_active(
    Php::Parameters &parameters) {
  gboolean active = (gboolean)parameters[0];

  gtk_file_chooser_set_preview_widget_active(GTK_FILE_CHOOSER(instance),
                                             active);
}

Php::Value GtkFileChooserDialog_::get_preview_widget_active() {
  bool ret = gtk_file_chooser_get_preview_widget_active(
                 GTK_FILE_CHOOSER(instance)) != 0;
...
Php::Value GtkFileChooserDialog_::get_use_preview_label() {
  bool ret =
      gtk_file_chooser_get_use_preview_label(GTK_FILE_CHOOSER(instance)) != 0;
...
Php::Value GtkFileChooserDialog_::get_preview_uri() {
  std::string ret =
      gtk_file_chooser_get_preview_uri(GTK_FILE_CHOOSER(instance));

  return ret;
}

void GtkFileChooserDialog_::set_extra_widget(Php::Parameters &parameters) {
  GtkWidget *extra_widget = nullptr;
  if (!parameters.empty()) {
    Php::Value object_extra_widget = parameters[0];
    GtkWidget_ *phpgtk_extra_widget =
        (GtkWidget_ *)object_extra_widget.implementation();
...
Php::Value GtkFileChooserDialog_::get_extra_widget() {
  gpointer *ret =
      (gpointer *)gtk_file_chooser_get_extra_widget(GTK_FILE_CHOOSER(instance));
...
void GtkFileChooserDialog_::add_filter(Php::Parameters &parameters) {
  ...
  if (!parameters.empty()) {
    ...
    GtkFileFilter_ *phpgtk_filter =
        (GtkFileFilter_ *)object_filter.implementation();
