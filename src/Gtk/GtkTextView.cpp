...
void GtkTextView_::__construct() { instance = (gpointer *)gtk_text_view_new(); }

Php::Value GtkTextView_::new_with_buffer(Php::Parameters &parameters) {
  GtkTextBuffer *buffer = nullptr;
  if (!parameters.empty()) {
    Php::Value object_buffer = parameters[0];
    GtkTextBuffer_ *phpgtk_buffer =
        (GtkTextBuffer_ *)object_buffer.implementation();
...
void GtkTextView_::scroll_to_mark(Php::Parameters &parameters) {
  ...
  gtk_text_view_scroll_to_mark(GTK_TEXT_VIEW(instance), mark, within_margin,
...
void GtkTextView_::scroll_to_iter(Php::Parameters &parameters) {
  ...
  gtk_text_view_scroll_to_iter(GTK_TEXT_VIEW(instance), &iter, within_margin,
                               use_align, xalign, yalign);
}
...
Php::Value GtkTextView_::move_mark_onscreen(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_text_view_move_mark_onscreen(GTK_TEXT_VIEW(instance), mark) != 0;

  return ret;
}

Php::Value GtkTextView_::place_cursor_onscreen() {
  bool ret = gtk_text_view_place_cursor_onscreen(GTK_TEXT_VIEW(instance)) != 0;
...
Php::Value GtkTextView_::get_line_at_y(Php::Parameters &parameters) {
  ...
  GtkTextIter_ *phpgtk_target_iter =
      (GtkTextIter_ *)object_target_iter.implementation();
  ...
  gtk_text_view_get_line_at_y(GTK_TEXT_VIEW(instance), &target_iter, y,
                              &line_top);
...
Php::Value GtkTextView_::get_line_yrange(Php::Parameters &parameters) {
  ...
  gtk_text_view_get_line_yrange(GTK_TEXT_VIEW(instance), &target_iter, &y,
                                &height);
...
Php::Value GtkTextView_::get_iter_at_location(Php::Parameters &parameters) {
  ...
  gint ret = gtk_text_view_get_iter_at_location(GTK_TEXT_VIEW(instance),
                                                &target_iter, x, y);
  if (ret == 0) {
    return ret;
  }
...
Php::Value GtkTextView_::get_iter_at_position(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_view_get_iter_at_position(
                 GTK_TEXT_VIEW(instance), &target_iter, nullptr, x, y) != 0;
  if (!ret) {
    return ret;
  }
...
Php::Value GtkTextView_::buffer_to_window_coords(Php::Parameters &parameters) {
  ...
  gtk_text_view_buffer_to_window_coords(GTK_TEXT_VIEW(instance), win, buffer_x,
...
Php::Value GtkTextView_::window_to_buffer_coords(Php::Parameters &parameters) {
  ...
  gtk_text_view_window_to_buffer_coords(GTK_TEXT_VIEW(instance), win, window_x,
...
Php::Value GtkTextView_::get_window_type(Php::Parameters &parameters) {
  ...
  // GtkTextWindowType ret = gtk_text_view_get_window_type
  // (GTK_TEXT_VIEW(instance), win);
...
Php::Value GtkTextView_::get_border_window_size(Php::Parameters &parameters) {
  ...
  gint ret =
      gtk_text_view_get_border_window_size(GTK_TEXT_VIEW(instance), type);
...
Php::Value GtkTextView_::forward_display_line(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_text_view_forward_display_line(GTK_TEXT_VIEW(instance), &type) != 0;
...
Php::Value GtkTextView_::backward_display_line(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_text_view_backward_display_line(GTK_TEXT_VIEW(instance), &type) != 0;
...
Php::Value GtkTextView_::forward_display_line_end(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_view_forward_display_line_end(GTK_TEXT_VIEW(instance),
                                                    &type) != 0;
...
Php::Value
GtkTextView_::backward_display_line_start(Php::Parameters &parameters) {

  Php::Value object_type = parameters[0];
  GtkTextIter_ *phpgtk_type = (GtkTextIter_ *)object_type.implementation();
  GtkTextIter type = (phpgtk_type->get_instance());

  bool ret = gtk_text_view_backward_display_line_start(GTK_TEXT_VIEW(instance),
                                                       &type) != 0;
...
Php::Value GtkTextView_::starts_display_line(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_text_view_starts_display_line(GTK_TEXT_VIEW(instance), &type) != 0;
...
Php::Value GtkTextView_::move_visually(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_text_view_move_visually(GTK_TEXT_VIEW(instance), &type, count) != 0;
...
void GtkTextView_::add_child_in_window(Php::Parameters &parameters) {
  ...
  gtk_text_view_add_child_in_window(GTK_TEXT_VIEW(instance), child,
                                    which_window, xpos, ypos);
}
...
Php::Value GtkTextView_::get_editable() {
  bool ret = gtk_text_view_get_editable(GTK_TEXT_VIEW(instance)) != 0;
...
Php::Value GtkTextView_::get_cursor_visible() {
  bool ret = gtk_text_view_get_cursor_visible(GTK_TEXT_VIEW(instance)) != 0;
...
Php::Value GtkTextView_::get_overwrite() {
  bool ret = gtk_text_view_get_overwrite(GTK_TEXT_VIEW(instance)) != 0;
...
void GtkTextView_::set_pixels_above_lines(Php::Parameters &parameters) {
  ...
  gtk_text_view_set_pixels_above_lines(GTK_TEXT_VIEW(instance),
                                       pixels_above_lines);
}
...
void GtkTextView_::set_pixels_below_lines(Php::Parameters &parameters) {
  ...
  gtk_text_view_set_pixels_below_lines(GTK_TEXT_VIEW(instance),
                                       pixels_below_lines);
}
...
void GtkTextView_::set_pixels_inside_wrap(Php::Parameters &parameters) {
  ...
  gtk_text_view_set_pixels_inside_wrap(GTK_TEXT_VIEW(instance),
                                       pixels_inside_wrap);
}
...
Php::Value GtkTextView_::get_justification() {
  GtkJustification ret =
      gtk_text_view_get_justification(GTK_TEXT_VIEW(instance));
...
Php::Value GtkTextView_::get_accepts_tab() {
  bool ret = gtk_text_view_get_accepts_tab(GTK_TEXT_VIEW(instance)) != 0;

  return ret;
}

Php::Value
GtkTextView_::im_context_filter_keypress(Php::Parameters &parameters) {
  // bool ret = gtk_text_view_im_context_filter_keypress
  // (GTK_TEXT_VIEW(instance), event); return ret;

  throw Php::Exception(
      "GtkTextView_::im_context_filter_keypress not implemented");
  return -1;
}
...
Php::Value GtkTextView_::get_input_purpose() {
  GtkInputPurpose ret =
      gtk_text_view_get_input_purpose(GTK_TEXT_VIEW(instance));
...
Php::Value GtkTextView_::get_monospace() {
  bool ret = gtk_text_view_get_monospace(GTK_TEXT_VIEW(instance)) != 0;
