...
void GtkTextView_::scroll_to_mark(Php::Parameters &parameters) {
  ...
  gtk_text_view_scroll_to_mark(GTK_TEXT_VIEW(instance), mark, within_margin, use_align, xalign,
                               yalign);
}
...
void GtkTextView_::scroll_to_iter(Php::Parameters &parameters) {
  ...
  gtk_text_view_scroll_to_iter(GTK_TEXT_VIEW(instance), &iter, within_margin, use_align, xalign,
                               yalign);
}
...
Php::Value GtkTextView_::buffer_to_window_coords(Php::Parameters &parameters) {
  ...
  gtk_text_view_buffer_to_window_coords(GTK_TEXT_VIEW(instance), win, buffer_x, buffer_y, &window_x,
                                        &window_y);
...
Php::Value GtkTextView_::window_to_buffer_coords(Php::Parameters &parameters) {
  ...
  gtk_text_view_window_to_buffer_coords(GTK_TEXT_VIEW(instance), win, window_x, window_y, &buffer_x,
                                        &buffer_y);
