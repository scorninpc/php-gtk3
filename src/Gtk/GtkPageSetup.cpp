...
Php::Value GtkPageSetup_::get_orientation() {
  GtkPageOrientation ret =
      gtk_page_setup_get_orientation(GTK_PAGE_SETUP(instance));
...
Php::Value GtkPageSetup_::get_bottom_margin(Php::Parameters &parameters) {
  ...
  gdouble ret =
      gtk_page_setup_get_bottom_margin(GTK_PAGE_SETUP(instance), unit);
...
void GtkPageSetup_::set_paper_size_and_default_margins(
  ...
  gtk_page_setup_set_paper_size_and_default_margins(GTK_PAGE_SETUP(instance),
                                                    paper_size);
}
...
Php::Value GtkPageSetup_::load_file(Php::Parameters &parameters) {
  ...
  GError *error = nullptr;
  bool ret = gtk_page_setup_load_file(GTK_PAGE_SETUP(instance), file_name,
                                      &error) != 0;
...
Php::Value GtkPageSetup_::load_key_file(Php::Parameters &parameters) {
  ...
  // gboolean ret = gtk_page_setup_load_key_file (GTK_PAGE_SETUP(instance),
...
Php::Value GtkPageSetup_::to_file(Php::Parameters &parameters) {
  ...
  GError *error = nullptr;
  bool ret =
      gtk_page_setup_to_file(GTK_PAGE_SETUP(instance), file_name, &error) != 0;
...
void GtkPageSetup_::to_key_file(Php::Parameters &parameters) {
  ...
  // gtk_page_setup_to_key_file (GTK_PAGE_SETUP(instance), key_file,
  // group_name);
