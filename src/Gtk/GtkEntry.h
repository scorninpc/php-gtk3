...
class GtkEntry_ : public GtkWidget_ {
 ...
 public:
  ...
  /**
   * Retrieves the character displayed in place of the real characters for entries with visibility
   * set to false
   *
  ...
  /**
   * If setting is TRUE, pressing Enter in the entry will activate the default widget for the window
  ...
  /**
   * Sets the alignment for the contents of the entry. This controls the horizontal positioning of
   * the contents when the displayed text is shorter than the width of the entry.
   *
