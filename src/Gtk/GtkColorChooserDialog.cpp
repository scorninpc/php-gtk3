...
Php::Value GtkColorChooserDialog_::get_use_alpha() {
  bool ret = gtk_color_chooser_get_use_alpha(GTK_COLOR_CHOOSER(instance)) != 0;
...
void GtkColorChooserDialog_::add_palette(Php::Parameters &parameters) {
  ...
  // gtk_color_chooser_add_palette (GTK_COLOR_CHOOSER_DIALOG(instance),
  // GtkOrientation, color_per_line, n_colors, colors);

  throw Php::Exception(
      "GtkColorChooserDialog_::add_palette not implemented yet");
}
