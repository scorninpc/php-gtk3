...
void GtkFlowBox_::__construct() { instance = (gpointer *)gtk_flow_box_new(); }
...
Php::Value GtkFlowBox_::get_child_at_index(Php::Parameters &parameters) {
  ...
  GtkFlowBoxChild *ret =
      gtk_flow_box_get_child_at_index(GTK_FLOW_BOX(instance), idx);
...
Php::Value GtkFlowBox_::get_homogeneous() {
  bool ret = gtk_flow_box_get_homogeneous(GTK_FLOW_BOX(instance)) != 0;
...
Php::Value GtkFlowBox_::get_activate_on_single_click() {
  bool ret =
      gtk_flow_box_get_activate_on_single_click(GTK_FLOW_BOX(instance)) != 0;
...
void GtkFlowBox_::selected_foreach(Php::Parameters &parameters) {
  ...
  // 	GtkFlowBoxForeachFunc_ *phpgtk_func = (GtkFlowBoxForeachFunc_
...
void GtkFlowBox_::select_child(Php::Parameters &parameters) {
  GtkFlowBoxChild *child = nullptr;
  if (!parameters.empty()) {
    Php::Value object_child = parameters[0];
    GtkFlowBoxChild_ *phpgtk_child =
        (GtkFlowBoxChild_ *)object_child.implementation();
...
Php::Value GtkFlowBox_::get_selection_mode() {
  GtkSelectionMode ret =
      gtk_flow_box_get_selection_mode(GTK_FLOW_BOX(instance));
...
void GtkFlowBox_::set_filter_func(Php::Parameters &parameters) {
  ...
  // 	GtkFlowBoxFilterFunc_ *phpgtk_filter_func = (GtkFlowBoxFilterFunc_
  // *)object_filter_func.implementation(); 	filter_func =
  // GTK_WIDGET(phpgtk_filter_func->get_instance());
  // }

  // gpointer user_data = (gpointer)parameters[1];

  // gtk_flow_box_set_filter_func (GTK_FLOW_BOX(instance), filter_func,
  // user_data, destroy);
...
void GtkFlowBox_::set_sort_func(Php::Parameters &parameters) {
  ...
  // gtk_flow_box_set_sort_func (GTK_FLOW_BOX(instance), sort_func, user_data,
  // destroy);
...
void GtkFlowBox_::bind_model(Php::Parameters &parameters) {
  ...
  // 	GtkFlowBoxCreateWidgetFunc_ *phpgtk_create_widget_func =
  // (GtkFlowBoxCreateWidgetFunc_ *)object_create_widget_func.implementation();
  // 	create_widget_func =
  // GTK_WIDGET(phpgtk_create_widget_func->get_instance());
  // }

  // gpointer user_data = (gpointer)parameters[2];

  // gtk_flow_box_bind_model (GTK_FLOW_BOX(instance), model, create_widget_func,
