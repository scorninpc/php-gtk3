...
Php::Value GtkTextBuffer_::get_tag_table() {
  GtkTextTagTable *ret =
      gtk_text_buffer_get_tag_table(GTK_TEXT_BUFFER(instance));
...
Php::Value GtkTextBuffer_::insert_interactive(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_text_buffer_insert_interactive(GTK_TEXT_BUFFER(instance), &iter, text,
                                         len, default_editable) != 0;

  return ret;
}

Php::Value
GtkTextBuffer_::insert_interactive_at_cursor(Php::Parameters &parameters) {
  std::string s_text = parameters[0];
  gchar *text = (gchar *)s_text.c_str();
  ...
  bool ret = gtk_text_buffer_insert_interactive_at_cursor(
                 GTK_TEXT_BUFFER(instance), text, len, default_editable) != 0;
...
Php::Value
GtkTextBuffer_::insert_range_interactive(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_buffer_insert_range_interactive(GTK_TEXT_BUFFER(instance),
                                                      &iter, &start, &end,
                                                      default_editable) != 0;
...
void GtkTextBuffer_::insert_with_tags(Php::Parameters &parameters) {
  ...
  if (parameters.size() > 3) {
    ...
    GtkTextTag_ *phpgtk_first_tag =
        (GtkTextTag_ *)object_first_tag.implementation();
    first_tag = (phpgtk_first_tag->get_tag());
  }

  gtk_text_buffer_insert_with_tags(GTK_TEXT_BUFFER(instance), &iter, text, len,
                                   first_tag, NULL);
}
...
void GtkTextBuffer_::insert_with_tags_by_name(Php::Parameters &parameters) {
  ...
  gtk_text_buffer_insert_with_tags_by_name(GTK_TEXT_BUFFER(instance), &iter,
                                           text, len, first_tag_name, NULL);
}
...
Php::Value GtkTextBuffer_::delete_interactive(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_text_buffer_delete_interactive(GTK_TEXT_BUFFER(instance), &start,
                                         &end, default_editable) != 0;
...
Php::Value GtkTextBuffer_::backspace(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_buffer_backspace(GTK_TEXT_BUFFER(instance), &iter,
                                       interactive, default_editable) != 0;
...
Php::Value GtkTextBuffer_::get_text(Php::Parameters &parameters) {
  ...
  std::string ret = gtk_text_buffer_get_text(GTK_TEXT_BUFFER(instance), &start,
                                             &end, include_hidden_chars);
...
Php::Value GtkTextBuffer_::get_slice(Php::Parameters &parameters) {
  ...
  std::string ret = gtk_text_buffer_get_slice(GTK_TEXT_BUFFER(instance), &start,
                                              &end, include_hidden_chars);
...
Php::Value GtkTextBuffer_::create_mark(Php::Parameters &parameters) {
  ...
  GtkTextMark *ret = gtk_text_buffer_create_mark(
      GTK_TEXT_BUFFER(instance), mark_name, &where, left_gravity);
...
Php::Value GtkTextBuffer_::get_selection_bound(Php::Parameters &parameters) {
  GtkTextMark *ret =
      gtk_text_buffer_get_selection_bound(GTK_TEXT_BUFFER(instance));
...
Php::Value GtkTextBuffer_::get_has_selection(Php::Parameters &parameters) {
  bool ret = gtk_text_buffer_get_has_selection(GTK_TEXT_BUFFER(instance)) != 0;
...
void GtkTextBuffer_::apply_tag_by_name(Php::Parameters &parameters) {
  ...
  gtk_text_buffer_apply_tag_by_name(GTK_TEXT_BUFFER(instance), name, &start,
                                    &end);
}
...
void GtkTextBuffer_::remove_tag_by_name(Php::Parameters &parameters) {
  ...
  gtk_text_buffer_remove_tag_by_name(GTK_TEXT_BUFFER(instance), name, &start,
                                     &end);
}
...
Php::Value GtkTextBuffer_::create_tag(Php::Parameters &parameters) {
  ...
  GtkTextTag *ret = gtk_text_buffer_create_tag(GTK_TEXT_BUFFER(instance),
                                               tag_name, first_property_name);
...
Php::Value
GtkTextBuffer_::get_iter_at_line_offset(Php::Parameters &parameters) {
  GtkTextIter iter;
  ...
  gtk_text_buffer_get_iter_at_line_offset(GTK_TEXT_BUFFER(instance), &iter,
...
Php::Value GtkTextBuffer_::get_iter_at_offset(Php::Parameters &parameters) {
  ...
  gtk_text_buffer_get_iter_at_offset(GTK_TEXT_BUFFER(instance), &iter,
                                     char_offset);
...
Php::Value GtkTextBuffer_::get_iter_at_line(Php::Parameters &parameters) {
  ...
  gtk_text_buffer_get_iter_at_line(GTK_TEXT_BUFFER(instance), &iter,
                                   line_number);
...
Php::Value GtkTextBuffer_::get_iter_at_line_index(Php::Parameters &parameters) {
  ...
  gtk_text_buffer_get_iter_at_line_index(GTK_TEXT_BUFFER(instance), &iter,
...
Php::Value GtkTextBuffer_::get_modified() {
  bool ret = gtk_text_buffer_get_modified(GTK_TEXT_BUFFER(instance)) != 0;
...
Php::Value GtkTextBuffer_::delete_selection(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_buffer_delete_selection(
                 GTK_TEXT_BUFFER(instance), interactive, default_editable) != 0;
...
Php::Value GtkTextBuffer_::get_selection_bounds(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_buffer_get_selection_bounds(GTK_TEXT_BUFFER(instance),
                                                  &start, &end) != 0;
  if (!ret) {
    return ret;
  }
...
void GtkTextBuffer_::remove_selection_clipboard(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkTextBuffer_::remove_selection_clipboard not implemented");
}
...
Php::Value
GtkTextBuffer_::deserialize_get_can_create_tags(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkTextBuffer_::deserialize_get_can_create_tags not implemented");
  return -1;
}

Php::Value
GtkTextBuffer_::deserialize_set_can_create_tags(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkTextBuffer_::deserialize_set_can_create_tags not implemented");
  return -1;
}
...
Php::Value
GtkTextBuffer_::get_deserialize_formats(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkTextBuffer_::get_deserialize_formats not implemented");
  return -1;
}
...
Php::Value
GtkTextBuffer_::register_deserialize_format(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkTextBuffer_::register_deserialize_format not implemented");
  return -1;
}

Php::Value
GtkTextBuffer_::register_serialize_format(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkTextBuffer_::register_serialize_format not implemented");
  return -1;
}

Php::Value
GtkTextBuffer_::register_serialize_tagset(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkTextBuffer_::register_serialize_tagset not implemented");
  return -1;
}
...
Php::Value
GtkTextBuffer_::unregister_deserialize_format(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkTextBuffer_::unregister_deserialize_format not implemented");
  return -1;
}

Php::Value
GtkTextBuffer_::unregister_serialize_format(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkTextBuffer_::unregister_serialize_format not implemented");
  return -1;
}
