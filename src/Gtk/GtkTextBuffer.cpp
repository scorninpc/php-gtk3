...
Php::Value GtkTextBuffer_::insert_range_interactive(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_buffer_insert_range_interactive(GTK_TEXT_BUFFER(instance), &iter, &start,
                                                      &end, default_editable);
...
void GtkTextBuffer_::insert_with_tags_by_name(Php::Parameters &parameters) {
  ...
  gtk_text_buffer_insert_with_tags_by_name(GTK_TEXT_BUFFER(instance), &iter, text, len,
                                           first_tag_name, NULL);
}
...
Php::Value GtkTextBuffer_::delete_interactive(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_text_buffer_delete_interactive(GTK_TEXT_BUFFER(instance), &start, &end, default_editable);
...
Php::Value GtkTextBuffer_::backspace(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_text_buffer_backspace(GTK_TEXT_BUFFER(instance), &iter, interactive, default_editable);
...
Php::Value GtkTextBuffer_::get_text(Php::Parameters &parameters) {
  ...
  std::string ret =
      gtk_text_buffer_get_text(GTK_TEXT_BUFFER(instance), &start, &end, include_hidden_chars);
...
Php::Value GtkTextBuffer_::get_slice(Php::Parameters &parameters) {
  ...
  std::string ret =
      gtk_text_buffer_get_slice(GTK_TEXT_BUFFER(instance), &start, &end, include_hidden_chars);
...
Php::Value GtkTextBuffer_::create_mark(Php::Parameters &parameters) {
  ...
  GtkTextMark *ret =
      gtk_text_buffer_create_mark(GTK_TEXT_BUFFER(instance), mark_name, &where, left_gravity);
...
Php::Value GtkTextBuffer_::create_tag(Php::Parameters &parameters) {
  ...
  GtkTextTag *ret =
      gtk_text_buffer_create_tag(GTK_TEXT_BUFFER(instance), tag_name, first_property_name);
...
Php::Value GtkTextBuffer_::get_iter_at_line_offset(Php::Parameters &parameters) {
  ...
  gtk_text_buffer_get_iter_at_line_offset(GTK_TEXT_BUFFER(instance), &iter, line_number,
                                          char_offset);
...
Php::Value GtkTextBuffer_::delete_selection(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_text_buffer_delete_selection(GTK_TEXT_BUFFER(instance), interactive, default_editable);
