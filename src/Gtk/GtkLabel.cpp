...
Php::Value GtkLabel_::get_selectable() {
  bool ret = gtk_label_get_selectable(GTK_LABEL(instance)) != 0;
...
Php::Value GtkLabel_::get_line_wrap() {
  bool ret = gtk_label_get_line_wrap(GTK_LABEL(instance)) != 0;
...
Php::Value GtkLabel_::get_mnemonic_widget() {
  gpointer *ret =
      (gpointer *)gtk_label_get_mnemonic_widget(GTK_LABEL(instance));
...
Php::Value GtkLabel_::get_use_markup() {
  bool ret = gtk_label_get_use_markup(GTK_LABEL(instance)) != 0;

  return ret;
}

Php::Value GtkLabel_::get_use_underline() {
  bool ret = gtk_label_get_use_underline(GTK_LABEL(instance)) != 0;

  return ret;
}

Php::Value GtkLabel_::get_single_line_mode() {
  bool ret = gtk_label_get_single_line_mode(GTK_LABEL(instance)) != 0;
...
Php::Value GtkLabel_::get_track_visited_links() {
  bool ret = gtk_label_get_track_visited_links(GTK_LABEL(instance)) != 0;
