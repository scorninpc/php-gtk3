...
void GtkMenuShell_::activate_item(Php::Parameters &parameters) {
  ...
  gtk_menu_shell_activate_item(GTK_MENU_SHELL(instance), menu_item,
                               force_deactivate);
}
...
Php::Value GtkMenuShell_::get_take_focus() {
  bool ret = gtk_menu_shell_get_take_focus(GTK_MENU_SHELL(instance)) != 0;
...
Php::Value GtkMenuShell_::get_selected_item() {
  gpointer *ret =
      (gpointer *)gtk_menu_shell_get_selected_item(GTK_MENU_SHELL(instance));
...
Php::Value GtkMenuShell_::get_parent_shell() {
  gpointer *ret =
      (gpointer *)gtk_menu_shell_get_parent_shell(GTK_MENU_SHELL(instance));
...
void GtkMenuShell_::bind_model(Php::Parameters &parameters) {
  ...
  // gtk_menu_shell_bind_model (GTK_MENU_SHELL(instance), model,
  // action_namespace, with_separators);
