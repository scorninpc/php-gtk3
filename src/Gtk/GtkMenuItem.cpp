...
void GtkMenuItem_::__construct() { instance = (gpointer *)gtk_menu_item_new(); }
...
Php::Value GtkMenuItem_::get_use_underline() {
  bool ret = gtk_menu_item_get_use_underline(GTK_MENU_ITEM(instance)) != 0;
...
Php::Value GtkMenuItem_::get_submenu() {
  gpointer *ret =
      (gpointer *)gtk_menu_item_get_submenu(GTK_MENU_ITEM(instance));
...
Php::Value GtkMenuItem_::get_reserve_indicator() {
  bool ret = gtk_menu_item_get_reserve_indicator(GTK_MENU_ITEM(instance)) != 0;
