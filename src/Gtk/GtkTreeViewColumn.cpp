...
void GtkTreeViewColumn_::__construct(Php::Parameters &parameters) {
  ...
  // if (!object.instanceOf("GtkCellRenderer")) throw Php::Exception("parameter
  // expect GtkCellRenderer instance");
  GtkCellRenderer_ *passedRenderer =
      (GtkCellRenderer_ *)object.implementation();

  // Get type and column
  std::string t_column = parameters[2];
  int n_column = parameters[3];

  instance = (gpointer *)gtk_tree_view_column_new_with_attributes(
      title.c_str(), GTK_CELL_RENDERER(passedRenderer->get_instance()),
      t_column.c_str(), n_column, NULL);
}
...
void GtkTreeViewColumn_::pack_start(Php::Parameters &parameters) {
  ...
  gtk_tree_view_column_pack_start(
      GTK_TREE_VIEW_COLUMN(instance),
      GTK_CELL_RENDERER(passedRenderer->get_instance()), parameters[1]);
}
...
void GtkTreeViewColumn_::set_resizable(Php::Parameters &parameters) {
  gtk_tree_view_column_set_resizable(GTK_TREE_VIEW_COLUMN(instance),
                                     parameters[0]);
}
...
void GtkTreeViewColumn_::set_fixed_width(Php::Parameters &parameters) {
  gtk_tree_view_column_set_fixed_width(GTK_TREE_VIEW_COLUMN(instance),
                                       parameters[0]);
}
...
Php::Value GtkTreeViewColumn_::get_button() {
  ...
  GtkWidget *widget =
      gtk_tree_view_column_get_button(GTK_TREE_VIEW_COLUMN(instance));
...
void GtkTreeViewColumn_::set_reorderable(Php::Parameters &parameters) {
  gtk_tree_view_column_set_reorderable(GTK_TREE_VIEW_COLUMN(instance),
                                       parameters[0]);
}
...
void GtkTreeViewColumn_::set_sizing(Php::Parameters &parameters) {
  ...
  gtk_tree_view_column_set_sizing(GTK_TREE_VIEW_COLUMN(instance),
...
Php::Value GtkTreeViewColumn_::get_widget() {
  // Create the gtk button
  gpointer *ret = (gpointer *)gtk_tree_view_column_get_widget(
      GTK_TREE_VIEW_COLUMN(instance));
...
void GtkTreeViewColumn_::set_widget(Php::Parameters &parameters) {
  ...
  // Pack the widget
  gtk_tree_view_column_set_widget(GTK_TREE_VIEW_COLUMN(instance),
...
void GtkTreeViewColumn_::set_sort_column_id(Php::Parameters &parameters) {
  gtk_tree_view_column_set_sort_column_id(GTK_TREE_VIEW_COLUMN(instance),
                                          parameters[0]);
}
 ...
 * button indicating the column is sorted.
 */
void GtkTreeViewColumn_::set_sort_indicator(Php::Parameters &parameters) {
  gtk_tree_view_column_set_sort_indicator(
      GTK_TREE_VIEW_COLUMN(instance),
      static_cast<gboolean>((bool)parameters[0]));
}
...
void GtkTreeViewColumn_::set_sort_order(Php::Parameters &parameters) {
  ...
  gtk_tree_view_column_set_sort_order(GTK_TREE_VIEW_COLUMN(instance),
                                      passedCasted);
}
...
Php::Value GtkTreeViewColumn_::get_tree_view() {
  // Create the gtk button
  GtkWidget *widget =
      gtk_tree_view_column_get_tree_view(GTK_TREE_VIEW_COLUMN(instance));
...
void GtkTreeViewColumn_::set_cell_data_func(Php::Parameters &parameters) {
  ...
  GtkCellRenderer_ *p_cell_renderer =
      (GtkCellRenderer_ *)o_cell_renderer.implementation();
  ...
  gtk_tree_view_column_set_cell_data_func(
      GTK_TREE_VIEW_COLUMN(instance), cell_renderer,
      set_cell_data_func_callback, (gpointer)callback_object, nullptr);
}

void GtkTreeViewColumn_::set_cell_data_func_callback(
  ...
  // (GtkTreeViewColumn,GtkCellRenderer,GtkTreeModel,GtkTreeIter,user_data)
