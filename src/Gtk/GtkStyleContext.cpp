...
void GtkStyleContext_::add_provider(Php::Parameters &parameters) {
  ...
  if (!parameters.empty()) {
    ...
    GtkCssProvider_ *phpgtk_provider =
        (GtkCssProvider_ *)object_provider.implementation();
    provider = GTK_CSS_PROVIDER(phpgtk_provider->get_instance());
  }

  guint priority = (int)parameters[1];

  gtk_style_context_add_provider(GTK_STYLE_CONTEXT(instance),
...
void GtkStyleContext_::get(Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::get not implemented - variadic "
                       "function not supported");
}

Php::Value GtkStyleContext_::get_direction() {
  GtkTextDirection ret =
      gtk_style_context_get_direction(GTK_STYLE_CONTEXT(instance));

  return ret;
}

Php::Value GtkStyleContext_::get_junction_sides() {
  GtkJunctionSides ret =
      gtk_style_context_get_junction_sides(GTK_STYLE_CONTEXT(instance));
...
Php::Value GtkStyleContext_::get_parent() {
  GtkStyleContext *ret =
      gtk_style_context_get_parent(GTK_STYLE_CONTEXT(instance));
...
Php::Value GtkStyleContext_::get_path() {
  const GtkWidgetPath *ret =
      gtk_style_context_get_path(GTK_STYLE_CONTEXT(instance));
...
void GtkStyleContext_::get_property(Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::get_property not implemented - "
                       "GValue handling not yet available");
}
...
Php::Value GtkStyleContext_::get_frame_clock() {
  throw Php::Exception("GtkStyleContext_::get_frame_clock not implemented - "
                       "GdkFrameClock class not yet available");
}
...
void GtkStyleContext_::get_style(Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::get_style not implemented - variadic "
                       "function not supported");
}

void GtkStyleContext_::get_style_property(Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::get_style_property not implemented - "
                       "GValue handling not yet available");
}

void GtkStyleContext_::get_style_valist(Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::get_style_valist not implemented - "
                       "va_list not supported");
}

void GtkStyleContext_::get_valist(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkStyleContext_::get_valist not implemented - va_list not supported");
}

Php::Value GtkStyleContext_::get_section(Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::get_section not implemented - "
                       "GtkCssSection class not yet available");
}

Php::Value GtkStyleContext_::get_color(Php::Parameters &parameters) {
  // Validate state parameter
  if (parameters.empty()) {
    throw Php::Exception("GtkStyleContext_::get_color: At least one parameter "
                         "(state) is required");
  }
  if (!parameters[0].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::get_color: First parameter (state) must be numeric");
  }
  ...
  // If a second parameter is provided, validate and update it with the color
  // value
  if (parameters.size() > 1) {
    Php::Value object_color = parameters[1];
    if (!object_color.isObject() || !object_color.instanceOf("GdkRGBA")) {
      throw Php::Exception("GtkStyleContext_::get_color: Second parameter must "
                           "be a GdkRGBA instance");
    }
...
Php::Value GtkStyleContext_::get_background_color(Php::Parameters &parameters) {
  // Validate state parameter
  if (parameters.empty()) {
    throw Php::Exception("GtkStyleContext_::get_background_color: At least one "
                         "parameter (state) is required");
  }
  if (!parameters[0].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::get_background_color: First "
                         "parameter (state) must be numeric");
  }
  ...
  gtk_style_context_get_background_color(GTK_STYLE_CONTEXT(instance), state,
                                         &color);
  ...
  if (parameters.size() > 1) {
    Php::Value object_color = parameters[1];
    if (!object_color.isObject() || !object_color.instanceOf("GdkRGBA")) {
      throw Php::Exception("GtkStyleContext_::get_background_color: Second "
                           "parameter must be a GdkRGBA instance");
    }
    GdkRGBA_ *phpgtk_color = (GdkRGBA_ *)object_color.implementation();
    phpgtk_color->set_instance(color);
  }
...
Php::Value GtkStyleContext_::get_border_color(Php::Parameters &parameters) {
  // Validate state parameter
  if (parameters.empty()) {
    throw Php::Exception("GtkStyleContext_::get_border_color: At least one "
                         "parameter (state) is required");
  }
  if (!parameters[0].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::get_border_color: First parameter "
  ...
  G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  gtk_style_context_get_border_color(GTK_STYLE_CONTEXT(instance), state,
                                     &color);
  G_GNUC_END_IGNORE_DEPRECATIONS
  ...
  if (parameters.size() > 1) {
    Php::Value object_color = parameters[1];
    if (!object_color.isObject() || !object_color.instanceOf("GdkRGBA")) {
      throw Php::Exception("GtkStyleContext_::get_border_color: Second "
                           "parameter must be a GdkRGBA instance");
    }
    GdkRGBA_ *phpgtk_color = (GdkRGBA_ *)object_color.implementation();
    phpgtk_color->set_instance(color);
...
void GtkStyleContext_::get_border(Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::get_border not implemented - "
                       "GtkBorder class not yet available");
}

void GtkStyleContext_::get_padding(Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::get_padding not implemented - "
                       "GtkBorder class not yet available");
}

void GtkStyleContext_::get_margin(Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::get_margin not implemented - "
                       "GtkBorder class not yet available");
}

Php::Value GtkStyleContext_::get_font(Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::get_font not implemented - "
                       "PangoFontDescription class not yet available");
}
...
Php::Value GtkStyleContext_::state_is_running(Php::Parameters &parameters) {
  // Validate state parameter
  if (parameters.empty()) {
    throw Php::Exception("GtkStyleContext_::state_is_running: At least one "
                         "parameter (state) is required");
  }
  if (!parameters[0].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::state_is_running: First parameter "
                         "(state) must be numeric");
  }
  ...
  if (parameters.size() > 1) {
    if (!parameters[1].isNumeric()) {
      throw Php::Exception("GtkStyleContext_::state_is_running: Second "
                           "parameter (progress) must be numeric");
    }
    progress = (gdouble)parameters[1];
  }

  G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  gboolean ret = gtk_style_context_state_is_running(GTK_STYLE_CONTEXT(instance),
                                                    state, &progress);
  G_GNUC_END_IGNORE_DEPRECATIONS
...
Php::Value GtkStyleContext_::lookup_color(Php::Parameters &parameters) {
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::lookup_color: Requires one parameter: color_name");
  }

  if (!parameters[0].isString()) {
    throw Php::Exception("GtkStyleContext_::lookup_color: First parameter "
                         "(color_name) must be a string");
  }
  ...
  gboolean ret = gtk_style_context_lookup_color(GTK_STYLE_CONTEXT(instance),
                                                color_name, &color);
...
Php::Value GtkStyleContext_::lookup_icon_set(Php::Parameters &parameters) {
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::lookup_icon_set: Requires one parameter: stock_id");
  }

  if (!parameters[0].isString()) {
    throw Php::Exception("GtkStyleContext_::lookup_icon_set: First parameter "
                         "(stock_id) must be a string");
  }
  ...
  G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  GtkIconSet *ret =
      gtk_style_context_lookup_icon_set(GTK_STYLE_CONTEXT(instance), stock_id);
  G_GNUC_END_IGNORE_DEPRECATIONS
  ...
  throw Php::Exception("GtkStyleContext_::lookup_icon_set(): GtkIconSet "
                       "wrapper not available yet");
}
...
void GtkStyleContext_::notify_state_change(Php::Parameters &parameters) {
  ...
  if (!parameters.empty() && !parameters[0].isNull()) {
    ...
    if (!object_window.isObject() || !object_window.instanceOf("GdkWindow")) {
      throw Php::Exception("GtkStyleContext_::notify_state_change(): first "
                           "argument must be a GdkWindow instance or null");
    }
  ...
  if (parameters.size() > 1 && !parameters[1].isNull()) {
    if (!parameters[1].isNumeric()) {
      throw Php::Exception("GtkStyleContext_::notify_state_change(): second "
                           "argument (region_id) must be numeric or null");
    }
  ...
  if (parameters.size() > 2) {
    if (!parameters[2].isNumeric()) {
      throw Php::Exception(
          "GtkStyleContext_::notify_state_change(): third argument (state) "
          "must be a numeric GtkStateType value");
    }
  ...
  G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  gtk_style_context_notify_state_change(GTK_STYLE_CONTEXT(instance), window,
                                        region_id, state, state_value);
  G_GNUC_END_IGNORE_DEPRECATIONS
}
...
void GtkStyleContext_::push_animatable_region(Php::Parameters &parameters) {
  ...
  G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  gtk_style_context_push_animatable_region(GTK_STYLE_CONTEXT(instance),
                                           region_id);
  G_GNUC_END_IGNORE_DEPRECATIONS
}
...
void GtkStyleContext_::scroll_animations(Php::Parameters &parameters) {
  ...
  if (!parameters.empty() && !parameters[0].isNull()) {
    Php::Value object_window = parameters[0];
    if (!object_window.isObject() || !object_window.instanceOf("GdkWindow")) {
      throw Php::Exception("GtkStyleContext_::scroll_animations first "
                           "parameter must be a GdkWindow or null");
    }
  ...
  if (parameters.size() > 1 && !parameters[1].isNull()) {
    if (!parameters[1].isNumeric()) {
      throw Php::Exception("GtkStyleContext_::scroll_animations second "
                           "parameter (dx) must be numeric");
    }
  ...
  if (parameters.size() > 2 && !parameters[2].isNull()) {
    if (!parameters[2].isNumeric()) {
      throw Php::Exception("GtkStyleContext_::scroll_animations third "
                           "parameter (dy) must be numeric");
    }
    dy = (gint)parameters[2].numericValue();
  }
  G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  gtk_style_context_scroll_animations(GTK_STYLE_CONTEXT(instance), window, dx,
                                      dy);
  G_GNUC_END_IGNORE_DEPRECATIONS
}
...
void GtkStyleContext_::remove_provider(Php::Parameters &parameters) {
  ...
  if (provider == nullptr) {
    throw Php::Exception(
        "GtkStyleContext::remove_provider requires a provider parameter");
  }
...
void GtkStyleContext_::remove_provider_for_screen(Php::Parameters &parameters) {
  ...
  if (provider == nullptr) {
    throw Php::Exception("GtkStyleContext::remove_provider_for_screen requires "
                         "a provider parameter");
  }

  GdkScreen *screen = gdk_screen_get_default();
  if (screen == nullptr) {
    throw Php::Exception("GtkStyleContext::remove_provider_for_screen: no "
...
void GtkStyleContext_::set_background(Php::Parameters &parameters) {
  ...
  if (!parameters.empty() && !parameters[0].isNull()) {
    ...
    if (!object_window.instanceOf("GdkWindow")) {
      throw Php::Exception("GtkStyleContext::set_background expects parameter "
                           "0 to be a GdkWindow instance or null");
    }

    GdkWindow_ *phpgtk_window = (GdkWindow_ *)object_window.implementation();
    if (phpgtk_window == nullptr) {
      throw Php::Exception("GtkStyleContext::set_background received an "
                           "invalid GdkWindow object");
    }
    window = GDK_WINDOW(phpgtk_window->get_instance());
  }
...
void GtkStyleContext_::set_direction(Php::Parameters &parameters) {
  if (parameters.empty()) {
    throw Php::Exception("GtkStyleContext_::set_direction expects 1 numeric "
                         "parameter (GtkTextDirection)");
  }

  if (!parameters[0].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::set_direction expects a numeric "
                         "GtkTextDirection value as the first parameter");
  }
...
void GtkStyleContext_::set_junction_sides(Php::Parameters &parameters) {
  if (parameters.empty()) {
    throw Php::Exception("GtkStyleContext_::set_junction_sides: Requires one "
                         "numeric parameter (GtkJunctionSides)");
  }

  if (!parameters[0].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::set_junction_sides: First "
                         "parameter must be a numeric GtkJunctionSides value");
  }
...
void GtkStyleContext_::set_parent(Php::Parameters &parameters) {
  ...
  if (!parameters.empty() && !parameters[0].isNull()) {
    ...
    if (!object_parent.isObject() ||
        !object_parent.instanceOf("GtkStyleContext")) {
      throw Php::Exception(
          "GtkStyleContext::set_parent expects GtkStyleContext or null");
    }
    GtkStyleContext_ *phpgtk_parent =
        (GtkStyleContext_ *)object_parent.implementation();
...
void GtkStyleContext_::set_path(Php::Parameters &parameters) {
  ...
  if (!parameters.empty() && !parameters[0].isNull()) {
    ...
    if (!object_path.isObject() || !object_path.instanceOf("GtkWidgetPath")) {
      throw Php::Exception(
          "GtkStyleContext::set_path expects GtkWidgetPath or null");
    }
    GtkWidgetPath_ *phpgtk_path =
        (GtkWidgetPath_ *)object_path.implementation();
...
Php::Value GtkStyleContext_::has_class(Php::Parameters &parameters) {
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::has_class: Requires one parameter: class_name");
  }

  if (!parameters[0].isString()) {
    throw Php::Exception("GtkStyleContext_::has_class: First parameter "
  ...
  gboolean ret =
      gtk_style_context_has_class(GTK_STYLE_CONTEXT(instance), class_name);
...
void GtkStyleContext_::add_region(Php::Parameters &parameters) {
  if (parameters.size() < 2) {
    throw Php::Exception("GtkStyleContext_::add_region: Requires two "
                         "parameters: region_name and flags");
  }

  if (!parameters[0].isString()) {
    throw Php::Exception("GtkStyleContext_::add_region: First parameter "
  ...
  if (!parameters[1].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::add_region: Second parameter "
...
void GtkStyleContext_::remove_region(Php::Parameters &parameters) {
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::remove_region: Requires one parameter: region_name");
  }

  if (!parameters[0].isString()) {
    throw Php::Exception("GtkStyleContext_::remove_region: First parameter "
                         "(region_name) must be a string");
  }
...
Php::Value GtkStyleContext_::has_region(Php::Parameters &parameters) {
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::has_region: Requires one parameter: region_name");
  }

  if (!parameters[0].isString()) {
    throw Php::Exception("GtkStyleContext_::has_region: First parameter "
                         "(region_name) must be a string");
  }
  std::string s_region_name = parameters[0];
  gchar *region_name = (gchar *)s_region_name.c_str();
  ...
  G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  gboolean ret = gtk_style_context_has_region(GTK_STYLE_CONTEXT(instance),
                                              region_name, &flags_return);
  G_GNUC_END_IGNORE_DEPRECATIONS
...
void GtkStyleContext_::set_screen(Php::Parameters &parameters) {
  ...
  if (!parameters.empty() && !parameters[0].isNull()) {
    ...
    if (!object_screen.isObject() || !object_screen.instanceOf("GdkScreen")) {
      throw Php::Exception("GtkStyleContext_::set_screen expects parameter 0 "
                           "to be a GdkScreen instance or null");
    }
...
void GtkStyleContext_::set_frame_clock(Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::set_frame_clock not implemented - "
                       "GdkFrameClock class not yet available");
}

void GtkStyleContext_::set_state(Php::Parameters &parameters) {
  if (parameters.empty()) {
    throw Php::Exception("GtkStyleContext_::set_state expects 1 numeric "
                         "parameter (GtkStateFlags)");
  }

  if (!parameters[0].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::set_state expects a numeric "
                         "GtkStateFlags value as the first parameter");
  }
...
void GtkStyleContext_::set_scale(Php::Parameters &parameters) {
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::set_scale expects 1 numeric parameter (scale)");
  }

  if (!parameters[0].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::set_scale expects a numeric scale "
  ...
  if (scale <= 0) {
    throw Php::Exception(
        "GtkStyleContext_::set_scale expects a positive scale value");
  }
...
Php::Value GtkStyleContext_::to_string(Php::Parameters &parameters) {
  ...
  if (!parameters.empty()) {
    if (!parameters[0].isNumeric()) {
      throw Php::Exception("GtkStyleContext_::to_string: First parameter "
                           "(flags) must be numeric");
    }
...
Php::Value GtkStyleContext_::gtk_border_new() {
  throw Php::Exception("GtkStyleContext_::gtk_border_new not implemented - "
                       "GtkBorder class not yet available");
}

Php::Value GtkStyleContext_::gtk_border_copy() {
  throw Php::Exception("GtkStyleContext_::gtk_border_copy not implemented - "
                       "GtkBorder class not yet available");
}

void GtkStyleContext_::gtk_border_free() {
  throw Php::Exception("GtkStyleContext_::gtk_border_free not implemented - "
                       "GtkBorder class not yet available");
}
...
void GtkStyleContext_::gtk_render_arrow(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 5) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_arrow: Requires five parameters: "
        "GdkEvent (cairo context), angle, x, y, size");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_arrow: First parameter "
                         "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() ||
      !parameters[3].isNumeric() || !parameters[4].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_arrow: Parameters 2-5 "
                         "(angle, x, y, size) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_arrow: Invalid cairo context");
  }
...
void GtkStyleContext_::gtk_render_background(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 5) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_background: Requires five parameters: "
        "GdkEvent (cairo context), x, y, width, height");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_background: First "
                         "parameter must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() ||
      !parameters[3].isNumeric() || !parameters[4].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_background: Parameters "
                         "2-5 (x, y, width, height) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_background: Invalid cairo context");
  }
...
void GtkStyleContext_::gtk_render_background_get_clip(
    Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::gtk_render_background_get_clip not "
                       "implemented - GdkRectangle handling not yet available");
}
...
void GtkStyleContext_::gtk_render_check(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 5) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_check: Requires five parameters: "
        "GdkEvent (cairo context), x, y, width, height");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_check: First parameter "
                         "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() ||
      !parameters[3].isNumeric() || !parameters[4].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_check: Parameters 2-5 "
                         "(x, y, width, height) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_check: Invalid cairo context");
  }
...
void GtkStyleContext_::gtk_render_expander(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 5) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_expander: Requires five parameters: "
        "GdkEvent (cairo context), x, y, width, height");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_expander: First "
                         "parameter must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() ||
      !parameters[3].isNumeric() || !parameters[4].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_expander: Parameters "
                         "2-5 (x, y, width, height) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_expander: Invalid cairo context");
  }
...
void GtkStyleContext_::gtk_render_extension(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 6) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_extension: Requires six parameters: "
        "GdkEvent (cairo context), x, y, width, height, gap_side");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_extension: First "
                         "parameter must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() ||
      !parameters[3].isNumeric() || !parameters[4].isNumeric() ||
      !parameters[5].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_extension: Parameters "
                         "2-6 (x, y, width, height, gap_side) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_extension: Invalid cairo context");
  }
  ...
  ::gtk_render_extension(GTK_STYLE_CONTEXT(instance), cr, x, y, width, height,
                         gap_side);
}
...
void GtkStyleContext_::gtk_render_focus(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 5) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_focus: Requires five parameters: "
        "GdkEvent (cairo context), x, y, width, height");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_focus: First parameter "
                         "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() ||
      !parameters[3].isNumeric() || !parameters[4].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_focus: Parameters 2-5 "
                         "(x, y, width, height) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_focus: Invalid cairo context");
  }
...
void GtkStyleContext_::gtk_render_frame(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 5) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_frame: Requires five parameters: "
        "GdkEvent (cairo context), x, y, width, height");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_frame: First parameter "
                         "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() ||
      !parameters[3].isNumeric() || !parameters[4].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_frame: Parameters 2-5 "
                         "(x, y, width, height) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_frame: Invalid cairo context");
  }
...
void GtkStyleContext_::gtk_render_frame_gap(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 8) {
    throw Php::Exception("GtkStyleContext_::gtk_render_frame_gap: Requires "
                         "eight parameters: GdkEvent (cairo context), x, y, "
                         "width, height, gap_side, xy0_gap, xy1_gap");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_frame_gap: First "
                         "parameter must be a GdkEvent (cairo context)");
  }
  // Validate parameters 1-7 (user parameters 2-8) are numeric
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() ||
      !parameters[3].isNumeric() || !parameters[4].isNumeric() ||
      !parameters[5].isNumeric() || !parameters[6].isNumeric() ||
      !parameters[7].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_frame_gap: Parameters 2-8 (x, y, width, "
        "height, gap_side, xy0_gap, xy1_gap) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_frame_gap: Invalid cairo context");
  }
  ...
  ::gtk_render_frame_gap(GTK_STYLE_CONTEXT(instance), cr, x, y, width, height,
...
void GtkStyleContext_::gtk_render_handle(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 5) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_handle: Requires five parameters: "
        "GdkEvent (cairo context), x, y, width, height");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_handle: First parameter "
                         "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() ||
      !parameters[3].isNumeric() || !parameters[4].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_handle: Parameters 2-5 "
                         "(x, y, width, height) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_handle: Invalid cairo context");
  }
...
void GtkStyleContext_::gtk_render_layout(Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::gtk_render_layout not implemented - "
                       "Cairo/Pango support not yet available");
}
...
void GtkStyleContext_::gtk_render_line(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 5) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_line: Requires five parameters: GdkEvent "
        "(cairo context), x0, y0, x1, y1");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_line: First parameter "
                         "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() ||
      !parameters[3].isNumeric() || !parameters[4].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_line: Parameters 2-5 "
                         "(x0, y0, x1, y1) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_line: Invalid cairo context");
  }
...
void GtkStyleContext_::gtk_render_option(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 5) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_option: Requires five parameters: "
        "GdkEvent (cairo context), x, y, width, height");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_option: First parameter "
                         "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() ||
      !parameters[3].isNumeric() || !parameters[4].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_option: Parameters 2-5 "
                         "(x, y, width, height) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_option: Invalid cairo context");
  }
...
void GtkStyleContext_::gtk_render_slider(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 6) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_slider: Requires six parameters: "
        "GdkEvent (cairo context), x, y, width, height, orientation");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_slider: First parameter "
                         "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() ||
      !parameters[3].isNumeric() || !parameters[4].isNumeric() ||
      !parameters[5].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_slider: Parameters 2-6 "
                         "(x, y, width, height, orientation) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_slider: Invalid cairo context");
  }
  ...
  ::gtk_render_slider(GTK_STYLE_CONTEXT(instance), cr, x, y, width, height,
                      orientation);
}
...
void GtkStyleContext_::gtk_render_activity(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 5) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_activity: Requires five parameters: "
        "GdkEvent (cairo context), x, y, width, height");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_activity: First "
                         "parameter must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() ||
      !parameters[3].isNumeric() || !parameters[4].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_activity: Parameters "
                         "2-5 (x, y, width, height) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_activity: Invalid cairo context");
  }
...
Php::Value
GtkStyleContext_::gtk_render_icon_pixbuf(Php::Parameters &parameters) {
  // Note: This function is deprecated since GTK 3.10
  // GtkIconSource parameter - we'll accept nullptr for now since GtkIconSource
  // is also deprecated The full implementation would require a GtkIconSource
  // wrapper
  ...
  //   ignore the first (conceptual `source`) until a GtkIconSource wrapper
  //   exists
  if (parameters.empty()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_icon_pixbuf: At least a "
  ...
  if (!parameters[size_index].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_icon_pixbuf: size "
                         "parameter must be numeric");
  }

  int int_size = (int)parameters[size_index];

  // Basic validation: reject the explicit invalid sentinel, allow custom
  // registered sizes
  if (int_size == GTK_ICON_SIZE_INVALID) {
    throw Php::Exception("GtkStyleContext_::gtk_render_icon_pixbuf: size "
                         "parameter must not be GTK_ICON_SIZE_INVALID");
  }
  ...
  G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  GdkPixbuf *ret =
      ::gtk_render_icon_pixbuf(GTK_STYLE_CONTEXT(instance), source, size);
  G_GNUC_END_IGNORE_DEPRECATIONS
...
void GtkStyleContext_::gtk_render_icon_surface(Php::Parameters &parameters) {
  ...
  if (parameters.empty() || !parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_icon_surface: First "
                         "parameter must be a GdkEvent (cairo context)");
  }
  GdkEvent_ *phpgtk_event = (GdkEvent_ *)parameters[0].implementation();
  cairo_t *cr = (cairo_t *)phpgtk_event->instance;
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_icon_surface: Invalid cairo context");
  }
  ...
  throw Php::Exception(
      "GtkStyleContext_::gtk_render_icon_surface not implemented - "
      "cairo_surface_t wrapper not yet available");
}
...
void GtkStyleContext_::gtk_render_icon(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 4) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_icon: Requires four parameters: GdkEvent "
        "(cairo context), GdkPixbuf, x, y");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_icon: First parameter "
                         "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].instanceOf("GdkPixbuf")) {
    throw Php::Exception("GtkStyleContext_::gtk_render_icon: Second parameter "
                         "must be a GdkPixbuf");
  }
  if (!parameters[2].isNumeric() || !parameters[3].isNumeric()) {
    throw Php::Exception("GtkStyleContext_::gtk_render_icon: Third and fourth "
                         "parameters (x, y) must be numeric");
  }
  ...
  if (cr == nullptr) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_icon: Invalid cairo context");
  }
...
void GtkStyleContext_::gtk_render_insertion_cursor(
    Php::Parameters &parameters) {
  throw Php::Exception("GtkStyleContext_::gtk_render_insertion_cursor not "
                       "implemented - Cairo/Pango support not yet available");
}
