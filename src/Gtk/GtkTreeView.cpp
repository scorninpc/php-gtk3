...
void GtkTreeView_::__construct(Php::Parameters &parameters) {
  ...
  //     if (!object.instanceOf("GtkTreeModel")) throw Php::Exception("parameter
  //     expect GtkTreeModel instance"); GtkTreeModel_ *passedModel =
  //     (GtkTreeModel_ *)object.implementation();

  //  gtk_tree_view_set_model(GTK_TREE_VIEW(widget),
  //  GTK_TREE_MODEL(passedModel.get_model()));
...
Php::Value GtkTreeView_::append_column(Php::Parameters &parameters) {
  ...
  GtkTreeViewColumn_ *passedColumn =
      (GtkTreeViewColumn_ *)object.implementation();

  //
  return gtk_tree_view_append_column(
      GTK_TREE_VIEW(instance),
      GTK_TREE_VIEW_COLUMN(passedColumn->get_instance()));
}
...
Php::Value GtkTreeView_::expand_row(Php::Parameters &parameters) {
  ...
  //
  bool ret = gtk_tree_view_expand_row(GTK_TREE_VIEW(instance), path,
                                      static_cast<gboolean>(open_all)) != 0;
...
Php::Value GtkTreeView_::row_expanded(Php::Parameters &parameters) {
  ...
  //
  bool ret = gtk_tree_view_row_expanded(GTK_TREE_VIEW(instance), path) != 0;
...
Php::Value GtkTreeView_::collapse_row(Php::Parameters &parameters) {
  ...
  //
  bool ret = gtk_tree_view_collapse_row(GTK_TREE_VIEW(instance), path) != 0;
...
void GtkTreeView_::set_show_expanders(Php::Parameters &parameters) {
  ...
  gtk_tree_view_set_show_expanders(GTK_TREE_VIEW(instance),
...
void GtkTreeView_::set_enable_tree_lines(Php::Parameters &parameters) {
  ...
  gtk_tree_view_set_enable_tree_lines(GTK_TREE_VIEW(instance),
                                      static_cast<gboolean>(enabled));
}
...
void GtkTreeView_::set_reorderable(Php::Parameters &parameters) {
  ...
  gtk_tree_view_set_reorderable(GTK_TREE_VIEW(instance),
                                static_cast<gboolean>(enabled));
}
...
void GtkTreeView_::set_enable_search(Php::Parameters &parameters) {
  ...
  gtk_tree_view_set_enable_search(GTK_TREE_VIEW(instance),
                                  static_cast<gboolean>(enabled));
}
...
void GtkTreeView_::set_fixed_height_mode(Php::Parameters &parameters) {
  ...
  gtk_tree_view_set_fixed_height_mode(GTK_TREE_VIEW(instance),
                                      static_cast<gboolean>(enabled));
}
...
void GtkTreeView_::set_headers_visible(Php::Parameters &parameters) {
  ...
  gtk_tree_view_set_headers_visible(GTK_TREE_VIEW(instance),
                                    static_cast<gboolean>(enabled));
}

void GtkTreeView_::select_all() {
  gtk_tree_selection_select_all(
      gtk_tree_view_get_selection(GTK_TREE_VIEW(instance)));
}
...
void GtkTreeView_::scroll_to_cell(Php::Parameters &parameters) {
  ...
  gtk_tree_view_scroll_to_cell(GTK_TREE_VIEW(instance), path, nullptr, FALSE, 0,
                               0);
}
...
Php::Value GtkTreeView_::get_columns() {
  ...
  for (int index = 0; GList *item != nullptr = g_list_nth(ret, index);
       index++) {
...
Php::Value GtkTreeView_::get_column(Php::Parameters &parameters) {
  ...
  GtkTreeViewColumn *ret =
      gtk_tree_view_get_column(GTK_TREE_VIEW(instance), number_column);
...
void GtkTreeView_::move_column_after(Php::Parameters &parameters) {
  ...
  GtkTreeViewColumn_ *baseColumn =
      (GtkTreeViewColumn_ *)phpBaseColumn.implementation();

  gtk_tree_view_move_column_after(
      GTK_TREE_VIEW(instance), GTK_TREE_VIEW_COLUMN(column->get_instance()),
      GTK_TREE_VIEW_COLUMN(baseColumn->get_instance()));
}
...
Php::Value GtkTreeView_::get_path_at_pos(Php::Parameters &parameters) {
  ...
  bool ret = gtk_tree_view_get_path_at_pos(GTK_TREE_VIEW(instance), x, y, &path,
                                           &column, &cell_x, &cell_y) != 0;
...
Php::Value GtkTreeView_::get_bin_window() {
  gpointer *ret =
      (gpointer *)gtk_tree_view_get_bin_window(GTK_TREE_VIEW(instance));
...
Php::Value
GtkTreeView_::convert_widget_to_bin_window_coords(Php::Parameters &parameters) {
  ...
  gtk_tree_view_convert_widget_to_bin_window_coords(
      GTK_TREE_VIEW(instance), widget_x, widget_y, &bin_x, &bin_y);
...
Php::Value
GtkTreeView_::convert_widget_to_tree_coords(Php::Parameters &parameters) {
  if (parameters.size() < 2) {
    throw Php::Exception("Expected two parameters: widget_x, widget_y");
  }
  ...
  gtk_tree_view_convert_widget_to_tree_coords(GTK_TREE_VIEW(instance), widget_x,
                                              widget_y, &tree_x, &tree_y);
...
Php::Value
GtkTreeView_::convert_tree_to_widget_coords(Php::Parameters &parameters) {
  if (parameters.size() < 2) {
  ...
  gtk_tree_view_convert_tree_to_widget_coords(GTK_TREE_VIEW(instance), tree_x,
                                              tree_y, &widget_x, &widget_y);
...
Php::Value
GtkTreeView_::convert_tree_to_bin_window_coords(Php::Parameters &parameters) {
  if (parameters.size() < 2) {
    throw Php::Exception("Expected two parameters: tree_x, tree_y");
  }
  ...
  gtk_tree_view_convert_tree_to_bin_window_coords(
      GTK_TREE_VIEW(instance), tree_x, tree_y, &bin_x, &bin_y);
...
Php::Value
GtkTreeView_::convert_bin_window_to_widget_coords(Php::Parameters &parameters) {
  if (parameters.size() < 2) {
  ...
  gtk_tree_view_convert_bin_window_to_widget_coords(
      GTK_TREE_VIEW(instance), bin_x, bin_y, &widget_x, &widget_y);
...
Php::Value
GtkTreeView_::convert_bin_window_to_tree_coords(Php::Parameters &parameters) {
  if (parameters.size() < 2) {
    throw Php::Exception("Expected two parameters: bin_x, bin_y");
  }
  ...
  gtk_tree_view_convert_bin_window_to_tree_coords(
      GTK_TREE_VIEW(instance), bin_x, bin_y, &tree_x, &tree_y);
