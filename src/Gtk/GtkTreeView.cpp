...
void GtkTreeView_::__construct(Php::Parameters &parameters) {
  ...
  //     if (!object.instanceOf("GtkTreeModel")) throw Php::Exception("parameter expect GtkTreeModel
  //     instance"); GtkTreeModel_ *passedModel = (GtkTreeModel_ *)object.implementation();
...
Php::Value GtkTreeView_::append_column(Php::Parameters &parameters) {
  ...
  //
  return gtk_tree_view_append_column(GTK_TREE_VIEW(instance),
...
void GtkTreeView_::move_column_after(Php::Parameters &parameters) {
  ...
  gtk_tree_view_move_column_after(GTK_TREE_VIEW(instance),
                                  GTK_TREE_VIEW_COLUMN(column->get_instance()),
...
Php::Value GtkTreeView_::convert_widget_to_bin_window_coords(Php::Parameters &parameters) {
  ...
  gtk_tree_view_convert_widget_to_bin_window_coords(GTK_TREE_VIEW(instance), widget_x, widget_y,
                                                    &bin_x, &bin_y);
