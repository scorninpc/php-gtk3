...
Php::Value GtkCssProvider_::load_from_data(Php::Parameters &parameters) {
  ...
  bool ret = gtk_css_provider_load_from_data(GTK_CSS_PROVIDER(instance), data,
                                             length, &error) != 0;
...
Php::Value GtkCssProvider_::load_from_file(Php::Parameters &parameters) {
  ...
  bool ret = gtk_css_provider_load_from_file(GTK_CSS_PROVIDER(instance), file,
                                             &error) != 0;
...
Php::Value GtkCssProvider_::load_from_path(Php::Parameters &parameters) {
  ...
  bool ret = gtk_css_provider_load_from_path(GTK_CSS_PROVIDER(instance), path,
                                             &error) != 0;
...
void GtkCssProvider_::load_from_resource(Php::Parameters &parameters) {
  ...
  gtk_css_provider_load_from_resource(GTK_CSS_PROVIDER(instance),
                                      resource_path);
}
...
Php::Value GtkCssProvider_::gtk_css_section_get_end_line() {
  ...
  // return ret;
  throw Php::Exception(
      "GtkCssProvider_::gtk_css_section_get_end_line not implemented");
  return 1;
}
...
Php::Value GtkCssProvider_::gtk_css_section_get_end_position() {
  ...
  // return ret;
  throw Php::Exception(
      "GtkCssProvider_::gtk_css_section_get_end_position not implemented");
  return 1;
}
...
Php::Value GtkCssProvider_::gtk_css_section_get_file() {
  ...
  // return ret;
  throw Php::Exception(
      "GtkCssProvider_::gtk_css_section_get_file not implemented");
  return 1;
}

Php::Value GtkCssProvider_::gtk_css_section_get_parent() {
  // GtkCssSection *ret = gtk_css_section_get_parent
  // (GTK_CSS_PROVIDER(instance));
  ...
  throw Php::Exception(
      "GtkCssProvider_::gtk_css_section_get_parent not implemented");
  return 1;
}

Php::Value GtkCssProvider_::gtk_css_section_get_section_type() {
  // GtkCssSectionType ret = gtk_css_section_get_section_type
  // (GTK_CSS_PROVIDER(instance));

  // return ret;
  throw Php::Exception(
      "GtkCssProvider_::gtk_css_section_get_section_type not implemented");
  return 1;
}
...
Php::Value GtkCssProvider_::gtk_css_section_get_start_line() {
  ...
  throw Php::Exception(
      "GtkCssProvider_::gtk_css_section_get_start_line not implemented");
  return 1;
}
...
Php::Value GtkCssProvider_::gtk_css_section_get_start_position() {
  ...
  throw Php::Exception(
      "GtkCssProvider_::gtk_css_section_get_start_position not implemented");
  return 1;
}
...
void GtkCssProvider_::gtk_css_section_unref() {
  ...
  throw Php::Exception(
      "GtkCssProvider_::gtk_css_section_unref not implemented");
}
