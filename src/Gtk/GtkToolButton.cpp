...
Php::Value GtkToolButton_::get_use_underline() {
  bool ret = gtk_tool_button_get_use_underline(GTK_TOOL_BUTTON(instance)) != 0;
...
void GtkToolButton_::set_icon_widget(Php::Parameters &parameters) {
  ...
  if (!parameters.empty()) {
    ...
    GtkWidget_ *phpgtk_icon_widget =
        (GtkWidget_ *)object_icon_widget.implementation();
...
Php::Value GtkToolButton_::get_icon_widget() {
  gpointer *ret =
      (gpointer *)gtk_tool_button_get_icon_widget(GTK_TOOL_BUTTON(instance));
...
Php::Value GtkToolButton_::get_label_widget() {
  gpointer *ret =
      (gpointer *)gtk_tool_button_get_label_widget(GTK_TOOL_BUTTON(instance));
