...
Php::Value GladePalette_::get_item_appearance() {
  ...
  // GladeItemAppearance ret = glade_palette_get_item_appearance
  // (GLADE_PALETTE(instance));
...
void GladePalette_::set_item_appearance(Php::Parameters &parameters) {
  ...
  // GladeItemAppearance item_appearence =
  // (GladeItemAppearance)int_item_appearence;

  // glade_palette_set_item_appearance (GLADE_PALETTE(instance),
  // item_appearence);
}
...
void GladePalette_::set_use_small_item_icons(Php::Parameters &parameters) {
  ...
  glade_palette_set_use_small_item_icons(GLADE_PALETTE(instance),
...
void GladePalette_::set_show_selector_button(Php::Parameters &parameters) {
  ...
  glade_palette_set_show_selector_button(GLADE_PALETTE(instance),
