...
Php::Value GApplication_::get_application_id() {
  // 	std::string ret = g_application_get_application_id
...
void GApplication_::set_application_id(Php::Parameters &parameters) {
  ...
  // 	g_application_set_application_id (G_APPLICATION(instance),
  // application_id);
...
Php::Value GApplication_::get_inactivity_timeout() {
  // 	int ret = g_application_get_inactivity_timeout
  // (G_APPLICATION(instance));
...
void GApplication_::set_inactivity_timeout(Php::Parameters &parameters) {
  ...
  // 	g_application_set_inactivity_timeout (G_APPLICATION(instance),
  // inactivity_timeout);
...
Php::Value GApplication_::get_flags() {
  // 	GApplicationFlags ret = g_application_get_flags
  // (G_APPLICATION(instance));
...
Php::Value GApplication_::get_resource_base_path() {
  // 	std::string ret = g_application_get_resource_base_path
  // (G_APPLICATION(instance));
...
void GApplication_::set_resource_base_path(Php::Parameters &parameters) {
  ...
  // 	g_application_set_resource_base_path (G_APPLICATION(instance),
  // resource_path);
...
Php::Value GApplication_::get_dbus_connection() {
  // 	GDBusConnection ret = g_application_get_dbus_connection
  // (G_APPLICATION(instance));
...
Php::Value GApplication_::get_dbus_object_path() {
  // 	std::string ret = g_application_get_dbus_object_path
  // (G_APPLICATION(instance));
...
Php::Value GApplication_::get_is_registered() {
  // 	gboolean ret = g_application_get_is_registered
  // (G_APPLICATION(instance));
...
Php::Value GApplication_::_register(Php::Parameters &parameters) {
  //
  //
  // 	gboolean ret = g_application_register (G_APPLICATION(instance),
  // cancellable, error);
...
void GApplication_::send_notification(Php::Parameters &parameters) {
  ...
  //
  // 	g_application_send_notification (G_APPLICATION(instance), id,
  // notification);
...
Php::Value GApplication_::run(Php::Parameters &parameters) {
  ...
  if (!parameters.empty()) {
    ...
    GtkApplication_ *phpgtk_app =
        (GtkApplication_ *)object_app.implementation();
...
void GApplication_::add_main_option_entries(Php::Parameters &parameters) {
  //
  // 	g_application_add_main_option_entries (G_APPLICATION(instance),
  // entries);

  throw Php::Exception(
      "GApplication_::add_main_option_entries not implemented");
}
...
void GApplication_::add_main_option(Php::Parameters &parameters) {
  ...
  //
  //
  // 	g_application_add_main_option (G_APPLICATION(instance), long_name,
  // short_name, flags, arg, description, arg_description);
...
void GApplication_::set_option_context_parameter_string(
  ...
  // (G_APPLICATION(instance), parameter_string);

  throw Php::Exception(
      "GApplication_::set_option_context_parameter_string not implemented");
}
...
void GApplication_::set_option_context_summary(Php::Parameters &parameters) {
  ...
  // 	g_application_set_option_context_summary (G_APPLICATION(instance),
  // summary);

  throw Php::Exception(
      "GApplication_::set_option_context_summary not implemented");
}

void GApplication_::set_option_context_description(
    Php::Parameters &parameters) {
  // // 	std::string s_description = parameters[0];
  // 	gchardescription = (gchar)s_description.c_str();

  // 	g_application_set_option_context_description (G_APPLICATION(instance),
  // description);

  throw Php::Exception(
      "GApplication_::set_option_context_description not implemented");
}
...
void GApplication_::bind_busy_property(Php::Parameters &parameters) {
  ...
  // 	g_application_bind_busy_property (G_APPLICATION(instance), object,
  // property);
...
void GApplication_::unbind_busy_property(Php::Parameters &parameters) {
  ...
  // 	g_application_unbind_busy_property (G_APPLICATION(instance), object,
  // property);
