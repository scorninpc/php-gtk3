...
void GtkSourceView_::set_mark_attributes(Php::Parameters &parameters) {
  ...
  // 		GtkSourceMarkAttributes_ *phpgtk_attributes = (GtkSourceMarkAttributes_
  // *)object_attributes.implementation(); 		attributes =
  // GTK_WIDGET(phpgtk_attributes->get_instance());
  // 	}

  // // 	gint priority = (gint)parameters[2];

  // 	gtk_source_view_set_mark_attributes (GTK_SOURCE_VIEW(instance), category, attributes,
  // priority);
