...
Php::Value GtkSourceView_::new_with_buffer(Php::Parameters &parameters) {
  GtkSourceBuffer *buffer = nullptr;
  if (!parameters.empty()) {
    Php::Value object_buffer = parameters[0];
    GtkSourceBuffer_ *phpgtk_buffer =
        (GtkSourceBuffer_ *)object_buffer.implementation();
...
Php::Value GtkSourceView_::get_show_line_numbers() {
  bool ret =
      gtk_source_view_get_show_line_numbers(GTK_SOURCE_VIEW(instance)) != 0;
...
Php::Value GtkSourceView_::get_show_right_margin() {
  bool ret =
      gtk_source_view_get_show_right_margin(GTK_SOURCE_VIEW(instance)) != 0;
...
Php::Value GtkSourceView_::get_right_margin_position() {
  int ret =
      gtk_source_view_get_right_margin_position(GTK_SOURCE_VIEW(instance));
...
void GtkSourceView_::set_highlight_current_line(Php::Parameters &parameters) {
  ...
  gtk_source_view_set_highlight_current_line(GTK_SOURCE_VIEW(instance),
                                             highlight);
}

Php::Value GtkSourceView_::get_highlight_current_line() {
  bool ret = gtk_source_view_get_highlight_current_line(
                 GTK_SOURCE_VIEW(instance)) != 0;
...
Php::Value GtkSourceView_::get_auto_indent() {
  bool ret = gtk_source_view_get_auto_indent(GTK_SOURCE_VIEW(instance)) != 0;
...
Php::Value GtkSourceView_::get_indent_on_tab() {
  bool ret = gtk_source_view_get_indent_on_tab(GTK_SOURCE_VIEW(instance)) != 0;
...
void GtkSourceView_::set_insert_spaces_instead_of_tabs(
    Php::Parameters &parameters) {
  gboolean enable = (gboolean)parameters[0];

  gtk_source_view_set_insert_spaces_instead_of_tabs(GTK_SOURCE_VIEW(instance),
                                                    enable);
}

Php::Value GtkSourceView_::get_insert_spaces_instead_of_tabs() {
  bool ret = gtk_source_view_get_insert_spaces_instead_of_tabs(
                 GTK_SOURCE_VIEW(instance)) != 0;
...
void GtkSourceView_::set_smart_backspace(Php::Parameters &parameters) {
  ...
  gtk_source_view_set_smart_backspace(GTK_SOURCE_VIEW(instance),
                                      smart_backspace);
}

Php::Value GtkSourceView_::get_smart_backspace() {
  bool ret =
      gtk_source_view_get_smart_backspace(GTK_SOURCE_VIEW(instance)) != 0;
...
void GtkSourceView_::set_smart_home_end(Php::Parameters &parameters) {
  ...
  GtkSourceSmartHomeEndType smart_home_end =
      (GtkSourceSmartHomeEndType)int_smart_home_end;

  gtk_source_view_set_smart_home_end(GTK_SOURCE_VIEW(instance), smart_home_end);
}

Php::Value GtkSourceView_::get_smart_home_end() {
  GtkSourceSmartHomeEndType ret =
      gtk_source_view_get_smart_home_end(GTK_SOURCE_VIEW(instance));
...
void GtkSourceView_::set_mark_attributes(Php::Parameters &parameters) {
  ...
  // 		GtkSourceMarkAttributes_ *phpgtk_attributes =
  // (GtkSourceMarkAttributes_ *)object_attributes.implementation(); 		attributes
  // = GTK_WIDGET(phpgtk_attributes->get_instance());
  // 	}

  // // 	gint priority = (gint)parameters[2];

  // 	gtk_source_view_set_mark_attributes (GTK_SOURCE_VIEW(instance),
  // category, attributes, priority);
...
Php::Value GtkSourceView_::get_mark_attributes(Php::Parameters &parameters) {
  ...
  // 	GtkSourceMarkAttributes *ret = gtk_source_view_get_mark_attributes
  // (GTK_SOURCE_VIEW(instance), category, priority);

  // 	GtkSourceMarkAttributes_ *return_parsed = new
  // GtkSourceMarkAttributes_(); 	return_parsed->set_instance((gpointer *)ret);
...
Php::Value GtkSourceView_::get_show_line_marks() {
  bool ret =
      gtk_source_view_get_show_line_marks(GTK_SOURCE_VIEW(instance)) != 0;
...
Php::Value GtkSourceView_::get_draw_spaces() {
  // GtkSourceDrawSpacesFlags ret = gtk_source_view_get_draw_spaces
  // (GTK_SOURCE_VIEW(instance));
...
Php::Value GtkSourceView_::get_completion() {
  // 	GtkSourceCompletion *ret = gtk_source_view_get_completion
  // (GTK_SOURCE_VIEW(instance));
...
Php::Value GtkSourceView_::get_gutter(Php::Parameters &parameters) {
  ...
  // 	GtkSourceGutter *ret = gtk_source_view_get_gutter
  // (GTK_SOURCE_VIEW(instance), window_type);
...
void GtkSourceView_::set_background_pattern(Php::Parameters &parameters) {
  ...
  GtkSourceBackgroundPatternType background_pattern =
      (GtkSourceBackgroundPatternType)int_background_pattern;

  gtk_source_view_set_background_pattern(GTK_SOURCE_VIEW(instance),
                                         background_pattern);
}

Php::Value GtkSourceView_::get_background_pattern() {
  GtkSourceBackgroundPatternType ret =
      gtk_source_view_get_background_pattern(GTK_SOURCE_VIEW(instance));
