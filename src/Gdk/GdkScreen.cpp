 ...
 */
GdkScreen *GdkScreen_::get_instance() const { return instance; }

/**
 * Set the original GdkScreen
 */
void GdkScreen_::set_instance(GdkScreen *screen) { instance = screen; }

/**
 * https://developer.gnome.org/gdk3/stable/GdkScreen.html#gdk-screen-get-rgba-visual
 */
Php::Value GdkScreen_::get_rgba_visual() const {
 ...
 */
Php::Value GdkScreen_::get_window_stack() const {
