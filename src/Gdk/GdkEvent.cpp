...
//
GdkEvent *GdkEvent_::get_instance() const { return instance; }
...
//
void GdkEvent_::set_instance(GdkEvent *event) { instance = event; }
...
void GdkEvent_::populate(GdkEvent *event) {
  ...
  if (event->type == GDK_BUTTON_PRESS || event->type == GDK_BUTTON_RELEASE ||
      ...
      event->type == GDK_PAD_BUTTON_PRESS ||
  ...
  if (event->type == GDK_ENTER_NOTIFY || event->type == GDK_LEAVE_NOTIFY) {
    ...
    Php::Value gdkeventcrossing =
        Php::Object("GdkEventCrossing", eventcrossing_);
  ...
  if (event->type == GDK_CONFIGURE) {
    ...
    Php::Value gdkeventconfigure =
        Php::Object("GdkEventConfigure", eventconfigure_);
