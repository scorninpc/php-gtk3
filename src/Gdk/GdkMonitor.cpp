 ...
 */
GdkMonitor *GdkMonitor_::get_instance() const { return instance; }

/**
 * Set the original GdkMonitor
 */
void GdkMonitor_::set_instance(GdkMonitor *monitor) { instance = monitor; }

/**
 * https://developer.gnome.org/gdk3/stable/GdkMonitor.html#gdk-monitor-get-width-mm
 */
Php::Value GdkMonitor_::get_width_mm() const {
 ...
 */
Php::Value GdkMonitor_::get_height_mm() const {
 ...
 */
Php::Value GdkMonitor_::get_workarea() const {
...
Php::Value GdkMonitor_::get_geometry() const {
  GdkRectangle rect;
