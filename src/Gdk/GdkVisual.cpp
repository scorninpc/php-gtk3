...
Php::Value GdkVisual_::get_blue_pixel_details(Php::Parameters &parameters) {
  ...
  gdk_visual_get_blue_pixel_details(GDK_VISUAL(instance), &mask, &shift,
                                    &precision);
...
Php::Value GdkVisual_::get_green_pixel_details(Php::Parameters &parameters) {
  ...
  gdk_visual_get_green_pixel_details(GDK_VISUAL(instance), &mask, &shift,
                                     &precision);
...
Php::Value GdkVisual_::get_red_pixel_details(Php::Parameters &parameters) {
  ...
  gdk_visual_get_red_pixel_details(GDK_VISUAL(instance), &mask, &shift,
                                   &precision);
