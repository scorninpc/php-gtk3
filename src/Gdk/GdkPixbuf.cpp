 ...
 */
GdkPixbuf *GdkPixbuf_::get_instance() const { return instance; }
...
Php::Value GdkPixbuf_::new_from_file_at_size(Php::Parameters &parameters) {
  ...
  // Create pixbuff
  GdkPixbuf *l_pixbuf = gdk_pixbuf_new_from_file_at_size(
      filename.c_str(), width, height, nullptr);
...
Php::Value GdkPixbuf_::new_from_file_at_scale(Php::Parameters &parameters) {
  ...
  // Create pixbuff
  GdkPixbuf *l_pixbuf = gdk_pixbuf_new_from_file_at_scale(
      filename.c_str(), width, height, preserve_aspect_ratio, nullptr);
...
void GdkPixbuf_::set_data(Php::Parameters &parameters) const {
  ...
  // Store the duplicated string in the GObject, with g_free as the destroy
  // notifier
  g_object_set_data_full(G_OBJECT(instance), key, value, (GDestroyNotify)free);
}

Php::Value GdkPixbuf_::get_data(Php::Parameters &parameters) const {
  std::string s_key = parameters[0];
  gchar *key = (gchar *)s_key.c_str();
...
Php::Value GdkPixbuf_::get_byte_length() const {
...
Php::Value GdkPixbuf_::get_file_info(Php::Parameters &parameters) {
  ...
  //    GdkPixbufFormat *format = gdk_pixbuf_get_file_info(filename.c_str(),
  //    &width, &height);
...
Php::Value GdkPixbuf_::get_colorspace() const {
  return gdk_pixbuf_get_colorspace(instance);
}

Php::Value GdkPixbuf_::get_n_channels() const {
  return gdk_pixbuf_get_n_channels(instance);
}

Php::Value GdkPixbuf_::get_has_alpha() const {
  return (bool)gdk_pixbuf_get_has_alpha(instance);
}

Php::Value GdkPixbuf_::get_pixels() const {
  gpointer *ret = (gpointer *)gdk_pixbuf_get_pixels(instance);
  return cobject_to_phpobject(ret);
}

Php::Value GdkPixbuf_::get_width() const {
  return gdk_pixbuf_get_width(instance);
}

Php::Value GdkPixbuf_::get_height() const {
  return gdk_pixbuf_get_height(instance);
}

Php::Value GdkPixbuf_::get_rowstride() const {
  return gdk_pixbuf_get_rowstride(instance);
}

Php::Value GdkPixbuf_::get_option(Php::Parameters &parameters) const {
  std::string option = parameters[0];

  return gdk_pixbuf_get_option(instance, option.c_str());
}

Php::Value GdkPixbuf_::save(Php::Parameters &parameters) const {
  std::string filename = parameters[0];
  std::string type = parameters[1];

  bool ret = gdk_pixbuf_save(instance, filename.c_str(), type.c_str(), nullptr,
                             NULL) != 0;
...
Php::Value GdkPixbuf_::get_from_drawable(Php::Parameters &parameters) {
  ...
  // GdkWindow_ *phpgtk_drawable = (GdkWindow_
  // *)object_drawable.implementation(); drawable =
  // GDK_WINDOW(phpgtk_drawable->get_instance());
  ...
  // screenshot = gdk_pixbuf_get_from_drawable (NULL, drawable, NULL, source_x,
  // source_y, dest_x, dest_y, width, height);
 ...
 */
Php::Value GdkPixbuf_::scale_simple(Php::Parameters &parameters) const {
  ...
  // Scale
  GdkPixbuf *l_pixbuf =
      gdk_pixbuf_scale_simple(GDK_PIXBUF(instance), width, height, type);
