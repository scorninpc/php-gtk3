 ...
 */
GdkDisplay *GdkDisplay_::get_instance() const { return instance; }

/**
 * Set the original GdkDisplay
 */
void GdkDisplay_::set_instance(GdkDisplay *screen) { instance = screen; }
 ...
 */
Php::Value GdkDisplay_::get_primary_monitor() const {
  GdkMonitor *returndedValue =
      gdk_display_get_primary_monitor(GDK_DISPLAY(instance));
...
Php::Value GdkDisplay_::get_default_screen() const {
...
Php::Value GdkDisplay_::get_monitor(Php::Parameters &parameters) const {
  if (parameters.empty()) {
