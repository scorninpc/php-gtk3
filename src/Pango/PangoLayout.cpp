...
void PangoLayout_::__construct(Php::Parameters &parameters) {
  ...
  PangoContext_ *pango_context =
      (PangoContext_ *)object_pango_context.implementation();

  instance = (gpointer *)pango_layout_new(
      PANGO_CONTEXT(pango_context->get_instance()));
}
...
void PangoLayout_::set_markup(Php::Parameters &parameters) {
  ...
  pango_layout_set_markup(PANGO_LAYOUT(instance), markup, length);
}
...
Php::Value PangoLayout_::get_line(Php::Parameters &parameters) {
  ...
  PangoLayoutLine *ret = pango_layout_get_line(PANGO_LAYOUT(instance), line);
  ...
  if (ret != nullptr) {
    ...
    return_parsed->set_instance((gpointer *)PANGO_LAYOUT(ret->layout));
...
Php::Value PangoLayout_::xy_to_index(Php::Parameters &parameters) {
  ...
  gboolean result = pango_layout_xy_to_index(PANGO_LAYOUT(instance), x, y,
                                             &index_, &trailing);
...
Php::Value PangoLayout_::get_extents() {
  ...
  pango_layout_get_extents(PANGO_LAYOUT(instance), &ink_rect, &logical_rect);
...
Php::Value PangoLayout_::get_size() {
  ...
  pango_layout_get_size(PANGO_LAYOUT(instance), &width, &height);
...
Php::Value PangoLayout_::get_pixel_size() {
  ...
  pango_layout_get_pixel_size(PANGO_LAYOUT(instance), &width, &height);
...
void PangoLayout_::set_spacing(Php::Parameters &parameters) {
  ...
  pango_layout_set_spacing(PANGO_LAYOUT(instance), spacing);
}
...
Php::Value PangoLayout_::get_spacing() {
  return pango_layout_get_spacing(PANGO_LAYOUT(instance));
}
...
void PangoLayout_::set_line_spacing(Php::Parameters &parameters) {
  ...
  pango_layout_set_line_spacing(PANGO_LAYOUT(instance), factor);
}
